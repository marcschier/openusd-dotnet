...
internal sealed record VulkanSmokePixelCapture(
    string Phase,
    string Sha256,
    int Width,
    int Height,
...
internal sealed record VulkanSmokePixelEvidence(
    string CaptureApi,
    VulkanSmokePixelCapture Initial,
    VulkanSmokePixelCapture Edited,
    long ChangedPixels,
    double MeanAbsoluteChannelDelta)
{
    ...
    internal void Validate()
    {
        ...
        {
            throw new InvalidDataException("Unexpected composed-window capture API.");
        }
            ...
            Edited.NonBackgroundPixels < minimumPixels)
        {
            throw new InvalidDataException(
                "Composed capture did not contain enough non-background scene pixels.");
        }
        ...
        {
            throw new InvalidDataException(
                "Composed pixels did not change meaningfully after the live edit.");
        }
    }

    private static void ValidateCapture(VulkanSmokePixelCapture capture, string phase)
    {
...
internal sealed record WindowsClientCaptureResult(
    VulkanSmokePixelCapture Evidence,
    byte[] BgraPixels)
{
        ...
        WindowsClientCaptureResult after)
    {
            ...
            before.Evidence.Height != after.Evidence.Height)
        {
            throw new InvalidOperationException(
                "Composed before/after captures must have identical dimensions.");
        }
...
internal static partial class WindowsClientCapture
{
        ...
        byte[] pixels)
    {
        ...
        var evidence = new VulkanSmokePixelCapture(
            phase,
