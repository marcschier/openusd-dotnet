...
""";
    ...
    public async Task SilkFrameCaptureRetainedRendersTheSceneALiveRendererSynchronized()
    {
        ...
        // Capturing the same session again would synchronize a session with nothing left to
        // report and render a blank frame. That is what the viewer's Capture Frame command did:
        // it captured through the session the presentation renderer had already synchronized.
