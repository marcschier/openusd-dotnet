...
struct pickSubprimVertexMain_Result_0
{
...
struct PickSubprimVertexOutput_0
{
    float4 position_2;
    float pointSize_1;
};

[[vertex]] pickSubprimVertexMain_Result_0 pickSubprimVertexMain(vertexInput_0 _S1 [[stage_in]], SLANG_ParameterGroup_SceneParameters_0 constant* SceneParameters_0 [[buffer(0)]])
{
    ...
    thread PickSubprimVertexOutput_0 output_0;
    (&output_0)->position_2 = clip_0;
    (&output_0)->pointSize_1 = 1.0f;
    thread pickSubprimVertexMain_Result_0 _S3;
