...
[[fragment]] pixelOutput_0 fragmentMain_uv_basecolor_roughmetal_metallic_emissive(pixelInput_0 _S1 [[stage_in]], bool isFrontFace_0 [[front_facing]], float4 position_0 [[position]], SurfaceParameters_natural_0 device* surfaceParameters_1 [[buffer(7)]], FrameParameters_natural_0 device* frameParameters_1 [[buffer(8)]], texture2d<float, access::sample> baseColorTexture_1 [[texture(0)]], sampler baseColorSampler_1 [[sampler(0)]], texture2d<float, access::sample> roughnessMetallicTexture_1 [[texture(2)]], sampler roughnessMetallicSampler_1 [[sampler(2)]], texture2d<float, access::sample> metallicTexture_1 [[texture(4)]], sampler metallicSampler_1 [[sampler(5)]], texture2d<float, access::sample> emissiveTexture_1 [[texture(3)]], sampler emissiveSampler_1 [[sampler(3)]])
{
    ...
    for(;;)
    {
        ...
        texture2d<float, access::sample> _S22 = (&kernelContext_0)->roughnessMetallicTexture_0;
        ...
        float4 metadata_1 = round((((&kernelContext_0)->roughnessMetallicTexture_0).read(vec<uint,2>(((_S23)).xy), uint(((_S23)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S3 = (((&kernelContext_0)->roughnessMetallicTexture_0).read(vec<uint,2>(((_S25)).xy), uint(((_S25)).z)));
            break;
        }
    ...
    for(;;)
    {
        ...
        texture2d<float, access::sample> _S30 = (&kernelContext_0)->metallicTexture_0;
        thread uint atlasWidth_2;
        thread uint atlasHeight_2;
        (*((&atlasWidth_2)) = (_S30).get_width(0)),(*((&atlasHeight_2)) = (_S30).get_height(0));
        int3 _S31 = int3(int(0), int(0), int(0));
        float4 metadata_2 = round((((&kernelContext_0)->metallicTexture_0).read(vec<uint,2>(((_S31)).xy), uint(((_S31)).z))) * float4(255.0f) );
        int2 _S32 = int2(metadata_2.zw);
        ...
        {
            hasSceneLighting_0 = any(tile_2 >= _S32);
        }
        if(hasSceneLighting_0)
        {
            int3 _S33 = int3(int(min(1U, atlasWidth_2 - 1U)), int(0), int(0));
            _S3 = (((&kernelContext_0)->metallicTexture_0).read(vec<uint,2>(((_S33)).xy), uint(((_S33)).z)));
            break;
        }
        uint _S34 = atlasWidth_2 / uint(_S32.x);
        float _S35 = float(_S34);
        uint _S36 = (atlasHeight_2 - 1U) / uint(_S32.y);
        float2 cellSize_2 = float2(_S35, float(_S36));
    ...
    for(;;)
    {
        ...
        texture2d<float, access::sample> _S38 = (&kernelContext_0)->emissiveTexture_0;
        thread uint atlasWidth_3;
        thread uint atlasHeight_3;
        (*((&atlasWidth_3)) = (_S38).get_width(0)),(*((&atlasHeight_3)) = (_S38).get_height(0));
        int3 _S39 = int3(int(0), int(0), int(0));
        float4 metadata_3 = round((((&kernelContext_0)->emissiveTexture_0).read(vec<uint,2>(((_S39)).xy), uint(((_S39)).z))) * float4(255.0f) );
        int2 _S40 = int2(metadata_3.zw);
        ...
        {
            hasSceneLighting_0 = any(tile_3 >= _S40);
        }
        if(hasSceneLighting_0)
        {
            int3 _S41 = int3(int(min(1U, atlasWidth_3 - 1U)), int(0), int(0));
            _S3 = (((&kernelContext_0)->emissiveTexture_0).read(vec<uint,2>(((_S41)).xy), uint(((_S41)).z)));
            break;
        }
        uint _S42 = atlasWidth_3 / uint(_S40.x);
        float _S43 = float(_S42);
        uint _S44 = (atlasHeight_3 - 1U) / uint(_S40.y);
        float2 cellSize_3 = float2(_S43, float(_S44));
    ...
    float4 _S45 = float4(surface_0.metallicRoughnessThresholdWorkflow_0) ;
    float opacityThreshold_0 = _S45.z;
    ...
    float _S46 = saturate(abs(dot(normal_2, diffuseColor_0)) + 0.00000999999974738f);
    float _S47 = max(0.00100000004749745f, roughness_0);
    float _S48 = _S8.x;
    float _S49 = max(0.00100000004749745f, _S8.y);
    float4 _S50 = float4(surface_0.specularIor_0) ;
    float _S51 = _S50.w;
    float reflectanceRatio_0 = (1.0f - _S51) / (1.0f + _S51);
    float3 _S52 = float3(3.14159274101257324f) ;
    float3 diffuse_0 = diffuseColor_1 / _S52;
    float3 normalIncidence_0;
    float3 grazingIncidence_0;
    float3 diffuse_1;
    if((_S45.w) >= 0.5f)
    {
        float3 _S53 = float3(1.0f, 1.0f, 1.0f);
        normalIncidence_0 = _S50.xyz;
        grazingIncidence_0 = _S53;
        diffuse_1 = diffuse_0;
    }
    else
    {
        float3 _S54 = float3(metallic_0) ;
        float3 specularTint_0 = mix(float3(1.0f, 1.0f, 1.0f), diffuseColor_1, _S54);
        float3 diffuse_2 = diffuse_0 * float3((1.0f - metallic_0)) ;
        normalIncidence_0 = mix(float3((reflectanceRatio_0 * reflectanceRatio_0))  * specularTint_0, specularTint_0, _S54);
        grazingIncidence_0 = specularTint_0;
        diffuse_1 = diffuse_2;
    }
    float4 _S55 = float4(_S4->ambientLight_0) ;
    float _S56 = _S55.w;
    if(_S56 > 0.5f)
    {
        hasSceneLighting_0 = true;
    ...
    {
        float3 _S57 = _S55.xyz;
        hasSceneLighting_0 = (dot(_S57, _S57)) > 0.0f;
    }
    uint _S58 = min(uint(_S56), 8U);
    matrix<float,int(4),int(4)>  _S59 = matrix<float,int(4),int(4)> (_S4->eyeToWorld_0.data_0[int(0)][int(0)], _S4->eyeToWorld_0.data_0[int(0)][int(1)], _S4->eyeToWorld_0.data_0[int(0)][int(2)], _S4->eyeToWorld_0.data_0[int(0)][int(3)], _S4->eyeToWorld_0.data_0[int(1)][int(0)], _S4->eyeToWorld_0.data_0[int(1)][int(1)], _S4->eyeToWorld_0.data_0[int(1)][int(2)], _S4->eyeToWorld_0.data_0[int(1)][int(3)], _S4->eyeToWorld_0.data_0[int(2)][int(0)], _S4->eyeToWorld_0.data_0[int(2)][int(1)], _S4->eyeToWorld_0.data_0[int(2)][int(2)], _S4->eyeToWorld_0.data_0[int(2)][int(3)], _S4->eyeToWorld_0.data_0[int(3)][int(0)], _S4->eyeToWorld_0.data_0[int(3)][int(1)], _S4->eyeToWorld_0.data_0[int(3)][int(2)], _S4->eyeToWorld_0.data_0[int(3)][int(3)]);
    float3 _S60 = normalize((((float4(diffuseColor_0, 0.0f)) * (_S59))).xyz);
    float3 _S61 = (((float4(_S1.eyePosition_0, 1.0f)) * (_S59))).xyz;
    float4 _S62 = float4(surface_0.lightColorAmbient_0) ;
    float3 color_0 = diffuseColor_1 * float3(_S62.w)  + diffuseColor_1 * _S55.xyz;
    bool _S63 = !hasSceneLighting_0;
    uint lightCount_0;
    if(_S63)
    {
        lightCount_0 = 1U;
    ...
    for(;;)
    {
        ...
        bool _S64 = lightIndex_0 == 0U;
        if(_S64)
        {
            hasSceneLighting_0 = _S63;
        }
        else
        {
            hasSceneLighting_0 = false;
        ...
        {
            _S68 = (float4((&_S4->lightColorIntensity_0)->data_1[lightIndex_0]) ).xyz;
        }
        bool _S69;
        if(_S64)
        {
        ...
        {
            _S70 = (float4((&_S4->lightControls_0)->data_1[lightIndex_0]) ).x;
        }
        bool _S71;
        if(_S64)
        {
        ...
        {
            _S72 = (float4((&_S4->lightControls_0)->data_1[lightIndex_0]) ).y;
        }
        bool _S73;
        if(_S64)
        {
        ...
        sampleOffsets_0[int(0)] = _S80;
        sampleOffsets_0[int(1)] = _S80;
        sampleOffsets_0[int(2)] = _S80;
        sampleOffsets_0[int(3)] = _S80;
        sampleOffsets_0[int(4)] = _S80;
        float sampleCount_0;
        if(lightType_0 == 3.0f)
        {
            ...
            float3 _S81 = - halfWidth_0;
            sampleOffsets_0[int(3)] = _S81 + halfHeight_0;
            sampleOffsets_0[int(4)] = _S81 - halfHeight_0;
            sampleCount_0 = 5.0f;
        }
        else
        {
        ...
        for(;;)
        {
            ...
            if(lightType_0 >= 2.0f)
            {
                float3 toLight_0 = (float4((&_S4->lightPositionType_0)->data_1[lightIndex_0]) ).xyz + sampleOffsets_0[sampleIndex_0] - _S61;
                float _S82 = max(dot(toLight_0, toLight_0), 0.00100000004749745f);
                float3 sampleDirection_1 = toLight_0 * float3(rsqrt(_S82)) ;
                float sampleIntensity_2 = sampleIntensity_0 / _S82;
                if(lightType_0 == 4.0f)
                {
            ...
            float3 half_0 = normalize(sampleDirection_0 + _S79);
            float normalDotLight_0 = saturate(dot(normal_2, sampleDirection_0));
            float normalDotHalf_0 = saturate(dot(normal_2, half_0));
            float3 _S83 = float3(pow(max(0.0f, 1.0f - saturate(dot(_S79, half_0))), 5.0f)) ;
            float3 _S84 = mix(normalIncidence_0, grazingIncidence_0, _S83);
            float3 directDiffuse_0 = diffuse_1 * (float3(1.0f)  - _S84);
            float alpha_0 = _S47 * _S47;
            float alphaSquared_0 = alpha_0 * alpha_0;
            float _S85 = normalDotHalf_0 * normalDotHalf_0;
            float denominator_0 = _S85 * (alphaSquared_0 - 1.0f) + 1.0f;
            float k_0 = alpha_0 * 0.5f;
            float _S86 = 1.0f - k_0;
            float3 _S87 = float3((4.0f * normalDotLight_0 * _S46 + 0.00100000004749745f)) ;
            float3 _S88 = _S84 * float3((_S46 / (_S46 * _S86 + k_0) * (normalDotLight_0 / (normalDotLight_0 * _S86 + k_0))))  * float3(((alphaSquared_0 + 0.00100000004749745f) / (denominator_0 * denominator_0 * 3.14159274101257324f)))  / _S87;
            float3 directSpecular_0;
            if(_S48 > 0.0f)
            {
                float alpha_1 = _S49 * _S49;
                float alphaSquared_1 = alpha_1 * alpha_1;
                float denominator_1 = _S85 * (alphaSquared_1 - 1.0f) + 1.0f;
                float k_1 = alpha_1 * 0.5f;
                float _S89 = 1.0f - k_1;
                directSpecular_0 = _S88 + float3(_S48)  * (mix(float3((reflectanceRatio_0 * reflectanceRatio_0)) , float3(1.0f, 1.0f, 1.0f), _S83) * float3((_S46 / (_S46 * _S89 + k_1) * (normalDotLight_0 / (normalDotLight_0 * _S89 + k_1))))  * float3(((alphaSquared_1 + 0.00100000004749745f) / (denominator_1 * denominator_1 * 3.14159274101257324f)))  / _S87);
            }
            else
            {
                directSpecular_0 = _S88;
            }
            float3 _S90 = _S68 * float3(sampleIntensity_1) ;
            color_2 = color_2 + float3((_S9 * emissionScale_0 * normalDotLight_0))  * (directDiffuse_0 * float3(_S70)  * (_S90 * _S52) + directSpecular_0 * float3(_S72)  * _S90);
            sampleIndex_0 = sampleIndex_0 + 1U;
        }
    ...
    pixelOutput_0 _S91 = { float4(color_1, opacity_1) };
    return _S91;
}
