...
[[fragment]] pixelOutput_0 fragmentMain_uv_basecolor_normal(pixelInput_0 _S1 [[stage_in]], bool isFrontFace_0 [[front_facing]], float4 position_0 [[position]], SurfaceParameters_natural_0 device* surfaceParameters_1 [[buffer(7)]], FrameParameters_natural_0 device* frameParameters_1 [[buffer(8)]], texture2d<float, access::sample> baseColorTexture_1 [[texture(0)]], sampler baseColorSampler_1 [[sampler(0)]], texture2d<float, access::sample> normalTexture_1 [[texture(1)]], sampler normalSampler_1 [[sampler(1)]])
{
    ...
    float _S32 = saturate(abs(dot(normal_2, diffuseColor_0)) + 0.00000999999974738f);
    ...
    float3 diffuse_0 = diffuseColor_1 / _S38;
    ...
    else
    {
        ...
        float3 specularTint_0 = mix(float3(1.0f, 1.0f, 1.0f), diffuseColor_1, _S40);
    ...
    float3 _S46 = normalize((((float4(diffuseColor_0, 0.0f)) * (_S45))).xyz);
    float3 _S47 = (((float4(_S1.eyePosition_0, 1.0f)) * (_S45))).xyz;
    float4 _S48 = float4(surface_0.lightColorAmbient_0) ;
    float3 color_0 = diffuseColor_1 * float3(_S48.w)  + diffuseColor_1 * _S41.xyz;
    ...
    for(;;)
    {
        ...
        {
            _S54 = (float4((&_S4->lightColorIntensity_0)->data_1[lightIndex_0]) ).xyz;
        }
        bool _S55;
        if(_S50)
        {
        ...
        for(;;)
        {
            ...
            float3 directDiffuse_0 = diffuse_1 * (_S31 - _S70);
            ...
            float3 _S76 = _S54 * float3(sampleIntensity_1) ;
    ...
    pixelOutput_0 _S77 = { float4(color_1, opacity_1) };
    return _S77;
}
