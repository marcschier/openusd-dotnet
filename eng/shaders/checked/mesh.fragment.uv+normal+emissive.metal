...
[[fragment]] pixelOutput_0 fragmentMain_uv_normal_emissive(pixelInput_0 _S1 [[stage_in]], bool isFrontFace_0 [[front_facing]], float4 position_0 [[position]], SurfaceParameters_natural_0 device* surfaceParameters_1 [[buffer(7)]], FrameParameters_natural_0 device* frameParameters_1 [[buffer(8)]], texture2d<float, access::sample> normalTexture_1 [[texture(1)]], sampler normalSampler_1 [[sampler(1)]], texture2d<float, access::sample> emissiveTexture_1 [[texture(3)]], sampler emissiveSampler_1 [[sampler(3)]])
{
    ...
    for(;;)
    {
        ...
        texture2d<float, access::sample> _S24 = (&kernelContext_0)->emissiveTexture_0;
        ...
        float4 metadata_1 = round((((&kernelContext_0)->emissiveTexture_0).read(vec<uint,2>(((_S25)).xy), uint(((_S25)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S3 = (((&kernelContext_0)->emissiveTexture_0).read(vec<uint,2>(((_S27)).xy), uint(((_S27)).z)));
            break;
        }
    ...
    for(;;)
    {
        ...
        for(;;)
        {
            ...
            float3 directDiffuse_0 = diffuse_1 * (_S22 - _S70);
            ...
            color_2 = color_2 + float3((_S9 * emissionScale_0 * normalDotLight_0))  * (directDiffuse_0 * float3(_S56)  * (_S76 * _S38) + directSpecular_0 * float3(_S58)  * _S76);
            sampleIndex_0 = sampleIndex_0 + 1U;
        }
