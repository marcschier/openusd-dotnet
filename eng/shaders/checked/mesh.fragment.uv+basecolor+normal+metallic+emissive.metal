...
[[fragment]] pixelOutput_0 fragmentMain_uv_basecolor_normal_metallic_emissive(pixelInput_0 _S1 [[stage_in]], bool isFrontFace_0 [[front_facing]], float4 position_0 [[position]], SurfaceParameters_natural_0 device* surfaceParameters_1 [[buffer(7)]], FrameParameters_natural_0 device* frameParameters_1 [[buffer(8)]], texture2d<float, access::sample> baseColorTexture_1 [[texture(0)]], sampler baseColorSampler_1 [[sampler(0)]], texture2d<float, access::sample> normalTexture_1 [[texture(1)]], sampler normalSampler_1 [[sampler(1)]], texture2d<float, access::sample> metallicTexture_1 [[texture(4)]], sampler metallicSampler_1 [[sampler(5)]], texture2d<float, access::sample> emissiveTexture_1 [[texture(3)]], sampler emissiveSampler_1 [[sampler(3)]])
{
    uint4 _S2;
    ...
    for(;;)
    {
        ...
        texture2d<float, access::sample> _S15 = (&kernelContext_0)->baseColorTexture_0;
        ...
        float4 metadata_0 = round((((&kernelContext_0)->baseColorTexture_0).read(vec<uint,2>(((_S16)).xy), uint(((_S16)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S3 = (((&kernelContext_0)->baseColorTexture_0).read(vec<uint,2>(((_S18)).xy), uint(((_S18)).z)));
            break;
        }
    ...
    for(;;)
    {
        ...
        texture2d<float, access::sample> _S23 = (&kernelContext_0)->normalTexture_0;
        ...
        float4 metadata_1 = round((((&kernelContext_0)->normalTexture_0).read(vec<uint,2>(((_S24)).xy), uint(((_S24)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S3 = (((&kernelContext_0)->normalTexture_0).read(vec<uint,2>(((_S26)).xy), uint(((_S26)).z)));
            break;
        }
    ...
    float3 _S30 = float3(1.0f) ;
    float3 sampledNormal_0 = _S3.xyz * float3(2.0f)  - _S30;
    ...
    for(;;)
    {
        ...
        texture2d<float, access::sample> _S32 = (&kernelContext_0)->metallicTexture_0;
        thread uint atlasWidth_2;
        thread uint atlasHeight_2;
        (*((&atlasWidth_2)) = (_S32).get_width(0)),(*((&atlasHeight_2)) = (_S32).get_height(0));
        int3 _S33 = int3(int(0), int(0), int(0));
        float4 metadata_2 = round((((&kernelContext_0)->metallicTexture_0).read(vec<uint,2>(((_S33)).xy), uint(((_S33)).z))) * float4(255.0f) );
        int2 _S34 = int2(metadata_2.zw);
        ...
        {
            hasSceneLighting_0 = any(tile_2 >= _S34);
        }
        if(hasSceneLighting_0)
        {
            int3 _S35 = int3(int(min(1U, atlasWidth_2 - 1U)), int(0), int(0));
            _S3 = (((&kernelContext_0)->metallicTexture_0).read(vec<uint,2>(((_S35)).xy), uint(((_S35)).z)));
            break;
        }
        uint _S36 = atlasWidth_2 / uint(_S34.x);
        float _S37 = float(_S36);
        uint _S38 = (atlasHeight_2 - 1U) / uint(_S34.y);
        float2 cellSize_2 = float2(_S37, float(_S38));
        _S3 = (((&kernelContext_0)->metallicTexture_0).sample(((&kernelContext_0)->metallicSampler_0), ((float2(tile_2) * cellSize_2 + float2(1.5f, 2.5f) + fract(_S1.texCoord_0) * max(cellSize_2 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_2), float(atlasHeight_2)))));
        break;
    }
    float metallic_0 = saturate(_S3.x);
    bool _S39 = (_S13 & 8U) != 0U;
    for(;;)
    {
        if(!_S39)
        {
        ...
        texture2d<float, access::sample> _S40 = (&kernelContext_0)->emissiveTexture_0;
        thread uint atlasWidth_3;
        thread uint atlasHeight_3;
        (*((&atlasWidth_3)) = (_S40).get_width(0)),(*((&atlasHeight_3)) = (_S40).get_height(0));
        int3 _S41 = int3(int(0), int(0), int(0));
        float4 metadata_3 = round((((&kernelContext_0)->emissiveTexture_0).read(vec<uint,2>(((_S41)).xy), uint(((_S41)).z))) * float4(255.0f) );
        int2 _S42 = int2(metadata_3.zw);
        ...
        {
            hasSceneLighting_0 = any(tile_3 >= _S42);
        }
        if(hasSceneLighting_0)
        {
            int3 _S43 = int3(int(min(1U, atlasWidth_3 - 1U)), int(0), int(0));
            _S3 = (((&kernelContext_0)->emissiveTexture_0).read(vec<uint,2>(((_S43)).xy), uint(((_S43)).z)));
            break;
        }
        uint _S44 = atlasWidth_3 / uint(_S42.x);
        float _S45 = float(_S44);
        uint _S46 = (atlasHeight_3 - 1U) / uint(_S42.y);
        float2 cellSize_3 = float2(_S45, float(_S46));
        _S3 = (((&kernelContext_0)->emissiveTexture_0).sample(((&kernelContext_0)->emissiveSampler_0), ((float2(tile_3) * cellSize_3 + float2(1.5f, 2.5f) + fract(_S1.texCoord_0) * max(cellSize_3 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_3), float(atlasHeight_3)))));
        break;
    }
    ...
    float _S47 = saturate(abs(dot(normal_2, diffuseColor_0)) + 0.00000999999974738f);
    float _S48 = max(0.00100000004749745f, roughness_0);
    float _S49 = _S8.x;
    float _S50 = max(0.00100000004749745f, _S8.y);
    float4 _S51 = float4(surface_0.specularIor_0) ;
    float _S52 = _S51.w;
    float reflectanceRatio_0 = (1.0f - _S52) / (1.0f + _S52);
    float3 _S53 = float3(3.14159274101257324f) ;
    float3 diffuse_0 = diffuseColor_1 / _S53;
    float3 normalIncidence_0;
    float3 grazingIncidence_0;
    float3 diffuse_1;
    if((_S12.w) >= 0.5f)
    {
        float3 _S54 = float3(1.0f, 1.0f, 1.0f);
        normalIncidence_0 = _S51.xyz;
        grazingIncidence_0 = _S54;
        diffuse_1 = diffuse_0;
    }
    else
    {
        float3 _S55 = float3(metallic_0) ;
        float3 specularTint_0 = mix(float3(1.0f, 1.0f, 1.0f), diffuseColor_1, _S55);
        float3 diffuse_2 = diffuse_0 * float3((1.0f - metallic_0)) ;
        normalIncidence_0 = mix(float3((reflectanceRatio_0 * reflectanceRatio_0))  * specularTint_0, specularTint_0, _S55);
        grazingIncidence_0 = specularTint_0;
        diffuse_1 = diffuse_2;
    }
    float4 _S56 = float4(_S4->ambientLight_0) ;
    float _S57 = _S56.w;
    if(_S57 > 0.5f)
    {
        hasSceneLighting_0 = true;
    ...
    {
        float3 _S58 = _S56.xyz;
        hasSceneLighting_0 = (dot(_S58, _S58)) > 0.0f;
    }
    uint _S59 = min(uint(_S57), 8U);
    matrix<float,int(4),int(4)>  _S60 = matrix<float,int(4),int(4)> (_S4->eyeToWorld_0.data_0[int(0)][int(0)], _S4->eyeToWorld_0.data_0[int(0)][int(1)], _S4->eyeToWorld_0.data_0[int(0)][int(2)], _S4->eyeToWorld_0.data_0[int(0)][int(3)], _S4->eyeToWorld_0.data_0[int(1)][int(0)], _S4->eyeToWorld_0.data_0[int(1)][int(1)], _S4->eyeToWorld_0.data_0[int(1)][int(2)], _S4->eyeToWorld_0.data_0[int(1)][int(3)], _S4->eyeToWorld_0.data_0[int(2)][int(0)], _S4->eyeToWorld_0.data_0[int(2)][int(1)], _S4->eyeToWorld_0.data_0[int(2)][int(2)], _S4->eyeToWorld_0.data_0[int(2)][int(3)], _S4->eyeToWorld_0.data_0[int(3)][int(0)], _S4->eyeToWorld_0.data_0[int(3)][int(1)], _S4->eyeToWorld_0.data_0[int(3)][int(2)], _S4->eyeToWorld_0.data_0[int(3)][int(3)]);
    float3 _S61 = normalize((((float4(diffuseColor_0, 0.0f)) * (_S60))).xyz);
    float3 _S62 = (((float4(_S1.eyePosition_0, 1.0f)) * (_S60))).xyz;
    float4 _S63 = float4(surface_0.lightColorAmbient_0) ;
    float3 color_0 = diffuseColor_1 * float3(_S63.w)  + diffuseColor_1 * _S56.xyz;
    bool _S64 = !hasSceneLighting_0;
    uint lightCount_0;
    if(_S64)
    {
        lightCount_0 = 1U;
    ...
    for(;;)
    {
        ...
        bool _S65 = lightIndex_0 == 0U;
        if(_S65)
        {
            hasSceneLighting_0 = _S64;
        }
        else
        {
            hasSceneLighting_0 = false;
        ...
        {
            _S69 = (float4((&_S4->lightColorIntensity_0)->data_1[lightIndex_0]) ).xyz;
        }
        bool _S70;
        if(_S65)
        {
        ...
        {
            _S71 = (float4((&_S4->lightControls_0)->data_1[lightIndex_0]) ).x;
        }
        bool _S72;
        if(_S65)
        {
        ...
        {
            _S73 = (float4((&_S4->lightControls_0)->data_1[lightIndex_0]) ).y;
        }
        bool _S74;
        if(_S65)
        {
        ...
        float3 _S81 = float3(0.0f, 0.0f, 0.0f);
        sampleOffsets_0[int(0)] = _S81;
        sampleOffsets_0[int(1)] = _S81;
        sampleOffsets_0[int(2)] = _S81;
        sampleOffsets_0[int(3)] = _S81;
        sampleOffsets_0[int(4)] = _S81;
        float sampleCount_0;
        if(lightType_0 == 3.0f)
        {
            ...
            float3 _S82 = - halfWidth_0;
            sampleOffsets_0[int(3)] = _S82 + halfHeight_0;
            sampleOffsets_0[int(4)] = _S82 - halfHeight_0;
            sampleCount_0 = 5.0f;
        }
        else
        {
        ...
        for(;;)
        {
            ...
            if(lightType_0 >= 2.0f)
            {
                float3 toLight_0 = (float4((&_S4->lightPositionType_0)->data_1[lightIndex_0]) ).xyz + sampleOffsets_0[sampleIndex_0] - _S62;
                float _S83 = max(dot(toLight_0, toLight_0), 0.00100000004749745f);
                float3 sampleDirection_1 = toLight_0 * float3(rsqrt(_S83)) ;
                float sampleIntensity_2 = sampleIntensity_0 / _S83;
                if(lightType_0 == 4.0f)
                {
            ...
            float3 half_0 = normalize(sampleDirection_0 + _S80);
            float normalDotLight_0 = saturate(dot(normal_2, sampleDirection_0));
            float normalDotHalf_0 = saturate(dot(normal_2, half_0));
            float3 _S84 = float3(pow(max(0.0f, 1.0f - saturate(dot(_S80, half_0))), 5.0f)) ;
            float3 _S85 = mix(normalIncidence_0, grazingIncidence_0, _S84);
            float3 directDiffuse_0 = diffuse_1 * (_S30 - _S85);
            float alpha_0 = _S48 * _S48;
            float alphaSquared_0 = alpha_0 * alpha_0;
            float _S86 = normalDotHalf_0 * normalDotHalf_0;
            float denominator_0 = _S86 * (alphaSquared_0 - 1.0f) + 1.0f;
            float k_0 = alpha_0 * 0.5f;
            float _S87 = 1.0f - k_0;
            float3 _S88 = float3((4.0f * normalDotLight_0 * _S47 + 0.00100000004749745f)) ;
            float3 _S89 = _S85 * float3((_S47 / (_S47 * _S87 + k_0) * (normalDotLight_0 / (normalDotLight_0 * _S87 + k_0))))  * float3(((alphaSquared_0 + 0.00100000004749745f) / (denominator_0 * denominator_0 * 3.14159274101257324f)))  / _S88;
            float3 directSpecular_0;
            if(_S49 > 0.0f)
            {
                float alpha_1 = _S50 * _S50;
                float alphaSquared_1 = alpha_1 * alpha_1;
                float denominator_1 = _S86 * (alphaSquared_1 - 1.0f) + 1.0f;
                float k_1 = alpha_1 * 0.5f;
                float _S90 = 1.0f - k_1;
                directSpecular_0 = _S89 + float3(_S49)  * (mix(float3((reflectanceRatio_0 * reflectanceRatio_0)) , float3(1.0f, 1.0f, 1.0f), _S84) * float3((_S47 / (_S47 * _S90 + k_1) * (normalDotLight_0 / (normalDotLight_0 * _S90 + k_1))))  * float3(((alphaSquared_1 + 0.00100000004749745f) / (denominator_1 * denominator_1 * 3.14159274101257324f)))  / _S88);
            }
            else
            {
                directSpecular_0 = _S89;
            }
            float3 _S91 = _S69 * float3(sampleIntensity_1) ;
            color_2 = color_2 + float3((_S9 * emissionScale_0 * normalDotLight_0))  * (directDiffuse_0 * float3(_S71)  * (_S91 * _S53) + directSpecular_0 * float3(_S73)  * _S91);
            sampleIndex_0 = sampleIndex_0 + 1U;
        }
    ...
    if((_S2.y) == 1U)
    {
        color_1 = color_3 / (_S30 + max(color_3, float3(0.0f, 0.0f, 0.0f)));
    }
    else
    {
        color_1 = color_3;
    }
    pixelOutput_0 _S92 = { float4(color_1, opacity_1) };
    return _S92;
}
