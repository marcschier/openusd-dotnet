...
[[fragment]] pixelOutput_0 volumeFragmentMain(pixelInput_0 _S1 [[stage_in]], bool isFrontFace_0 [[front_facing]], float4 position_0 [[position]], SurfaceParameters_natural_0 device* surfaceParameters_1 [[buffer(7)]], FrameParameters_natural_0 device* frameParameters_1 [[buffer(8)]], texture3d<float, access::sample> volumeDensityTexture_1 [[texture(9)]], sampler volumeDensitySampler_1 [[sampler(4)]], texture2d<float, access::sample> shadowAtlas_1 [[texture(16)]], sampler shadowSampler_1 [[sampler(13)]], texture2d<float, access::sample> environmentBrdf_1 [[texture(19)]], sampler environmentBrdfSampler_1 [[sampler(15)]], texture2d<float, access::sample> environmentIrradiance_1 [[texture(17)]], sampler environmentSampler_1 [[sampler(14)]], texture2d<float, access::sample> environmentSpecular_1 [[texture(18)]])
{
    ...
    if((_S14.x) >= 0.5f)
    {
        if((_S14.w) >= 0.5f)
        {
            float _S15 = (float4(_S6->textureControls_0) ).z;
            for(;;)
            {
                float2 _S16 = saturate(_S1.objectPosition_0.xy + float2(0.5f, 0.5f));
                uint stepCount_0 = uint(clamp(_S15, 1.0f, 512.0f));
                step_0 = 0U;
                density_0 = 0.0f;
                for(;;)
                {
                    ...
                    float density_1 = density_0 + (((&kernelContext_0)->volumeDensityTexture_0).sample(((&kernelContext_0)->volumeDensitySampler_0), (float3(_S16, (float(step_0) + 0.5f) / float(stepCount_0)))).x);
                    step_0 = step_0 + 1U;
                    density_0 = density_1;
                }
            ...
            density_0 = _S3 * max(0.0f, _S14.y);
        }
        else
        {
            density_0 = max(0.0f, _S14.y);
        }
        pixelOutput_0 _S17 = { float4(diffuseColor_0 * float3((1.0f - exp(- density_0 * max(0.0f, _S14.z)))) , 1.0f) };
        return _S17;
    }
    float4 _S18 = float4(_S6->metallicRoughnessThresholdWorkflow_0) ;
    float metallic_0 = saturate(_S18.x);
    float roughness_0 = clamp(_S18.y, 0.00999999977648258f, 1.0f);
    float4 _S19 = float4(_S6->specularIor_0) ;
    float3 specularColor_0 = _S19.xyz;
    float ior_0 = _S19.w;
    float clearcoatAmount_0 = _S11.x;
    float clearcoatRoughness_0 = _S11.y;
    float opacityThreshold_0 = _S18.z;
    ...
    float _S20 = saturate(abs(dot(normal_2, unlitColor_0)) + 0.00000999999974738f);
    ...
    float4 _S26 = float4(_S7->ambientLight_0) ;
    float _S27 = _S26.w;
    if(_S27 > 0.5f)
    {
    ...
    matrix<float,int(4),int(4)>  _S30 = matrix<float,int(4),int(4)> (_S7->eyeToWorld_0.data_0[int(0)][int(0)], _S7->eyeToWorld_0.data_0[int(0)][int(1)], _S7->eyeToWorld_0.data_0[int(0)][int(2)], _S7->eyeToWorld_0.data_0[int(0)][int(3)], _S7->eyeToWorld_0.data_0[int(1)][int(0)], _S7->eyeToWorld_0.data_0[int(1)][int(1)], _S7->eyeToWorld_0.data_0[int(1)][int(2)], _S7->eyeToWorld_0.data_0[int(1)][int(3)], _S7->eyeToWorld_0.data_0[int(2)][int(0)], _S7->eyeToWorld_0.data_0[int(2)][int(1)], _S7->eyeToWorld_0.data_0[int(2)][int(2)], _S7->eyeToWorld_0.data_0[int(2)][int(3)], _S7->eyeToWorld_0.data_0[int(3)][int(0)], _S7->eyeToWorld_0.data_0[int(3)][int(1)], _S7->eyeToWorld_0.data_0[int(3)][int(2)], _S7->eyeToWorld_0.data_0[int(3)][int(3)]);
    float3 sceneEye_0 = normalize((((float4(unlitColor_0, 0.0f)) * (_S30))).xyz);
    float3 worldPosition_0 = (((float4(_S1.eyePosition_0, 1.0f)) * (_S30))).xyz;
    ...
    float4 _S31 = float4(_S6->lightColorAmbient_0) ;
    float3 color_0 = diffuseColor_0 * float3(_S31.w) ;
    uint domeLinkMask_0 = uint(max((float4(_S6->domeLinkControls_0) ).x, 0.0f));
    float4 _S32 = float4(_S7->domeControls_0) ;
    uint _S33 = min(uint(max(_S32.x, 0.0f)), 8U);
    uint allDomes_0 = (1U << _S33) - 1U;
    bool allDomesLinked_0 = (domeLinkMask_0 & allDomes_0) == allDomes_0;
    float3 _S34 = _S26.xyz;
    float3 domeAmbient_1;
    if(!allDomesLinked_0)
    {
        float3 _S35 = float3(0.0f, 0.0f, 0.0f);
        step_0 = 0U;
        domeAmbient_1 = _S35;
        for(;;)
        {
            ...
            {
                domeAmbient_1 = domeAmbient_1 + (float4((&_S7->domeAmbient_0)->data_1[step_0]) ).xyz;
            }
            step_0 = step_0 + 1U;
        }
    }
    ...
    uint _S37 = uint(max(_S11.w, 0.0f));
    ...
    for(;;)
    {
        ...
        {
            density_0 = (float4((&_S7->lightPositionType_0)->data_1[lightIndex_0]) ).w;
        }
        bool _S41;
        if(_S39)
        {
        ...
        if(_S42)
        {
            _S43 = (float4(_S6->lightDirectionIntensity_0) ).w;
        }
        else
        {
            _S43 = (float4((&_S7->lightColorIntensity_0)->data_1[lightIndex_0]) ).w;
        }
        bool _S44;
        if(_S39)
        {
        ...
        {
            _S46 = (float4((&_S7->lightControls_0)->data_1[lightIndex_0]) ).x;
        }
        bool _S47;
        if(_S39)
        {
        ...
        {
            _S48 = (float4((&_S7->lightControls_0)->data_1[lightIndex_0]) ).y;
        }
        bool _S49;
        if(_S39)
        {
        ...
        if(hasSceneLighting_0)
        {
            ...
            if(shadowSlot_0 >= int(0))
            {
                for(;;)
                {
                    float4 _S55 = float4((&_S7->shadowControls_0)->data_3[shadowSlot_0]) ;
                    float4 _S56 = float4((&_S7->shadowTile_0)->data_3[shadowSlot_0]) ;
                    ...
                    float4 lightClip_0 = (((float4(worldPosition_0 + color_3 * float3((_S55.y * slope_0)) , 1.0f)) * (matrix<float,int(4),int(4)> ((&_S7->shadowWorldToLightClip_0)->data_2[shadowSlot_0].data_0[int(0)][int(0)], (&_S7->shadowWorldToLightClip_0)->data_2[shadowSlot_0].data_0[int(0)][int(1)], (&_S7->shadowWorldToLightClip_0)->data_2[shadowSlot_0].data_0[int(0)][int(2)], (&_S7->shadowWorldToLightClip_0)->data_2[shadowSlot_0].data_0[int(0)][int(3)], (&_S7->shadowWorldToLightClip_0)->data_2[shadowSlot_0].data_0[int(1)][int(0)], (&_S7->shadowWorldToLightClip_0)->data_2[shadowSlot_0].data_0[int(1)][int(1)], (&_S7->shadowWorldToLightClip_0)->data_2[shadowSlot_0].data_0[int(1)][int(2)], (&_S7->shadowWorldToLightClip_0)->data_2[shadowSlot_0].data_0[int(1)][int(3)], (&_S7->shadowWorldToLightClip_0)->data_2[shadowSlot_0].data_0[int(2)][int(0)], (&_S7->shadowWorldToLightClip_0)->data_2[shadowSlot_0].data_0[int(2)][int(1)], (&_S7->shadowWorldToLightClip_0)->data_2[shadowSlot_0].data_0[int(2)][int(2)], (&_S7->shadowWorldToLightClip_0)->data_2[shadowSlot_0].data_0[int(2)][int(3)], (&_S7->shadowWorldToLightClip_0)->data_2[shadowSlot_0].data_0[int(3)][int(0)], (&_S7->shadowWorldToLightClip_0)->data_2[shadowSlot_0].data_0[int(3)][int(1)], (&_S7->shadowWorldToLightClip_0)->data_2[shadowSlot_0].data_0[int(3)][int(2)], (&_S7->shadowWorldToLightClip_0)->data_2[shadowSlot_0].data_0[int(3)][int(3)]))));
                    float _S57 = lightClip_0.w;
                    if(_S57 <= 0.0f)
                    {
                        shadowVisibility_0 = 1.0f;
                        break;
                    }
                    float3 ndc_0 = lightClip_0.xyz / float3(_S57) ;
                    bool _S58;
                    if((abs(ndc_0.x)) > 1.0f)
                    {
                        _S58 = true;
                    ...
                    float2 _S61 = _S56.xy;
                    float2 _S62 = _S56.zw;
                    float2 _S63 = _S61 + (ndc_0.xy * float2(0.5f, -0.5f) + float2(0.5f, 0.5f)) * _S62;
                    float texel_0 = _S55.w;
                    float _S64 = max(_S55.z, 0.0f);
                    float _S65 = ndc_0.z - _S55.x * (1.0f + 2.0f * slope_0);
                    float2 _S66 = float2((texel_0 * 0.5f)) ;
                    float2 _S67 = _S61 + _S66;
                    float2 _S68 = _S61 + _S62 - _S66;
                    int y_0 = int(-1);
                    ...
                    for(;;)
                    {
                        ...
                        for(;;)
                        {
                            ...
                            if(_S65 <= (((&kernelContext_0)->shadowAtlas_0).sample(((&kernelContext_0)->shadowSampler_0), (clamp(_S63 + float2(float(x_0), float(y_0)) * float2((_S64 * texel_0)) , _S67, _S68)), level((0.0f))).x))
                            {
                                sampleCount_0 = 1.0f;
                            }
                            else
        ...
        sampleOffsets_0[int(0)] = _S69;
        sampleOffsets_0[int(1)] = _S69;
        sampleOffsets_0[int(2)] = _S69;
        sampleOffsets_0[int(3)] = _S69;
        sampleOffsets_0[int(4)] = _S69;
        if(density_0 == 3.0f)
        {
            ...
            float3 _S70 = - halfWidth_0;
            sampleOffsets_0[int(3)] = _S70 + halfHeight_0;
            sampleOffsets_0[int(4)] = _S70 - halfHeight_0;
            sampleCount_0 = 5.0f;
        }
        else
        {
        ...
        for(;;)
        {
            ...
            float sampleIntensity_0 = _S43 / sampleCount_0;
            ...
            if(density_0 >= 2.0f)
            {
                ...
                float _S71 = max(dot(toLight_0, toLight_0), 0.00100000004749745f);
                float3 sampleDirection_1 = toLight_0 * float3(rsqrt(_S71)) ;
                float sampleIntensity_2 = sampleIntensity_0 / _S71;
                if(density_0 == 4.0f)
                {
            ...
            float3 _S72 = float3(pow(max(0.0f, 1.0f - saturate(dot(domeAmbient_1, half_0))), 5.0f)) ;
            float3 _S73 = mix(normalIncidence_0, grazingIncidence_0, _S72);
            float3 directDiffuse_0 = diffuse_1 * (float3(1.0f)  - _S73);
            float _S74 = max(_S21, 0.00100000004749745f);
            float alpha_0 = _S74 * _S74;
            ...
            float _S75 = 1.0f - k_0;
            float3 _S76 = float3(max(4.0f * normalDotLight_0 * _S20, 1.00000000317107685e-30f)) ;
            float3 _S77 = _S73 * float3((_S20 / (_S20 * _S75 + k_0) * (normalDotLight_0 / (normalDotLight_0 * _S75 + k_0))))  * float3((alphaSquared_0 / max(3.14159274101257324f * denominator_0 * denominator_0, 1.00000000317107685e-30f)))  / _S76;
            float3 directSpecular_0;
            if(clearcoatAmount_0 > 0.0f)
            {
                float _S78 = max(_S22, 0.00100000004749745f);
                float alpha_1 = _S78 * _S78;
                ...
                float _S79 = 1.0f - k_1;
                directSpecular_0 = _S77 + float3(clearcoatAmount_0)  * (mix(float3((reflectanceRatio_0 * reflectanceRatio_0)) , float3(1.0f, 1.0f, 1.0f), _S72) * float3((_S20 / (_S20 * _S79 + k_1) * (normalDotLight_0 / (normalDotLight_0 * _S79 + k_1))))  * float3((alphaSquared_1 / max(3.14159274101257324f * denominator_1 * denominator_1, 1.00000000317107685e-30f)))  / _S76);
            }
            else
            {
                directSpecular_0 = _S77;
            }
            float3 _S80 = diffuseColor_0 * float3(sampleIntensity_1) ;
            color_3 = color_3 + float3((shadowVisibility_0 * occlusion_0 * emissionScale_0 * normalDotLight_0))  * (directDiffuse_0 * float3(_S46)  * (_S80 * _S23) + directSpecular_0 * float3(_S48)  * _S80);
            sampleIndex_0 = sampleIndex_0 + 1U;
        }
        color_2 = color_3;
        lightIndex_0 = lightIndex_0 + 1U;
    }
    float4 _S81 = float4(_S7->environmentControls_0) ;
    if((_S81.x) >= 0.5f)
    {
        float _S82 = saturate(saturate(abs(dot(worldNormal_2, sceneEye_0)) + 0.00000999999974738f));
        float _S83 = saturate(_S21);
        float2 _S84 = (((&kernelContext_0)->environmentBrdf_0).sample(((&kernelContext_0)->environmentBrdfSampler_0), (float2(_S82, _S83)), level((0.0f)))).xy;
        float3 specularWeight_0 = normalIncidence_0 * float3(_S84.x)  + grazingIncidence_0 * float3(_S84.y) ;
        ...
        float _S85 = max(_S32.y, 1.0f);
        float3 _S86 = float3(0.0f, 0.0f, 0.0f);
        if(allDomesLinked_0)
        {
            hasSceneLighting_0 = true;
        }
        ...
        {
            hasSceneLighting_0 = _S85 <= 1.0f;
        }
        if(hasSceneLighting_0)
        {
            float composedGroup_0 = _S32.z;
            float _S87 = _S32.w;
            for(;;)
            {
                bool _S88 = _S85 <= 1.0f;
                ...
                float inset_0 = 0.5f / max(_S87, 1.0f);
                diffuseColor_0 = (((&kernelContext_0)->environmentIrradiance_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(fract((atan2(unit_1.z, unit_1.x) + 1.57079637050628662f) / 6.28318548202514648f), (composedGroup_0 + clamp(acos(clamp(unit_1.y, -1.0f, 1.0f)) / 3.14159274101257324f, inset_0, 1.0f - inset_0)) / _S85)), level((0.0f)))).xyz;
                break;
            }
            float _S89 = _S81.y;
            float _S90 = _S81.z;
            for(;;)
            {
                if(_S4)
                {
                    ...
                    float _S91 = max(_S89, 1.0f);
                    float _S92 = _S91 - 1.0f;
                    float slice_0 = _S83 * max(_S92, 0.0f);
                    float lower_0 = floor(slice_0);
                    float inset_1 = 0.5f / max(_S90, 1.0f);
                    float v_0 = clamp(acos(clamp(unit_2.y, -1.0f, 1.0f)) / 3.14159274101257324f, inset_1, 1.0f - inset_1);
                    unlitColor_0 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_0, (lower_0 + v_0) / _S91)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_0, (min(lower_0 + 1.0f, _S92) + v_0) / _S91)), level((0.0f)))).xyz, float3((slice_0 - lower_0)) );
                    break;
                }
                ...
                float _S93 = max(_S89, 1.0f);
                float total_0 = _S93 * _S85;
                float _S94 = _S93 - 1.0f;
                float slice_1 = _S83 * max(_S94, 0.0f);
                float lower_1 = floor(slice_1);
                float inset_2 = 0.5f / max(_S90, 1.0f);
                float v_1 = clamp(acos(clamp(unit_3.y, -1.0f, 1.0f)) / 3.14159274101257324f, inset_2, 1.0f - inset_2);
                float base_0 = composedGroup_0 * _S93;
                unlitColor_0 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_1, (base_0 + lower_1 + v_1) / total_0)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_1, (base_0 + min(lower_1 + 1.0f, _S94) + v_1) / total_0)), level((0.0f)))).xyz, float3((slice_1 - lower_1)) );
                break;
            }
            if(clearcoatAmount_0 > 0.0f)
            {
                for(;;)
                {
                    if(_S4)
                    {
                        ...
                        float _S95 = max(_S89, 1.0f);
                        float _S96 = _S95 - 1.0f;
                        float slice_2 = saturate(_S22) * max(_S96, 0.0f);
                        float lower_2 = floor(slice_2);
                        float inset_3 = 0.5f / max(_S90, 1.0f);
                        float v_2 = clamp(acos(clamp(unit_4.y, -1.0f, 1.0f)) / 3.14159274101257324f, inset_3, 1.0f - inset_3);
                        normal_2 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_2, (lower_2 + v_2) / _S95)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_2, (min(lower_2 + 1.0f, _S96) + v_2) / _S95)), level((0.0f)))).xyz, float3((slice_2 - lower_2)) );
                        break;
                    }
            ...
            {
                lightDirection_0 = _S86;
            }
            float3 _S99 = unlitColor_0;
        ...
        else
        {
            ...
            for(;;)
            {
                ...
                for(;;)
                {
                    ...
                    float inset_5 = 0.5f / max(_S100, 1.0f);
                    diffuseColor_0 = (((&kernelContext_0)->environmentIrradiance_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(fract((atan2(unit_7.z, unit_7.x) + 1.57079637050628662f) / 6.28318548202514648f), (domeGroup_0 + clamp(acos(clamp(unit_7.y, -1.0f, 1.0f)) / 3.14159274101257324f, inset_5, 1.0f - inset_5)) / _S85)), level((0.0f)))).xyz;
                    break;
                }
                ...
                for(;;)
                {
                    if(_S5)
                    {
                        ...
                        float slice_4 = _S83 * max(_S105, 0.0f);
                        float lower_4 = floor(slice_4);
                        float inset_6 = 0.5f / max(_S103, 1.0f);
                        float v_4 = clamp(acos(clamp(unit_8.y, -1.0f, 1.0f)) / 3.14159274101257324f, inset_6, 1.0f - inset_6);
                        normal_2 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_4, (lower_4 + v_4) / _S104)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_4, (min(lower_4 + 1.0f, _S105) + v_4) / _S104)), level((0.0f)))).xyz, float3((slice_4 - lower_4)) );
                        break;
                    }
                    ...
                    float total_2 = _S106 * _S85;
                    float _S107 = _S106 - 1.0f;
                    float slice_5 = _S83 * max(_S107, 0.0f);
                    float lower_5 = floor(slice_5);
                    float inset_7 = 0.5f / max(_S103, 1.0f);
                    float v_5 = clamp(acos(clamp(unit_9.y, -1.0f, 1.0f)) / 3.14159274101257324f, inset_7, 1.0f - inset_7);
                    float base_2 = domeGroup_0 * _S106;
                    normal_2 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_5, (base_2 + lower_5 + v_5) / total_2)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_5, (base_2 + min(lower_5 + 1.0f, _S107) + v_5) / total_2)), level((0.0f)))).xyz, float3((slice_5 - lower_5)) );
                    break;
                }
                ...
                if(clearcoatAmount_0 > 0.0f)
                {
                    for(;;)
                    {
                        if(_S5)
                        {
                            ...
                            float slice_6 = saturate(_S22) * max(_S109, 0.0f);
                            float lower_6 = floor(slice_6);
                            float inset_8 = 0.5f / max(_S103, 1.0f);
                            float v_6 = clamp(acos(clamp(unit_10.y, -1.0f, 1.0f)) / 3.14159274101257324f, inset_8, 1.0f - inset_8);
                            normalIncidence_0 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_6, (lower_6 + v_6) / _S108)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_6, (min(lower_6 + 1.0f, _S109) + v_6) / _S108)), level((0.0f)))).xyz, float3((slice_6 - lower_6)) );
                            break;
                        }
                        ...
                        float total_3 = _S110 * _S85;
                        float _S111 = _S110 - 1.0f;
                        float slice_7 = saturate(_S22) * max(_S111, 0.0f);
                        float lower_7 = floor(slice_7);
                        float inset_9 = 0.5f / max(_S103, 1.0f);
                        float v_7 = clamp(acos(clamp(unit_11.y, -1.0f, 1.0f)) / 3.14159274101257324f, inset_9, 1.0f - inset_9);
                        float base_3 = domeGroup_0 * _S110;
                        normalIncidence_0 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_7, (base_3 + lower_7 + v_7) / total_3)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_7, (base_3 + min(lower_7 + 1.0f, _S111) + v_7) / total_3)), level((0.0f)))).xyz, float3((slice_7 - lower_7)) );
                        break;
                    }
        ...
        float3 _S112 = float3(occlusion_0) ;
        float3 color_4 = color_2 + _S112 * diffuse_1 * unlitColor_0 * diffuseWeight_0 + _S112 * prefiltered_0 * specularWeight_0;
        if(clearcoatAmount_0 > 0.0f)
        {
            float2 _S113 = (((&kernelContext_0)->environmentBrdf_0).sample(((&kernelContext_0)->environmentBrdfSampler_0), (float2(_S82, saturate(_S22))), level((0.0f)))).xy;
            color_2 = color_4 + float3((occlusion_0 * clearcoatAmount_0))  * lightDirection_0 * (float3((reflectanceRatio_0 * reflectanceRatio_0))  * float3(_S113.x)  + float3(_S113.y) );
        }
        else
        {
            color_2 = color_4;
    ...
    pixelOutput_0 _S114 = { float4(color_2, opacity_0) };
    return _S114;
}
