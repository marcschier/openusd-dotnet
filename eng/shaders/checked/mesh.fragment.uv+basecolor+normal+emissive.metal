...
[[fragment]] pixelOutput_0 fragmentMain_uv_basecolor_normal_emissive(pixelInput_0 _S1 [[stage_in]], bool isFrontFace_0 [[front_facing]], float4 position_0 [[position]], SurfaceParameters_natural_0 device* surfaceParameters_1 [[buffer(7)]], FrameParameters_natural_0 device* frameParameters_1 [[buffer(8)]], texture2d<float, access::sample> baseColorTexture_1 [[texture(0)]], sampler baseColorSampler_1 [[sampler(0)]], texture2d<float, access::sample> normalTexture_1 [[texture(1)]], sampler normalSampler_1 [[sampler(1)]], texture2d<float, access::sample> emissiveTexture_1 [[texture(3)]], sampler emissiveSampler_1 [[sampler(3)]])
{
    ...
    for(;;)
    {
        ...
        texture2d<float, access::sample> _S32 = (&kernelContext_0)->emissiveTexture_0;
        ...
        float4 metadata_2 = round((((&kernelContext_0)->emissiveTexture_0).read(vec<uint,2>(((_S33)).xy), uint(((_S33)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S3 = (((&kernelContext_0)->emissiveTexture_0).read(vec<uint,2>(((_S35)).xy), uint(((_S35)).z)));
            break;
        }
    ...
    float _S39 = saturate(abs(dot(normal_2, diffuseColor_0)) + 0.00000999999974738f);
    ...
    float3 diffuse_0 = diffuseColor_1 / _S45;
    ...
    else
    {
        ...
        float3 specularTint_0 = mix(float3(1.0f, 1.0f, 1.0f), diffuseColor_1, _S47);
    ...
    float3 _S53 = normalize((((float4(diffuseColor_0, 0.0f)) * (_S52))).xyz);
    float3 _S54 = (((float4(_S1.eyePosition_0, 1.0f)) * (_S52))).xyz;
    float4 _S55 = float4(surface_0.lightColorAmbient_0) ;
    float3 color_0 = diffuseColor_1 * float3(_S55.w)  + diffuseColor_1 * _S48.xyz;
    ...
    for(;;)
    {
        ...
        {
            _S61 = (float4((&_S4->lightColorIntensity_0)->data_1[lightIndex_0]) ).xyz;
        }
        bool _S62;
        if(_S57)
        {
        ...
        for(;;)
        {
            ...
            float3 directDiffuse_0 = diffuse_1 * (_S30 - _S77);
            ...
            float3 _S83 = _S61 * float3(sampleIntensity_1) ;
    ...
    pixelOutput_0 _S84 = { float4(color_1, opacity_1) };
    return _S84;
}
