...
[[fragment]] pixelOutput_0 fragmentMain_uv_normal_roughmetal_metallic(pixelInput_0 _S1 [[stage_in]], bool isFrontFace_0 [[front_facing]], float4 position_0 [[position]], SurfaceParameters_natural_0 device* surfaceParameters_1 [[buffer(7)]], FrameParameters_natural_0 device* frameParameters_1 [[buffer(8)]], texture2d<float, access::sample> normalTexture_1 [[texture(1)]], sampler normalSampler_1 [[sampler(1)]], texture2d<float, access::sample> roughnessMetallicTexture_1 [[texture(2)]], sampler roughnessMetallicSampler_1 [[sampler(2)]], texture2d<float, access::sample> metallicTexture_1 [[texture(4)]], sampler metallicSampler_1 [[sampler(5)]])
{
    uint4 _S2;
    ...
    uint _S13 = uint(round(_S11.w));
    bool _S14 = (_S13 & 2U) != 0U;
    for(;;)
    {
        if(!_S14)
        {
        ...
        texture2d<float, access::sample> _S15 = (&kernelContext_0)->normalTexture_0;
        ...
        float4 metadata_0 = round((((&kernelContext_0)->normalTexture_0).read(vec<uint,2>(((_S16)).xy), uint(((_S16)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S3 = (((&kernelContext_0)->normalTexture_0).read(vec<uint,2>(((_S18)).xy), uint(((_S18)).z)));
            break;
        }
    ...
    float3 _S22 = float3(1.0f) ;
    float3 sampledNormal_0 = _S3.xyz * float3(2.0f)  - _S22;
    ...
    for(;;)
    {
        ...
        texture2d<float, access::sample> _S24 = (&kernelContext_0)->roughnessMetallicTexture_0;
        ...
        float4 metadata_1 = round((((&kernelContext_0)->roughnessMetallicTexture_0).read(vec<uint,2>(((_S25)).xy), uint(((_S25)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S3 = (((&kernelContext_0)->roughnessMetallicTexture_0).read(vec<uint,2>(((_S27)).xy), uint(((_S27)).z)));
            break;
        }
    ...
    float4 _S39 = float4(surface_0.metallicRoughnessThresholdWorkflow_0) ;
    float opacityThreshold_0 = _S39.z;
    ...
    {
        _S40 = - _S1.eyePosition_0 * float3(rsqrt(lengthSquared_0)) ;
    }
    else
    {
        _S40 = float3(0.0f, 0.0f, 1.0f);
    }
    float3 normal_2;
    if(isFrontFace_0)
    {
    ...
    float _S41 = saturate(abs(dot(normal_2, _S40)) + 0.00000999999974738f);
    float _S42 = max(0.00100000004749745f, roughness_0);
    float _S43 = _S8.x;
    float _S44 = max(0.00100000004749745f, _S8.y);
    float4 _S45 = float4(surface_0.specularIor_0) ;
    float _S46 = _S45.w;
    float reflectanceRatio_0 = (1.0f - _S46) / (1.0f + _S46);
    float3 _S47 = float3(3.14159274101257324f) ;
    float3 diffuse_0 = diffuseColor_0 / _S47;
    float3 normalIncidence_0;
    float3 grazingIncidence_0;
    float3 diffuse_1;
    if((_S39.w) >= 0.5f)
    {
        float3 _S48 = float3(1.0f, 1.0f, 1.0f);
        normalIncidence_0 = _S45.xyz;
        grazingIncidence_0 = _S48;
        diffuse_1 = diffuse_0;
    }
    else
    {
        float3 _S49 = float3(metallic_0) ;
        float3 specularTint_0 = mix(float3(1.0f, 1.0f, 1.0f), diffuseColor_0, _S49);
        float3 diffuse_2 = diffuse_0 * float3((1.0f - metallic_0)) ;
        normalIncidence_0 = mix(float3((reflectanceRatio_0 * reflectanceRatio_0))  * specularTint_0, specularTint_0, _S49);
        grazingIncidence_0 = specularTint_0;
        diffuse_1 = diffuse_2;
    }
    float4 _S50 = float4(_S4->ambientLight_0) ;
    float _S51 = _S50.w;
    if(_S51 > 0.5f)
    {
        hasSceneLighting_0 = true;
    ...
    {
        float3 _S52 = _S50.xyz;
        hasSceneLighting_0 = (dot(_S52, _S52)) > 0.0f;
    }
    uint _S53 = min(uint(_S51), 8U);
    matrix<float,int(4),int(4)>  _S54 = matrix<float,int(4),int(4)> (_S4->eyeToWorld_0.data_0[int(0)][int(0)], _S4->eyeToWorld_0.data_0[int(0)][int(1)], _S4->eyeToWorld_0.data_0[int(0)][int(2)], _S4->eyeToWorld_0.data_0[int(0)][int(3)], _S4->eyeToWorld_0.data_0[int(1)][int(0)], _S4->eyeToWorld_0.data_0[int(1)][int(1)], _S4->eyeToWorld_0.data_0[int(1)][int(2)], _S4->eyeToWorld_0.data_0[int(1)][int(3)], _S4->eyeToWorld_0.data_0[int(2)][int(0)], _S4->eyeToWorld_0.data_0[int(2)][int(1)], _S4->eyeToWorld_0.data_0[int(2)][int(2)], _S4->eyeToWorld_0.data_0[int(2)][int(3)], _S4->eyeToWorld_0.data_0[int(3)][int(0)], _S4->eyeToWorld_0.data_0[int(3)][int(1)], _S4->eyeToWorld_0.data_0[int(3)][int(2)], _S4->eyeToWorld_0.data_0[int(3)][int(3)]);
    float3 _S55 = normalize((((float4(_S40, 0.0f)) * (_S54))).xyz);
    float3 _S56 = (((float4(_S1.eyePosition_0, 1.0f)) * (_S54))).xyz;
    float4 _S57 = float4(surface_0.lightColorAmbient_0) ;
    float3 color_0 = diffuseColor_0 * float3(_S57.w)  + diffuseColor_0 * _S50.xyz;
    bool _S58 = !hasSceneLighting_0;
    uint lightCount_0;
    if(_S58)
    {
        lightCount_0 = 1U;
    ...
    for(;;)
    {
        ...
        bool _S59 = lightIndex_0 == 0U;
        if(_S59)
        {
            hasSceneLighting_0 = _S58;
        }
        else
        {
            hasSceneLighting_0 = false;
        ...
        if(_S61)
        {
            _S62 = (float4(surface_0.lightDirectionIntensity_0) ).w;
        }
        else
        {
            _S62 = (float4((&_S4->lightColorIntensity_0)->data_1[lightIndex_0]) ).w;
        }
        bool _S63;
        if(_S59)
        {
        ...
        {
            _S65 = (float4((&_S4->lightControls_0)->data_1[lightIndex_0]) ).x;
        }
        bool _S66;
        if(_S59)
        {
        ...
        {
            _S67 = (float4((&_S4->lightControls_0)->data_1[lightIndex_0]) ).y;
        }
        bool _S68;
        if(_S59)
        {
        ...
        sampleOffsets_0[int(0)] = _S75;
        sampleOffsets_0[int(1)] = _S75;
        sampleOffsets_0[int(2)] = _S75;
        sampleOffsets_0[int(3)] = _S75;
        sampleOffsets_0[int(4)] = _S75;
        float sampleCount_0;
        if(lightType_0 == 3.0f)
        {
            ...
            float3 _S76 = - halfWidth_0;
            sampleOffsets_0[int(3)] = _S76 + halfHeight_0;
            sampleOffsets_0[int(4)] = _S76 - halfHeight_0;
            sampleCount_0 = 5.0f;
        }
        else
        {
        ...
        for(;;)
        {
            ...
            float sampleIntensity_0 = _S62 / sampleCount_0;
            float3 sampleDirection_0;
            float emissionScale_0;
            float sampleIntensity_1;
            if(lightType_0 >= 2.0f)
            {
                float3 toLight_0 = (float4((&_S4->lightPositionType_0)->data_1[lightIndex_0]) ).xyz + sampleOffsets_0[sampleIndex_0] - _S56;
                float _S77 = max(dot(toLight_0, toLight_0), 0.00100000004749745f);
                float3 sampleDirection_1 = toLight_0 * float3(rsqrt(_S77)) ;
                float sampleIntensity_2 = sampleIntensity_0 / _S77;
                if(lightType_0 == 4.0f)
                {
            ...
            float3 half_0 = normalize(sampleDirection_0 + _S74);
            float normalDotLight_0 = saturate(dot(normal_2, sampleDirection_0));
            float normalDotHalf_0 = saturate(dot(normal_2, half_0));
            float3 _S78 = float3(pow(max(0.0f, 1.0f - saturate(dot(_S74, half_0))), 5.0f)) ;
            float3 _S79 = mix(normalIncidence_0, grazingIncidence_0, _S78);
            float3 directDiffuse_0 = diffuse_1 * (_S22 - _S79);
            float alpha_0 = _S42 * _S42;
            float alphaSquared_0 = alpha_0 * alpha_0;
            float _S80 = normalDotHalf_0 * normalDotHalf_0;
            float denominator_0 = _S80 * (alphaSquared_0 - 1.0f) + 1.0f;
            float k_0 = alpha_0 * 0.5f;
            float _S81 = 1.0f - k_0;
            float3 _S82 = float3((4.0f * normalDotLight_0 * _S41 + 0.00100000004749745f)) ;
            float3 _S83 = _S79 * float3((_S41 / (_S41 * _S81 + k_0) * (normalDotLight_0 / (normalDotLight_0 * _S81 + k_0))))  * float3(((alphaSquared_0 + 0.00100000004749745f) / (denominator_0 * denominator_0 * 3.14159274101257324f)))  / _S82;
            float3 directSpecular_0;
            if(_S43 > 0.0f)
            {
                float alpha_1 = _S44 * _S44;
                float alphaSquared_1 = alpha_1 * alpha_1;
                float denominator_1 = _S80 * (alphaSquared_1 - 1.0f) + 1.0f;
                float k_1 = alpha_1 * 0.5f;
                float _S84 = 1.0f - k_1;
                directSpecular_0 = _S83 + float3(_S43)  * (mix(float3((reflectanceRatio_0 * reflectanceRatio_0)) , float3(1.0f, 1.0f, 1.0f), _S78) * float3((_S41 / (_S41 * _S84 + k_1) * (normalDotLight_0 / (normalDotLight_0 * _S84 + k_1))))  * float3(((alphaSquared_1 + 0.00100000004749745f) / (denominator_1 * denominator_1 * 3.14159274101257324f)))  / _S82);
            }
            else
            {
                directSpecular_0 = _S83;
            }
            float3 _S85 = diffuseColor_0 * float3(sampleIntensity_1) ;
            color_2 = color_2 + float3((_S10 * emissionScale_0 * normalDotLight_0))  * (directDiffuse_0 * float3(_S65)  * (_S85 * _S47) + directSpecular_0 * float3(_S67)  * _S85);
            sampleIndex_0 = sampleIndex_0 + 1U;
        }
    ...
    if((_S2.y) == 1U)
    {
        color_1 = color_3 / (_S22 + max(color_3, float3(0.0f, 0.0f, 0.0f)));
    }
    else
    {
        color_1 = color_3;
    }
    pixelOutput_0 _S86 = { float4(color_1, opacity_0) };
    return _S86;
}
