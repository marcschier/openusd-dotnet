...
[[fragment]] pixelOutput_0 fragmentMain_uv_basecolor_normal_roughmetal_metallic(pixelInput_0 _S1 [[stage_in]], bool isFrontFace_0 [[front_facing]], float4 position_0 [[position]], SurfaceParameters_natural_0 device* surfaceParameters_1 [[buffer(7)]], FrameParameters_natural_0 device* frameParameters_1 [[buffer(8)]], texture2d<float, access::sample> baseColorTexture_1 [[texture(0)]], sampler baseColorSampler_1 [[sampler(0)]], texture2d<float, access::sample> normalTexture_1 [[texture(1)]], sampler normalSampler_1 [[sampler(1)]], texture2d<float, access::sample> roughnessMetallicTexture_1 [[texture(2)]], sampler roughnessMetallicSampler_1 [[sampler(2)]], texture2d<float, access::sample> metallicTexture_1 [[texture(4)]], sampler metallicSampler_1 [[sampler(5)]])
{
    ...
    for(;;)
    {
        ...
        float4 metadata_3 = round((((&kernelContext_0)->metallicTexture_0).read(vec<uint,2>(((_S41)).xy), uint(((_S41)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S3 = (((&kernelContext_0)->metallicTexture_0).read(vec<uint,2>(((_S43)).xy), uint(((_S43)).z)));
            break;
        }
    ...
    float4 _S47 = float4(surface_0.metallicRoughnessThresholdWorkflow_0) ;
    float opacityThreshold_0 = _S47.z;
    ...
    float _S48 = saturate(abs(dot(normal_2, diffuseColor_0)) + 0.00000999999974738f);
    ...
    float3 diffuse_0 = diffuseColor_1 / _S54;
    ...
    else
    {
        ...
        float3 specularTint_0 = mix(float3(1.0f, 1.0f, 1.0f), diffuseColor_1, _S56);
    ...
    float3 _S62 = normalize((((float4(diffuseColor_0, 0.0f)) * (_S61))).xyz);
    float3 _S63 = (((float4(_S1.eyePosition_0, 1.0f)) * (_S61))).xyz;
    float4 _S64 = float4(surface_0.lightColorAmbient_0) ;
    float3 color_0 = diffuseColor_1 * float3(_S64.w)  + diffuseColor_1 * _S57.xyz;
    ...
    for(;;)
    {
        ...
        {
            _S70 = (float4((&_S4->lightColorIntensity_0)->data_1[lightIndex_0]) ).xyz;
        }
        bool _S71;
        if(_S66)
        {
        ...
        for(;;)
        {
            ...
            float3 directDiffuse_0 = diffuse_1 * (_S30 - _S86);
            ...
            float3 _S92 = _S70 * float3(sampleIntensity_1) ;
            color_2 = color_2 + float3((_S10 * emissionScale_0 * normalDotLight_0))  * (directDiffuse_0 * float3(_S72)  * (_S92 * _S54) + directSpecular_0 * float3(_S74)  * _S92);
            sampleIndex_0 = sampleIndex_0 + 1U;
        }
    ...
    pixelOutput_0 _S93 = { float4(color_1, opacity_1) };
    return _S93;
}
