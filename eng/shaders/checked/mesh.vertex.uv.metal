...
[[vertex]] vertexMain_uv_Result_0 vertexMain_uv(vertexInput_0 _S1 [[stage_in]], uint instanceId_0 [[instance_id]], InstanceParameters_natural_0 device* instanceParameters_1 [[buffer(6)]], FrameParameters_natural_0 device* frameParameters_1 [[buffer(8)]])
{
    ...
    thread vertexMain_uv_Result_0 _S5;
