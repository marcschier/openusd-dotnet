...
[[fragment]] pixelOutput_0 fragmentMain_uv_material_normal(pixelInput_0 _S1 [[stage_in]], bool isFrontFace_0 [[front_facing]], float4 position_0 [[position]], SurfaceParameters_natural_0 device* surfaceParameters_1 [[buffer(7)]], FrameParameters_natural_0 device* frameParameters_1 [[buffer(8)]], texture2d<float, access::sample> baseColorTexture_1 [[texture(0)]], sampler baseColorSampler_1 [[sampler(0)]], texture2d<float, access::sample> normalTexture_1 [[texture(1)]], sampler normalSampler_1 [[sampler(1)]], texture2d<float, access::sample> roughnessMetallicTexture_1 [[texture(2)]], sampler roughnessMetallicSampler_1 [[sampler(2)]], texture2d<float, access::sample> metallicTexture_1 [[texture(4)]], sampler metallicSampler_1 [[sampler(5)]], texture2d<float, access::sample> emissiveTexture_1 [[texture(3)]], sampler emissiveSampler_1 [[sampler(3)]], texture2d<float, access::sample> opacityTexture_1 [[texture(5)]], sampler opacitySampler_1 [[sampler(6)]], texture2d<float, access::sample> occlusionTexture_1 [[texture(10)]], sampler occlusionSampler_1 [[sampler(7)]], texture2d<float, access::sample> specularColorTexture_1 [[texture(11)]], sampler specularColorSampler_1 [[sampler(8)]])
{
    ...
    bool _S29 = (udimMask_0 & 4U) != 0U;
    for(;;)
    {
        if(!_S29)
        {
            _S20 = (((&kernelContext_0)->normalTexture_0).sample(((&kernelContext_0)->normalSampler_0), (_S1.texCoord_0)));
            break;
        }
        texture2d<float, access::sample> _S30 = (&kernelContext_0)->normalTexture_0;
        ...
        float4 metadata_1 = round((((&kernelContext_0)->normalTexture_0).read(vec<uint,2>(((_S31)).xy), uint(((_S31)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S20 = (((&kernelContext_0)->normalTexture_0).read(vec<uint,2>(((_S33)).xy), uint(((_S33)).z)));
            break;
        }
        ...
        _S20 = (((&kernelContext_0)->normalTexture_0).sample(((&kernelContext_0)->normalSampler_0), ((float2(tile_1) * cellSize_1 + float2(1.5f, 2.5f) + fract(_S1.texCoord_0) * max(cellSize_1 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_1), float(atlasHeight_1)))));
        break;
    }
    float3 _S37 = float3(1.0f) ;
    float3 sampledNormal_0 = _S20.xyz * float3(2.0f)  - _S37;
    ...
    if((textureMask_0 & 8U) != 0U)
    {
        ...
        for(;;)
        {
            ...
            texture2d<float, access::sample> _S39 = (&kernelContext_0)->roughnessMetallicTexture_0;
            thread uint atlasWidth_2;
            thread uint atlasHeight_2;
            (*((&atlasWidth_2)) = (_S39).get_width(0)),(*((&atlasHeight_2)) = (_S39).get_height(0));
            int3 _S40 = int3(int(0), int(0), int(0));
            float4 metadata_2 = round((((&kernelContext_0)->roughnessMetallicTexture_0).read(vec<uint,2>(((_S40)).xy), uint(((_S40)).z))) * float4(255.0f) );
            int2 _S41 = int2(metadata_2.zw);
            ...
            {
                hasSceneLighting_0 = any(tile_2 >= _S41);
            }
            if(hasSceneLighting_0)
            {
                int3 _S42 = int3(int(min(1U, atlasWidth_2 - 1U)), int(0), int(0));
                _S20 = (((&kernelContext_0)->roughnessMetallicTexture_0).read(vec<uint,2>(((_S42)).xy), uint(((_S42)).z)));
                break;
            }
            uint _S43 = atlasWidth_2 / uint(_S41.x);
            float _S44 = float(_S43);
            uint _S45 = (atlasHeight_2 - 1U) / uint(_S41.y);
            float2 cellSize_2 = float2(_S44, float(_S45));
            _S20 = (((&kernelContext_0)->roughnessMetallicTexture_0).sample(((&kernelContext_0)->roughnessMetallicSampler_0), ((float2(tile_2) * cellSize_2 + float2(1.5f, 2.5f) + fract(_S1.texCoord_0) * max(cellSize_2 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_2), float(atlasHeight_2)))));
            break;
        }
    ...
    if((textureMask_0 & 32U) != 0U)
    {
        ...
        for(;;)
        {
            ...
            texture2d<float, access::sample> _S47 = (&kernelContext_0)->metallicTexture_0;
            thread uint atlasWidth_3;
            thread uint atlasHeight_3;
            (*((&atlasWidth_3)) = (_S47).get_width(0)),(*((&atlasHeight_3)) = (_S47).get_height(0));
            int3 _S48 = int3(int(0), int(0), int(0));
            float4 metadata_3 = round((((&kernelContext_0)->metallicTexture_0).read(vec<uint,2>(((_S48)).xy), uint(((_S48)).z))) * float4(255.0f) );
            int2 _S49 = int2(metadata_3.zw);
            ...
            {
                hasSceneLighting_0 = any(tile_3 >= _S49);
            }
            if(hasSceneLighting_0)
            {
                int3 _S50 = int3(int(min(1U, atlasWidth_3 - 1U)), int(0), int(0));
                _S20 = (((&kernelContext_0)->metallicTexture_0).read(vec<uint,2>(((_S50)).xy), uint(((_S50)).z)));
                break;
            }
            uint _S51 = atlasWidth_3 / uint(_S49.x);
            float _S52 = float(_S51);
            uint _S53 = (atlasHeight_3 - 1U) / uint(_S49.y);
            float2 cellSize_3 = float2(_S52, float(_S53));
            _S20 = (((&kernelContext_0)->metallicTexture_0).sample(((&kernelContext_0)->metallicSampler_0), ((float2(tile_3) * cellSize_3 + float2(1.5f, 2.5f) + fract(_S1.texCoord_0) * max(cellSize_3 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_3), float(atlasHeight_3)))));
            break;
        }
    ...
    if((textureMask_0 & 16U) != 0U)
    {
        ...
        for(;;)
        {
            ...
            texture2d<float, access::sample> _S55 = (&kernelContext_0)->emissiveTexture_0;
            thread uint atlasWidth_4;
            thread uint atlasHeight_4;
            (*((&atlasWidth_4)) = (_S55).get_width(0)),(*((&atlasHeight_4)) = (_S55).get_height(0));
            int3 _S56 = int3(int(0), int(0), int(0));
            float4 metadata_4 = round((((&kernelContext_0)->emissiveTexture_0).read(vec<uint,2>(((_S56)).xy), uint(((_S56)).z))) * float4(255.0f) );
            int2 _S57 = int2(metadata_4.zw);
            ...
            {
                hasSceneLighting_0 = any(tile_4 >= _S57);
            }
            if(hasSceneLighting_0)
            {
                int3 _S58 = int3(int(min(1U, atlasWidth_4 - 1U)), int(0), int(0));
                _S20 = (((&kernelContext_0)->emissiveTexture_0).read(vec<uint,2>(((_S58)).xy), uint(((_S58)).z)));
                break;
            }
            uint _S59 = atlasWidth_4 / uint(_S57.x);
            float _S60 = float(_S59);
            uint _S61 = (atlasHeight_4 - 1U) / uint(_S57.y);
            float2 cellSize_4 = float2(_S60, float(_S61));
            _S20 = (((&kernelContext_0)->emissiveTexture_0).sample(((&kernelContext_0)->emissiveSampler_0), ((float2(tile_4) * cellSize_4 + float2(1.5f, 2.5f) + fract(_S1.texCoord_0) * max(cellSize_4 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_4), float(atlasHeight_4)))));
            break;
        }
    ...
    if((textureMask_0 & 64U) != 0U)
    {
        ...
        for(;;)
        {
            ...
            texture2d<float, access::sample> _S63 = (&kernelContext_0)->opacityTexture_0;
            thread uint atlasWidth_5;
            thread uint atlasHeight_5;
            (*((&atlasWidth_5)) = (_S63).get_width(0)),(*((&atlasHeight_5)) = (_S63).get_height(0));
            int3 _S64 = int3(int(0), int(0), int(0));
            float4 metadata_5 = round((((&kernelContext_0)->opacityTexture_0).read(vec<uint,2>(((_S64)).xy), uint(((_S64)).z))) * float4(255.0f) );
            int2 _S65 = int2(metadata_5.zw);
            ...
            {
                hasSceneLighting_0 = any(tile_5 >= _S65);
            }
            if(hasSceneLighting_0)
            {
                int3 _S66 = int3(int(min(1U, atlasWidth_5 - 1U)), int(0), int(0));
                _S20 = (((&kernelContext_0)->opacityTexture_0).read(vec<uint,2>(((_S66)).xy), uint(((_S66)).z)));
                break;
            }
            uint _S67 = atlasWidth_5 / uint(_S65.x);
            float _S68 = float(_S67);
            uint _S69 = (atlasHeight_5 - 1U) / uint(_S65.y);
            float2 cellSize_5 = float2(_S68, float(_S69));
            _S20 = (((&kernelContext_0)->opacityTexture_0).sample(((&kernelContext_0)->opacitySampler_0), ((float2(tile_5) * cellSize_5 + float2(1.5f, 2.5f) + fract(_S1.texCoord_0) * max(cellSize_5 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_5), float(atlasHeight_5)))));
            break;
        }
    ...
    if((textureMask_0 & 128U) != 0U)
    {
        ...
        for(;;)
        {
            ...
            texture2d<float, access::sample> _S71 = (&kernelContext_0)->occlusionTexture_0;
            thread uint atlasWidth_6;
            thread uint atlasHeight_6;
            (*((&atlasWidth_6)) = (_S71).get_width(0)),(*((&atlasHeight_6)) = (_S71).get_height(0));
            int3 _S72 = int3(int(0), int(0), int(0));
            float4 metadata_6 = round((((&kernelContext_0)->occlusionTexture_0).read(vec<uint,2>(((_S72)).xy), uint(((_S72)).z))) * float4(255.0f) );
            int2 _S73 = int2(metadata_6.zw);
            ...
            {
                hasSceneLighting_0 = any(tile_6 >= _S73);
            }
            if(hasSceneLighting_0)
            {
                int3 _S74 = int3(int(min(1U, atlasWidth_6 - 1U)), int(0), int(0));
                _S20 = (((&kernelContext_0)->occlusionTexture_0).read(vec<uint,2>(((_S74)).xy), uint(((_S74)).z)));
                break;
            }
            uint _S75 = atlasWidth_6 / uint(_S73.x);
            float _S76 = float(_S75);
            uint _S77 = (atlasHeight_6 - 1U) / uint(_S73.y);
            float2 cellSize_6 = float2(_S76, float(_S77));
            _S20 = (((&kernelContext_0)->occlusionTexture_0).sample(((&kernelContext_0)->occlusionSampler_0), ((float2(tile_6) * cellSize_6 + float2(1.5f, 2.5f) + fract(_S1.texCoord_0) * max(cellSize_6 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_6), float(atlasHeight_6)))));
            break;
        }
    ...
    if((textureMask_0 & 256U) != 0U)
    {
        ...
        for(;;)
        {
            ...
            texture2d<float, access::sample> _S79 = (&kernelContext_0)->specularColorTexture_0;
            thread uint atlasWidth_7;
            thread uint atlasHeight_7;
            (*((&atlasWidth_7)) = (_S79).get_width(0)),(*((&atlasHeight_7)) = (_S79).get_height(0));
            int3 _S80 = int3(int(0), int(0), int(0));
            float4 metadata_7 = round((((&kernelContext_0)->specularColorTexture_0).read(vec<uint,2>(((_S80)).xy), uint(((_S80)).z))) * float4(255.0f) );
            int2 _S81 = int2(metadata_7.zw);
            ...
            {
                hasSceneLighting_0 = any(tile_7 >= _S81);
            }
            if(hasSceneLighting_0)
            {
                int3 _S82 = int3(int(min(1U, atlasWidth_7 - 1U)), int(0), int(0));
                _S20 = (((&kernelContext_0)->specularColorTexture_0).read(vec<uint,2>(((_S82)).xy), uint(((_S82)).z)));
                break;
            }
            uint _S83 = atlasWidth_7 / uint(_S81.x);
            float _S84 = float(_S83);
            uint _S85 = (atlasHeight_7 - 1U) / uint(_S81.y);
            float2 cellSize_7 = float2(_S84, float(_S85));
            _S20 = (((&kernelContext_0)->specularColorTexture_0).sample(((&kernelContext_0)->specularColorSampler_0), ((float2(tile_7) * cellSize_7 + float2(1.5f, 2.5f) + fract(_S1.texCoord_0) * max(cellSize_7 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_7), float(atlasHeight_7)))));
            break;
        }
    ...
    {
        _S86 = - _S1.eyePosition_0 * float3(rsqrt(lengthSquared_0)) ;
    }
    else
    {
        _S86 = float3(0.0f, 0.0f, 1.0f);
    }
    float3 normal_2;
    if(isFrontFace_0)
    {
    ...
    float _S87 = saturate(abs(dot(normal_2, _S86)) + 0.00000999999974738f);
    float _S88 = max(0.00100000004749745f, roughness_0);
    float _S89 = _S8.x;
    float _S90 = max(0.00100000004749745f, _S8.y);
    float _S91 = _S17.w;
    float reflectanceRatio_0 = (1.0f - _S91) / (1.0f + _S91);
    float3 _S92 = float3(3.14159274101257324f) ;
    float3 diffuse_0 = diffuseColor_0 / _S92;
    float3 normalIncidence_0;
    float3 grazingIncidence_0;
    float3 diffuse_1;
    if((_S14.w) >= 0.5f)
    {
        float3 _S93 = float3(1.0f, 1.0f, 1.0f);
        normalIncidence_0 = specularColor_0;
        grazingIncidence_0 = _S93;
        diffuse_1 = diffuse_0;
    }
    else
    {
        float3 _S94 = float3(metallic_0) ;
        float3 specularTint_0 = mix(float3(1.0f, 1.0f, 1.0f), diffuseColor_0, _S94);
        float3 diffuse_2 = diffuse_0 * float3((1.0f - metallic_0)) ;
        normalIncidence_0 = mix(float3((reflectanceRatio_0 * reflectanceRatio_0))  * specularTint_0, specularTint_0, _S94);
        grazingIncidence_0 = specularTint_0;
        diffuse_1 = diffuse_2;
    }
    float4 _S95 = float4(_S4->ambientLight_0) ;
    float _S96 = _S95.w;
    if(_S96 > 0.5f)
    {
        hasSceneLighting_0 = true;
    ...
    {
        float3 _S97 = _S95.xyz;
        hasSceneLighting_0 = (dot(_S97, _S97)) > 0.0f;
    }
    uint _S98 = min(uint(_S96), 8U);
    matrix<float,int(4),int(4)>  _S99 = matrix<float,int(4),int(4)> (_S4->eyeToWorld_0.data_0[int(0)][int(0)], _S4->eyeToWorld_0.data_0[int(0)][int(1)], _S4->eyeToWorld_0.data_0[int(0)][int(2)], _S4->eyeToWorld_0.data_0[int(0)][int(3)], _S4->eyeToWorld_0.data_0[int(1)][int(0)], _S4->eyeToWorld_0.data_0[int(1)][int(1)], _S4->eyeToWorld_0.data_0[int(1)][int(2)], _S4->eyeToWorld_0.data_0[int(1)][int(3)], _S4->eyeToWorld_0.data_0[int(2)][int(0)], _S4->eyeToWorld_0.data_0[int(2)][int(1)], _S4->eyeToWorld_0.data_0[int(2)][int(2)], _S4->eyeToWorld_0.data_0[int(2)][int(3)], _S4->eyeToWorld_0.data_0[int(3)][int(0)], _S4->eyeToWorld_0.data_0[int(3)][int(1)], _S4->eyeToWorld_0.data_0[int(3)][int(2)], _S4->eyeToWorld_0.data_0[int(3)][int(3)]);
    float3 _S100 = normalize((((float4(_S86, 0.0f)) * (_S99))).xyz);
    float3 _S101 = (((float4(_S1.eyePosition_0, 1.0f)) * (_S99))).xyz;
    float4 _S102 = float4(_S3->lightColorAmbient_0) ;
    float3 color_0 = diffuseColor_0 * float3(_S102.w)  + diffuseColor_0 * _S95.xyz;
    bool _S103 = !hasSceneLighting_0;
    uint lightCount_0;
    if(_S103)
    {
        lightCount_0 = 1U;
    ...
    for(;;)
    {
        ...
        bool _S104 = lightIndex_0 == 0U;
        if(_S104)
        {
            hasSceneLighting_0 = _S103;
        }
        else
        {
            hasSceneLighting_0 = false;
        ...
        {
            _S110 = (float4((&_S4->lightControls_0)->data_1[lightIndex_0]) ).y;
        }
        bool _S111;
        if(_S104)
        {
        ...
        if(_S116)
        {
            specularColor_0 = _S86;
        }
        else
        {
            specularColor_0 = _S100;
        }
        thread array<float3, int(5)> sampleOffsets_0;
        float3 _S117 = float3(0.0f, 0.0f, 0.0f);
        sampleOffsets_0[int(0)] = _S117;
        sampleOffsets_0[int(1)] = _S117;
        sampleOffsets_0[int(2)] = _S117;
        sampleOffsets_0[int(3)] = _S117;
        sampleOffsets_0[int(4)] = _S117;
        float sampleCount_0;
        if(lightType_0 == 3.0f)
        {
            ...
            float3 _S118 = - halfWidth_0;
            sampleOffsets_0[int(3)] = _S118 + halfHeight_0;
            sampleOffsets_0[int(4)] = _S118 - halfHeight_0;
            sampleCount_0 = 5.0f;
        }
        else
        {
        ...
        for(;;)
        {
            ...
            if(lightType_0 >= 2.0f)
            {
                float3 toLight_0 = (float4((&_S4->lightPositionType_0)->data_1[lightIndex_0]) ).xyz + sampleOffsets_0[sampleIndex_0] - _S101;
                float _S119 = max(dot(toLight_0, toLight_0), 0.00100000004749745f);
                float3 sampleDirection_1 = toLight_0 * float3(rsqrt(_S119)) ;
                float sampleIntensity_2 = sampleIntensity_0 / _S119;
                if(lightType_0 == 4.0f)
                {
            ...
            float3 _S120 = float3(pow(max(0.0f, 1.0f - saturate(dot(specularColor_0, half_0))), 5.0f)) ;
            float3 _S121 = mix(normalIncidence_0, grazingIncidence_0, _S120);
            float3 directDiffuse_0 = diffuse_1 * (_S37 - _S121);
            float alpha_0 = _S88 * _S88;
            float alphaSquared_0 = alpha_0 * alpha_0;
            float _S122 = normalDotHalf_0 * normalDotHalf_0;
            float denominator_0 = _S122 * (alphaSquared_0 - 1.0f) + 1.0f;
            float k_0 = alpha_0 * 0.5f;
            float _S123 = 1.0f - k_0;
            float3 _S124 = float3((4.0f * normalDotLight_0 * _S87 + 0.00100000004749745f)) ;
            float3 _S125 = _S121 * float3((_S87 / (_S87 * _S123 + k_0) * (normalDotLight_0 / (normalDotLight_0 * _S123 + k_0))))  * float3(((alphaSquared_0 + 0.00100000004749745f) / (denominator_0 * denominator_0 * 3.14159274101257324f)))  / _S124;
            float3 directSpecular_0;
            if(_S89 > 0.0f)
            {
                float alpha_1 = _S90 * _S90;
                float alphaSquared_1 = alpha_1 * alpha_1;
                float denominator_1 = _S122 * (alphaSquared_1 - 1.0f) + 1.0f;
                float k_1 = alpha_1 * 0.5f;
                float _S126 = 1.0f - k_1;
                directSpecular_0 = _S125 + float3(_S89)  * (mix(float3((reflectanceRatio_0 * reflectanceRatio_0)) , float3(1.0f, 1.0f, 1.0f), _S120) * float3((_S87 / (_S87 * _S126 + k_1) * (normalDotLight_0 / (normalDotLight_0 * _S126 + k_1))))  * float3(((alphaSquared_1 + 0.00100000004749745f) / (denominator_1 * denominator_1 * 3.14159274101257324f)))  / _S124);
            }
            else
            {
                directSpecular_0 = _S125;
            }
            float3 _S127 = diffuseColor_0 * float3(sampleIntensity_1) ;
            color_2 = color_2 + float3((occlusion_0 * emissionScale_0 * normalDotLight_0))  * (directDiffuse_0 * float3(metallic_0)  * (_S127 * _S92) + directSpecular_0 * float3(_S110)  * _S127);
            sampleIndex_0 = sampleIndex_0 + 1U;
        }
    ...
    if((_S2.y) == 1U)
    {
        color_1 = color_3 / (_S37 + max(color_3, float3(0.0f, 0.0f, 0.0f)));
    }
    else
    {
        color_1 = color_3;
    }
    pixelOutput_0 _S128 = { float4(color_1, opacity_0) };
    return _S128;
}
