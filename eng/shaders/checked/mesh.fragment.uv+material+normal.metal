...
[[fragment]] pixelOutput_0 fragmentMain_uv_material_normal(pixelInput_0 _S1 [[stage_in]], bool isFrontFace_0 [[front_facing]], float4 position_0 [[position]], SurfaceParameters_natural_0 device* surfaceParameters_1 [[buffer(7)]], uint32_t device* frameParameters_1 [[buffer(8)]], texture2d<float, access::sample> baseColorTexture_1 [[texture(0)]], sampler baseColorSampler_1 [[sampler(0)]], texture2d<float, access::sample> compositeTexture_1 [[texture(15)]], sampler compositeSampler_1 [[sampler(12)]], texture2d<float, access::sample> normalTexture_1 [[texture(1)]], sampler normalSampler_1 [[sampler(1)]], texture2d<float, access::sample> roughnessMetallicTexture_1 [[texture(2)]], sampler roughnessMetallicSampler_1 [[sampler(2)]], texture2d<float, access::sample> metallicTexture_1 [[texture(4)]], sampler metallicSampler_1 [[sampler(5)]], texture2d<float, access::sample> emissiveTexture_1 [[texture(3)]], sampler emissiveSampler_1 [[sampler(3)]], texture2d<float, access::sample> opacityTexture_1 [[texture(5)]], sampler opacitySampler_1 [[sampler(6)]], texture2d<float, access::sample> occlusionTexture_1 [[texture(10)]], sampler occlusionSampler_1 [[sampler(7)]], texture2d<float, access::sample> specularColorTexture_1 [[texture(11)]], sampler specularColorSampler_1 [[sampler(8)]], texture2d<float, access::sample> clearcoatTexture_1 [[texture(12)]], sampler clearcoatSampler_1 [[sampler(9)]], texture2d<float, access::sample> clearcoatRoughnessTexture_1 [[texture(13)]], sampler clearcoatRoughnessSampler_1 [[sampler(10)]], texture2d<float, access::sample> iorTexture_1 [[texture(14)]], sampler iorSampler_1 [[sampler(11)]], texture2d<float, access::sample> shadowAtlas_1 [[texture(16)]], sampler shadowSampler_1 [[sampler(13)]], texture2d<float, access::sample> environmentBrdf_1 [[texture(19)]], sampler environmentBrdfSampler_1 [[sampler(15)]], texture2d<float, access::sample> environmentIrradiance_1 [[texture(17)]], sampler environmentSampler_1 [[sampler(14)]], texture2d<float, access::sample> environmentSpecular_1 [[texture(18)]])
{
    ...
    bool _S4815 = (udimMask_0 & 4U) != 0U;
    for(;;)
    {
        if(!_S4815)
        {
            _S4796 = (((&kernelContext_0)->normalTexture_0).sample(((&kernelContext_0)->normalSampler_0), (_S4795)));
            break;
        }
        texture2d<float, access::sample> _S4816 = (&kernelContext_0)->normalTexture_0;
        ...
        float4 metadata_2 = round((((&kernelContext_0)->normalTexture_0).read(vec<uint,2>(((_S4817)).xy), uint(((_S4817)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S4796 = (((&kernelContext_0)->normalTexture_0).read(vec<uint,2>(((_S4819)).xy), uint(((_S4819)).z)));
            break;
        }
        ...
        _S4796 = (((&kernelContext_0)->normalTexture_0).sample(((&kernelContext_0)->normalSampler_0), ((float2(tile_2) * cellSize_2 + float2(1.5f, 2.5f) + fract(_S4795) * max(cellSize_2 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_2), float(atlasHeight_2)))));
        break;
    }
    float3 _S4823 = float3(1.0f) ;
    float3 sampledNormal_0 = _S4796.xyz * float3(2.0f)  - _S4823;
    float3 tangent_1 = normalize(_S1.tangent_0.xyz);
    float3 _S4824 = float3(sampledNormal_0.x) ;
    float3 _S4825 = float3(sampledNormal_0.y) ;
    float3 _S4826 = float3(sampledNormal_0.z) ;
    float3 shadingNormal_0 = normalize(tangent_1 * _S4824 + cross(normalize(_S1.normal_0), tangent_1) * float3(_S1.tangent_0.w)  * _S4825 + _S1.normal_0 * _S4826);
    ...
    float3 worldShadingNormal_0 = normalize(worldTangentBasis_1 * _S4824 + cross(worldNormalBasis_0, worldTangentBasis_1) * float3(_S1.worldTangent_0.w)  * _S4825 + worldNormalBasis_0 * _S4826);
    float roughness_0;
    if((textureMask_0 & 8U) != 0U)
    {
        bool _S4827 = (udimMask_0 & 8U) != 0U;
        for(;;)
        {
            if(!_S4827)
            {
            ...
            texture2d<float, access::sample> _S4828 = (&kernelContext_0)->roughnessMetallicTexture_0;
            thread uint atlasWidth_3;
            thread uint atlasHeight_3;
            (*((&atlasWidth_3)) = (_S4828).get_width(0)),(*((&atlasHeight_3)) = (_S4828).get_height(0));
            int3 _S4829 = int3(int(0), int(0), int(0));
            float4 metadata_3 = round((((&kernelContext_0)->roughnessMetallicTexture_0).read(vec<uint,2>(((_S4829)).xy), uint(((_S4829)).z))) * float4(255.0f) );
            int2 _S4830 = int2(metadata_3.zw);
            ...
            {
                hasSceneLighting_0 = any(tile_3 >= _S4830);
            }
            if(hasSceneLighting_0)
            {
                int3 _S4831 = int3(int(min(1U, atlasWidth_3 - 1U)), int(0), int(0));
                _S4796 = (((&kernelContext_0)->roughnessMetallicTexture_0).read(vec<uint,2>(((_S4831)).xy), uint(((_S4831)).z)));
                break;
            }
            uint _S4832 = atlasWidth_3 / uint(_S4830.x);
            float _S4833 = float(_S4832);
            uint _S4834 = (atlasHeight_3 - 1U) / uint(_S4830.y);
            float2 cellSize_3 = float2(_S4833, float(_S4834));
            _S4796 = (((&kernelContext_0)->roughnessMetallicTexture_0).sample(((&kernelContext_0)->roughnessMetallicSampler_0), ((float2(tile_3) * cellSize_3 + float2(1.5f, 2.5f) + fract(_S4795) * max(cellSize_3 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_3), float(atlasHeight_3)))));
            break;
        }
        for(;;)
        {
            float4 _S4835 = float4(_S4->compositeControls_0) ;
            if((_S4835.x) != 8.0f)
            {
                break;
            }
            bool _S4836 = (_S4835.w) >= 0.5f;
            for(;;)
            {
                if(!_S4836)
                {
                ...
                texture2d<float, access::sample> _S4837 = (&kernelContext_0)->compositeTexture_0;
                thread uint atlasWidth_4;
                thread uint atlasHeight_4;
                (*((&atlasWidth_4)) = (_S4837).get_width(0)),(*((&atlasHeight_4)) = (_S4837).get_height(0));
                int3 _S4838 = int3(int(0), int(0), int(0));
                float4 metadata_4 = round((((&kernelContext_0)->compositeTexture_0).read(vec<uint,2>(((_S4838)).xy), uint(((_S4838)).z))) * float4(255.0f) );
                int2 _S4839 = int2(metadata_4.zw);
                ...
                {
                    hasSceneLighting_0 = any(tile_4 >= _S4839);
                }
                if(hasSceneLighting_0)
                {
                    int3 _S4840 = int3(int(min(1U, atlasWidth_4 - 1U)), int(0), int(0));
                    _S4797 = (((&kernelContext_0)->compositeTexture_0).read(vec<uint,2>(((_S4840)).xy), uint(((_S4840)).z)));
                    break;
                }
                uint _S4841 = atlasWidth_4 / uint(_S4839.x);
                float _S4842 = float(_S4841);
                uint _S4843 = (atlasHeight_4 - 1U) / uint(_S4839.y);
                float2 cellSize_4 = float2(_S4842, float(_S4843));
                _S4797 = (((&kernelContext_0)->compositeTexture_0).sample(((&kernelContext_0)->compositeSampler_0), ((float2(tile_4) * cellSize_4 + float2(1.5f, 2.5f) + fract(_S4795) * max(cellSize_4 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_4), float(atlasHeight_4)))));
                break;
            }
            uint operation_1 = uint(round(_S4835.y));
            if(operation_1 == 1U)
            {
                _S4796 = _S4796 * _S4797;
                break;
    ...
    if((textureMask_0 & 32U) != 0U)
    {
        ...
        for(;;)
        {
            ...
            texture2d<float, access::sample> _S4845 = (&kernelContext_0)->metallicTexture_0;
            thread uint atlasWidth_5;
            thread uint atlasHeight_5;
            (*((&atlasWidth_5)) = (_S4845).get_width(0)),(*((&atlasHeight_5)) = (_S4845).get_height(0));
            int3 _S4846 = int3(int(0), int(0), int(0));
            float4 metadata_5 = round((((&kernelContext_0)->metallicTexture_0).read(vec<uint,2>(((_S4846)).xy), uint(((_S4846)).z))) * float4(255.0f) );
            int2 _S4847 = int2(metadata_5.zw);
            ...
            {
                hasSceneLighting_0 = any(tile_5 >= _S4847);
            }
            if(hasSceneLighting_0)
            {
                int3 _S4848 = int3(int(min(1U, atlasWidth_5 - 1U)), int(0), int(0));
                _S4796 = (((&kernelContext_0)->metallicTexture_0).read(vec<uint,2>(((_S4848)).xy), uint(((_S4848)).z)));
                break;
            }
            uint _S4849 = atlasWidth_5 / uint(_S4847.x);
            float _S4850 = float(_S4849);
            uint _S4851 = (atlasHeight_5 - 1U) / uint(_S4847.y);
            float2 cellSize_5 = float2(_S4850, float(_S4851));
            _S4796 = (((&kernelContext_0)->metallicTexture_0).sample(((&kernelContext_0)->metallicSampler_0), ((float2(tile_5) * cellSize_5 + float2(1.5f, 2.5f) + fract(_S4795) * max(cellSize_5 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_5), float(atlasHeight_5)))));
            break;
        }
        for(;;)
        {
            float4 _S4852 = float4(_S4->compositeControls_0) ;
            if((_S4852.x) != 32.0f)
            {
                break;
            }
            bool _S4853 = (_S4852.w) >= 0.5f;
            for(;;)
            {
                if(!_S4853)
                {
                ...
                texture2d<float, access::sample> _S4854 = (&kernelContext_0)->compositeTexture_0;
                thread uint atlasWidth_6;
                thread uint atlasHeight_6;
                (*((&atlasWidth_6)) = (_S4854).get_width(0)),(*((&atlasHeight_6)) = (_S4854).get_height(0));
                int3 _S4855 = int3(int(0), int(0), int(0));
                float4 metadata_6 = round((((&kernelContext_0)->compositeTexture_0).read(vec<uint,2>(((_S4855)).xy), uint(((_S4855)).z))) * float4(255.0f) );
                int2 _S4856 = int2(metadata_6.zw);
                ...
                {
                    hasSceneLighting_0 = any(tile_6 >= _S4856);
                }
                if(hasSceneLighting_0)
                {
                    int3 _S4857 = int3(int(min(1U, atlasWidth_6 - 1U)), int(0), int(0));
                    _S4797 = (((&kernelContext_0)->compositeTexture_0).read(vec<uint,2>(((_S4857)).xy), uint(((_S4857)).z)));
                    break;
                }
                uint _S4858 = atlasWidth_6 / uint(_S4856.x);
                float _S4859 = float(_S4858);
                uint _S4860 = (atlasHeight_6 - 1U) / uint(_S4856.y);
                float2 cellSize_6 = float2(_S4859, float(_S4860));
                _S4797 = (((&kernelContext_0)->compositeTexture_0).sample(((&kernelContext_0)->compositeSampler_0), ((float2(tile_6) * cellSize_6 + float2(1.5f, 2.5f) + fract(_S4795) * max(cellSize_6 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_6), float(atlasHeight_6)))));
                break;
            }
            uint operation_2 = uint(round(_S4852.y));
            if(operation_2 == 1U)
            {
                _S4796 = _S4796 * _S4797;
                break;
    ...
    if((textureMask_0 & 16U) != 0U)
    {
        ...
        for(;;)
        {
            ...
            texture2d<float, access::sample> _S4862 = (&kernelContext_0)->emissiveTexture_0;
            thread uint atlasWidth_7;
            thread uint atlasHeight_7;
            (*((&atlasWidth_7)) = (_S4862).get_width(0)),(*((&atlasHeight_7)) = (_S4862).get_height(0));
            int3 _S4863 = int3(int(0), int(0), int(0));
            float4 metadata_7 = round((((&kernelContext_0)->emissiveTexture_0).read(vec<uint,2>(((_S4863)).xy), uint(((_S4863)).z))) * float4(255.0f) );
            int2 _S4864 = int2(metadata_7.zw);
            ...
            {
                hasSceneLighting_0 = any(tile_7 >= _S4864);
            }
            if(hasSceneLighting_0)
            {
                int3 _S4865 = int3(int(min(1U, atlasWidth_7 - 1U)), int(0), int(0));
                _S4796 = (((&kernelContext_0)->emissiveTexture_0).read(vec<uint,2>(((_S4865)).xy), uint(((_S4865)).z)));
                break;
            }
            uint _S4866 = atlasWidth_7 / uint(_S4864.x);
            float _S4867 = float(_S4866);
            uint _S4868 = (atlasHeight_7 - 1U) / uint(_S4864.y);
            float2 cellSize_7 = float2(_S4867, float(_S4868));
            _S4796 = (((&kernelContext_0)->emissiveTexture_0).sample(((&kernelContext_0)->emissiveSampler_0), ((float2(tile_7) * cellSize_7 + float2(1.5f, 2.5f) + fract(_S4795) * max(cellSize_7 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_7), float(atlasHeight_7)))));
            break;
        }
        for(;;)
        {
            float4 _S4869 = float4(_S4->compositeControls_0) ;
            if((_S4869.x) != 16.0f)
            {
                break;
            }
            bool _S4870 = (_S4869.w) >= 0.5f;
            for(;;)
            {
                if(!_S4870)
                {
                ...
                texture2d<float, access::sample> _S4871 = (&kernelContext_0)->compositeTexture_0;
                thread uint atlasWidth_8;
                thread uint atlasHeight_8;
                (*((&atlasWidth_8)) = (_S4871).get_width(0)),(*((&atlasHeight_8)) = (_S4871).get_height(0));
                int3 _S4872 = int3(int(0), int(0), int(0));
                float4 metadata_8 = round((((&kernelContext_0)->compositeTexture_0).read(vec<uint,2>(((_S4872)).xy), uint(((_S4872)).z))) * float4(255.0f) );
                int2 _S4873 = int2(metadata_8.zw);
                ...
                {
                    hasSceneLighting_0 = any(tile_8 >= _S4873);
                }
                if(hasSceneLighting_0)
                {
                    int3 _S4874 = int3(int(min(1U, atlasWidth_8 - 1U)), int(0), int(0));
                    _S4797 = (((&kernelContext_0)->compositeTexture_0).read(vec<uint,2>(((_S4874)).xy), uint(((_S4874)).z)));
                    break;
                }
                uint _S4875 = atlasWidth_8 / uint(_S4873.x);
                float _S4876 = float(_S4875);
                uint _S4877 = (atlasHeight_8 - 1U) / uint(_S4873.y);
                float2 cellSize_8 = float2(_S4876, float(_S4877));
                _S4797 = (((&kernelContext_0)->compositeTexture_0).sample(((&kernelContext_0)->compositeSampler_0), ((float2(tile_8) * cellSize_8 + float2(1.5f, 2.5f) + fract(_S4795) * max(cellSize_8 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_8), float(atlasHeight_8)))));
                break;
            }
            uint operation_3 = uint(round(_S4869.y));
            if(operation_3 == 1U)
            {
                _S4796 = _S4796 * _S4797;
                break;
    ...
    if((textureMask_0 & 64U) != 0U)
    {
        ...
        for(;;)
        {
            ...
            texture2d<float, access::sample> _S4879 = (&kernelContext_0)->opacityTexture_0;
            thread uint atlasWidth_9;
            thread uint atlasHeight_9;
            (*((&atlasWidth_9)) = (_S4879).get_width(0)),(*((&atlasHeight_9)) = (_S4879).get_height(0));
            int3 _S4880 = int3(int(0), int(0), int(0));
            float4 metadata_9 = round((((&kernelContext_0)->opacityTexture_0).read(vec<uint,2>(((_S4880)).xy), uint(((_S4880)).z))) * float4(255.0f) );
            int2 _S4881 = int2(metadata_9.zw);
            ...
            {
                hasSceneLighting_0 = any(tile_9 >= _S4881);
            }
            if(hasSceneLighting_0)
            {
                int3 _S4882 = int3(int(min(1U, atlasWidth_9 - 1U)), int(0), int(0));
                _S4796 = (((&kernelContext_0)->opacityTexture_0).read(vec<uint,2>(((_S4882)).xy), uint(((_S4882)).z)));
                break;
            }
            uint _S4883 = atlasWidth_9 / uint(_S4881.x);
            float _S4884 = float(_S4883);
            uint _S4885 = (atlasHeight_9 - 1U) / uint(_S4881.y);
            float2 cellSize_9 = float2(_S4884, float(_S4885));
            _S4796 = (((&kernelContext_0)->opacityTexture_0).sample(((&kernelContext_0)->opacitySampler_0), ((float2(tile_9) * cellSize_9 + float2(1.5f, 2.5f) + fract(_S4795) * max(cellSize_9 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_9), float(atlasHeight_9)))));
            break;
        }
        for(;;)
        {
            float4 _S4886 = float4(_S4->compositeControls_0) ;
            if((_S4886.x) != 64.0f)
            {
                break;
            }
            bool _S4887 = (_S4886.w) >= 0.5f;
            for(;;)
            {
                if(!_S4887)
                {
                ...
                texture2d<float, access::sample> _S4888 = (&kernelContext_0)->compositeTexture_0;
                thread uint atlasWidth_10;
                thread uint atlasHeight_10;
                (*((&atlasWidth_10)) = (_S4888).get_width(0)),(*((&atlasHeight_10)) = (_S4888).get_height(0));
                int3 _S4889 = int3(int(0), int(0), int(0));
                float4 metadata_10 = round((((&kernelContext_0)->compositeTexture_0).read(vec<uint,2>(((_S4889)).xy), uint(((_S4889)).z))) * float4(255.0f) );
                int2 _S4890 = int2(metadata_10.zw);
                ...
                {
                    hasSceneLighting_0 = any(tile_10 >= _S4890);
                }
                if(hasSceneLighting_0)
                {
                    int3 _S4891 = int3(int(min(1U, atlasWidth_10 - 1U)), int(0), int(0));
                    _S4797 = (((&kernelContext_0)->compositeTexture_0).read(vec<uint,2>(((_S4891)).xy), uint(((_S4891)).z)));
                    break;
                }
                uint _S4892 = atlasWidth_10 / uint(_S4890.x);
                float _S4893 = float(_S4892);
                uint _S4894 = (atlasHeight_10 - 1U) / uint(_S4890.y);
                float2 cellSize_10 = float2(_S4893, float(_S4894));
                _S4797 = (((&kernelContext_0)->compositeTexture_0).sample(((&kernelContext_0)->compositeSampler_0), ((float2(tile_10) * cellSize_10 + float2(1.5f, 2.5f) + fract(_S4795) * max(cellSize_10 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_10), float(atlasHeight_10)))));
                break;
            }
            uint operation_4 = uint(round(_S4886.y));
            if(operation_4 == 1U)
            {
                _S4796 = _S4796 * _S4797;
                break;
    ...
    {
        bool _S4895 = (udimMask_0 & 128U) != 0U;
        for(;;)
        {
            if(!_S4895)
            {
            ...
            texture2d<float, access::sample> _S4896 = (&kernelContext_0)->occlusionTexture_0;
            thread uint atlasWidth_11;
            thread uint atlasHeight_11;
            (*((&atlasWidth_11)) = (_S4896).get_width(0)),(*((&atlasHeight_11)) = (_S4896).get_height(0));
            int3 _S4897 = int3(int(0), int(0), int(0));
            float4 metadata_11 = round((((&kernelContext_0)->occlusionTexture_0).read(vec<uint,2>(((_S4897)).xy), uint(((_S4897)).z))) * float4(255.0f) );
            int2 _S4898 = int2(metadata_11.zw);
            ...
            {
                hasSceneLighting_0 = any(tile_11 >= _S4898);
            }
            if(hasSceneLighting_0)
            {
                int3 _S4899 = int3(int(min(1U, atlasWidth_11 - 1U)), int(0), int(0));
                _S4796 = (((&kernelContext_0)->occlusionTexture_0).read(vec<uint,2>(((_S4899)).xy), uint(((_S4899)).z)));
                break;
            }
            uint _S4900 = atlasWidth_11 / uint(_S4898.x);
            float _S4901 = float(_S4900);
            uint _S4902 = (atlasHeight_11 - 1U) / uint(_S4898.y);
            float2 cellSize_11 = float2(_S4901, float(_S4902));
            _S4796 = (((&kernelContext_0)->occlusionTexture_0).sample(((&kernelContext_0)->occlusionSampler_0), ((float2(tile_11) * cellSize_11 + float2(1.5f, 2.5f) + fract(_S4795) * max(cellSize_11 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_11), float(atlasHeight_11)))));
            break;
        }
        for(;;)
        {
            float4 _S4903 = float4(_S4->compositeControls_0) ;
            if((_S4903.x) != 128.0f)
            {
                break;
            }
            bool _S4904 = (_S4903.w) >= 0.5f;
            for(;;)
            {
                if(!_S4904)
                {
                ...
                texture2d<float, access::sample> _S4905 = (&kernelContext_0)->compositeTexture_0;
                thread uint atlasWidth_12;
                thread uint atlasHeight_12;
                (*((&atlasWidth_12)) = (_S4905).get_width(0)),(*((&atlasHeight_12)) = (_S4905).get_height(0));
                int3 _S4906 = int3(int(0), int(0), int(0));
                float4 metadata_12 = round((((&kernelContext_0)->compositeTexture_0).read(vec<uint,2>(((_S4906)).xy), uint(((_S4906)).z))) * float4(255.0f) );
                int2 _S4907 = int2(metadata_12.zw);
                ...
                {
                    hasSceneLighting_0 = any(tile_12 >= _S4907);
                }
                if(hasSceneLighting_0)
                {
                    int3 _S4908 = int3(int(min(1U, atlasWidth_12 - 1U)), int(0), int(0));
                    _S4797 = (((&kernelContext_0)->compositeTexture_0).read(vec<uint,2>(((_S4908)).xy), uint(((_S4908)).z)));
                    break;
                }
                uint _S4909 = atlasWidth_12 / uint(_S4907.x);
                float _S4910 = float(_S4909);
                uint _S4911 = (atlasHeight_12 - 1U) / uint(_S4907.y);
                float2 cellSize_12 = float2(_S4910, float(_S4911));
                _S4797 = (((&kernelContext_0)->compositeTexture_0).sample(((&kernelContext_0)->compositeSampler_0), ((float2(tile_12) * cellSize_12 + float2(1.5f, 2.5f) + fract(_S4795) * max(cellSize_12 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_12), float(atlasHeight_12)))));
                break;
            }
            uint operation_5 = uint(round(_S4903.y));
            if(operation_5 == 1U)
            {
                _S4796 = _S4796 * _S4797;
                break;
    ...
    {
        bool _S4912 = (udimMask_0 & 256U) != 0U;
        for(;;)
        {
            if(!_S4912)
            {
            ...
            texture2d<float, access::sample> _S4913 = (&kernelContext_0)->specularColorTexture_0;
            thread uint atlasWidth_13;
            thread uint atlasHeight_13;
            (*((&atlasWidth_13)) = (_S4913).get_width(0)),(*((&atlasHeight_13)) = (_S4913).get_height(0));
            int3 _S4914 = int3(int(0), int(0), int(0));
            float4 metadata_13 = round((((&kernelContext_0)->specularColorTexture_0).read(vec<uint,2>(((_S4914)).xy), uint(((_S4914)).z))) * float4(255.0f) );
            int2 _S4915 = int2(metadata_13.zw);
            ...
            {
                hasSceneLighting_0 = any(tile_13 >= _S4915);
            }
            if(hasSceneLighting_0)
            {
                int3 _S4916 = int3(int(min(1U, atlasWidth_13 - 1U)), int(0), int(0));
                _S4796 = (((&kernelContext_0)->specularColorTexture_0).read(vec<uint,2>(((_S4916)).xy), uint(((_S4916)).z)));
                break;
            }
            uint _S4917 = atlasWidth_13 / uint(_S4915.x);
            float _S4918 = float(_S4917);
            uint _S4919 = (atlasHeight_13 - 1U) / uint(_S4915.y);
            float2 cellSize_13 = float2(_S4918, float(_S4919));
            _S4796 = (((&kernelContext_0)->specularColorTexture_0).sample(((&kernelContext_0)->specularColorSampler_0), ((float2(tile_13) * cellSize_13 + float2(1.5f, 2.5f) + fract(_S4795) * max(cellSize_13 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_13), float(atlasHeight_13)))));
            break;
        }
        for(;;)
        {
            float4 _S4920 = float4(_S4->compositeControls_0) ;
            if((_S4920.x) != 256.0f)
            {
                break;
            }
            bool _S4921 = (_S4920.w) >= 0.5f;
            for(;;)
            {
                if(!_S4921)
                {
                ...
                texture2d<float, access::sample> _S4922 = (&kernelContext_0)->compositeTexture_0;
                thread uint atlasWidth_14;
                thread uint atlasHeight_14;
                (*((&atlasWidth_14)) = (_S4922).get_width(0)),(*((&atlasHeight_14)) = (_S4922).get_height(0));
                int3 _S4923 = int3(int(0), int(0), int(0));
                float4 metadata_14 = round((((&kernelContext_0)->compositeTexture_0).read(vec<uint,2>(((_S4923)).xy), uint(((_S4923)).z))) * float4(255.0f) );
                int2 _S4924 = int2(metadata_14.zw);
                ...
                {
                    hasSceneLighting_0 = any(tile_14 >= _S4924);
                }
                if(hasSceneLighting_0)
                {
                    int3 _S4925 = int3(int(min(1U, atlasWidth_14 - 1U)), int(0), int(0));
                    _S4797 = (((&kernelContext_0)->compositeTexture_0).read(vec<uint,2>(((_S4925)).xy), uint(((_S4925)).z)));
                    break;
                }
                uint _S4926 = atlasWidth_14 / uint(_S4924.x);
                float _S4927 = float(_S4926);
                uint _S4928 = (atlasHeight_14 - 1U) / uint(_S4924.y);
                float2 cellSize_14 = float2(_S4927, float(_S4928));
                _S4797 = (((&kernelContext_0)->compositeTexture_0).sample(((&kernelContext_0)->compositeSampler_0), ((float2(tile_14) * cellSize_14 + float2(1.5f, 2.5f) + fract(_S4795) * max(cellSize_14 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_14), float(atlasHeight_14)))));
                break;
            }
            uint operation_6 = uint(round(_S4920.y));
            if(operation_6 == 1U)
            {
                _S4796 = _S4796 * _S4797;
                break;
    ...
    {
        bool _S4929 = (udimMask_0 & 512U) != 0U;
        for(;;)
        {
            if(!_S4929)
            {
            ...
            texture2d<float, access::sample> _S4930 = (&kernelContext_0)->clearcoatTexture_0;
            thread uint atlasWidth_15;
            thread uint atlasHeight_15;
            (*((&atlasWidth_15)) = (_S4930).get_width(0)),(*((&atlasHeight_15)) = (_S4930).get_height(0));
            int3 _S4931 = int3(int(0), int(0), int(0));
            float4 metadata_15 = round((((&kernelContext_0)->clearcoatTexture_0).read(vec<uint,2>(((_S4931)).xy), uint(((_S4931)).z))) * float4(255.0f) );
            int2 _S4932 = int2(metadata_15.zw);
            ...
            {
                hasSceneLighting_0 = any(tile_15 >= _S4932);
            }
            if(hasSceneLighting_0)
            {
                int3 _S4933 = int3(int(min(1U, atlasWidth_15 - 1U)), int(0), int(0));
                _S4796 = (((&kernelContext_0)->clearcoatTexture_0).read(vec<uint,2>(((_S4933)).xy), uint(((_S4933)).z)));
                break;
            }
            uint _S4934 = atlasWidth_15 / uint(_S4932.x);
            float _S4935 = float(_S4934);
            uint _S4936 = (atlasHeight_15 - 1U) / uint(_S4932.y);
            float2 cellSize_15 = float2(_S4935, float(_S4936));
            _S4796 = (((&kernelContext_0)->clearcoatTexture_0).sample(((&kernelContext_0)->clearcoatSampler_0), ((float2(tile_15) * cellSize_15 + float2(1.5f, 2.5f) + fract(_S4795) * max(cellSize_15 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_15), float(atlasHeight_15)))));
            break;
        }
        for(;;)
        {
            float4 _S4937 = float4(_S4->compositeControls_0) ;
            if((_S4937.x) != 512.0f)
            {
                break;
            }
            bool _S4938 = (_S4937.w) >= 0.5f;
            for(;;)
            {
                if(!_S4938)
                {
                ...
                texture2d<float, access::sample> _S4939 = (&kernelContext_0)->compositeTexture_0;
                thread uint atlasWidth_16;
                thread uint atlasHeight_16;
                (*((&atlasWidth_16)) = (_S4939).get_width(0)),(*((&atlasHeight_16)) = (_S4939).get_height(0));
                int3 _S4940 = int3(int(0), int(0), int(0));
                float4 metadata_16 = round((((&kernelContext_0)->compositeTexture_0).read(vec<uint,2>(((_S4940)).xy), uint(((_S4940)).z))) * float4(255.0f) );
                int2 _S4941 = int2(metadata_16.zw);
                ...
                {
                    hasSceneLighting_0 = any(tile_16 >= _S4941);
                }
                if(hasSceneLighting_0)
                {
                    int3 _S4942 = int3(int(min(1U, atlasWidth_16 - 1U)), int(0), int(0));
                    _S4797 = (((&kernelContext_0)->compositeTexture_0).read(vec<uint,2>(((_S4942)).xy), uint(((_S4942)).z)));
                    break;
                }
                uint _S4943 = atlasWidth_16 / uint(_S4941.x);
                float _S4944 = float(_S4943);
                uint _S4945 = (atlasHeight_16 - 1U) / uint(_S4941.y);
                float2 cellSize_16 = float2(_S4944, float(_S4945));
                _S4797 = (((&kernelContext_0)->compositeTexture_0).sample(((&kernelContext_0)->compositeSampler_0), ((float2(tile_16) * cellSize_16 + float2(1.5f, 2.5f) + fract(_S4795) * max(cellSize_16 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_16), float(atlasHeight_16)))));
                break;
            }
            uint operation_7 = uint(round(_S4937.y));
            if(operation_7 == 1U)
            {
                _S4796 = _S4796 * _S4797;
                break;
    ...
    {
        bool _S4946 = (udimMask_0 & 1024U) != 0U;
        for(;;)
        {
            if(!_S4946)
            {
            ...
            texture2d<float, access::sample> _S4947 = (&kernelContext_0)->clearcoatRoughnessTexture_0;
            thread uint atlasWidth_17;
            thread uint atlasHeight_17;
            (*((&atlasWidth_17)) = (_S4947).get_width(0)),(*((&atlasHeight_17)) = (_S4947).get_height(0));
            int3 _S4948 = int3(int(0), int(0), int(0));
            float4 metadata_17 = round((((&kernelContext_0)->clearcoatRoughnessTexture_0).read(vec<uint,2>(((_S4948)).xy), uint(((_S4948)).z))) * float4(255.0f) );
            int2 _S4949 = int2(metadata_17.zw);
            ...
            {
                hasSceneLighting_0 = any(tile_17 >= _S4949);
            }
            if(hasSceneLighting_0)
            {
                int3 _S4950 = int3(int(min(1U, atlasWidth_17 - 1U)), int(0), int(0));
                _S4796 = (((&kernelContext_0)->clearcoatRoughnessTexture_0).read(vec<uint,2>(((_S4950)).xy), uint(((_S4950)).z)));
                break;
            }
            uint _S4951 = atlasWidth_17 / uint(_S4949.x);
            float _S4952 = float(_S4951);
            uint _S4953 = (atlasHeight_17 - 1U) / uint(_S4949.y);
            float2 cellSize_17 = float2(_S4952, float(_S4953));
            _S4796 = (((&kernelContext_0)->clearcoatRoughnessTexture_0).sample(((&kernelContext_0)->clearcoatRoughnessSampler_0), ((float2(tile_17) * cellSize_17 + float2(1.5f, 2.5f) + fract(_S4795) * max(cellSize_17 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_17), float(atlasHeight_17)))));
            break;
        }
        for(;;)
        {
            float4 _S4954 = float4(_S4->compositeControls_0) ;
            if((_S4954.x) != 1024.0f)
            {
                break;
            }
            bool _S4955 = (_S4954.w) >= 0.5f;
            for(;;)
            {
                if(!_S4955)
                {
                ...
                texture2d<float, access::sample> _S4956 = (&kernelContext_0)->compositeTexture_0;
                thread uint atlasWidth_18;
                thread uint atlasHeight_18;
                (*((&atlasWidth_18)) = (_S4956).get_width(0)),(*((&atlasHeight_18)) = (_S4956).get_height(0));
                int3 _S4957 = int3(int(0), int(0), int(0));
                float4 metadata_18 = round((((&kernelContext_0)->compositeTexture_0).read(vec<uint,2>(((_S4957)).xy), uint(((_S4957)).z))) * float4(255.0f) );
                int2 _S4958 = int2(metadata_18.zw);
                ...
                {
                    hasSceneLighting_0 = any(tile_18 >= _S4958);
                }
                if(hasSceneLighting_0)
                {
                    int3 _S4959 = int3(int(min(1U, atlasWidth_18 - 1U)), int(0), int(0));
                    _S4797 = (((&kernelContext_0)->compositeTexture_0).read(vec<uint,2>(((_S4959)).xy), uint(((_S4959)).z)));
                    break;
                }
                uint _S4960 = atlasWidth_18 / uint(_S4958.x);
                float _S4961 = float(_S4960);
                uint _S4962 = (atlasHeight_18 - 1U) / uint(_S4958.y);
                float2 cellSize_18 = float2(_S4961, float(_S4962));
                _S4797 = (((&kernelContext_0)->compositeTexture_0).sample(((&kernelContext_0)->compositeSampler_0), ((float2(tile_18) * cellSize_18 + float2(1.5f, 2.5f) + fract(_S4795) * max(cellSize_18 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_18), float(atlasHeight_18)))));
                break;
            }
            uint operation_8 = uint(round(_S4954.y));
            if(operation_8 == 1U)
            {
                _S4796 = _S4796 * _S4797;
                break;
    ...
    {
        bool _S4963 = (udimMask_0 & 2048U) != 0U;
        for(;;)
        {
            if(!_S4963)
            {
            ...
            texture2d<float, access::sample> _S4964 = (&kernelContext_0)->iorTexture_0;
            thread uint atlasWidth_19;
            thread uint atlasHeight_19;
            (*((&atlasWidth_19)) = (_S4964).get_width(0)),(*((&atlasHeight_19)) = (_S4964).get_height(0));
            int3 _S4965 = int3(int(0), int(0), int(0));
            float4 metadata_19 = round((((&kernelContext_0)->iorTexture_0).read(vec<uint,2>(((_S4965)).xy), uint(((_S4965)).z))) * float4(255.0f) );
            int2 _S4966 = int2(metadata_19.zw);
            ...
            {
                hasSceneLighting_0 = any(tile_19 >= _S4966);
            }
            if(hasSceneLighting_0)
            {
                int3 _S4967 = int3(int(min(1U, atlasWidth_19 - 1U)), int(0), int(0));
                _S4796 = (((&kernelContext_0)->iorTexture_0).read(vec<uint,2>(((_S4967)).xy), uint(((_S4967)).z)));
                break;
            }
            uint _S4968 = atlasWidth_19 / uint(_S4966.x);
            float _S4969 = float(_S4968);
            uint _S4970 = (atlasHeight_19 - 1U) / uint(_S4966.y);
            float2 cellSize_19 = float2(_S4969, float(_S4970));
            _S4796 = (((&kernelContext_0)->iorTexture_0).sample(((&kernelContext_0)->iorSampler_0), ((float2(tile_19) * cellSize_19 + float2(1.5f, 2.5f) + fract(_S4795) * max(cellSize_19 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_19), float(atlasHeight_19)))));
            break;
        }
        for(;;)
        {
            float4 _S4971 = float4(_S4->compositeControls_0) ;
            if((_S4971.x) != 2048.0f)
            {
                break;
            }
            bool _S4972 = (_S4971.w) >= 0.5f;
            for(;;)
            {
                if(!_S4972)
                {
                ...
                texture2d<float, access::sample> _S4973 = (&kernelContext_0)->compositeTexture_0;
                thread uint atlasWidth_20;
                thread uint atlasHeight_20;
                (*((&atlasWidth_20)) = (_S4973).get_width(0)),(*((&atlasHeight_20)) = (_S4973).get_height(0));
                int3 _S4974 = int3(int(0), int(0), int(0));
                float4 metadata_20 = round((((&kernelContext_0)->compositeTexture_0).read(vec<uint,2>(((_S4974)).xy), uint(((_S4974)).z))) * float4(255.0f) );
                int2 _S4975 = int2(metadata_20.zw);
                int2 tile_20 = int2(floor(_S4795)) - int2(metadata_20.xy);
                ...
                {
                    hasSceneLighting_0 = any(tile_20 >= _S4975);
                }
                if(hasSceneLighting_0)
                {
                    int3 _S4976 = int3(int(min(1U, atlasWidth_20 - 1U)), int(0), int(0));
                    _S4797 = (((&kernelContext_0)->compositeTexture_0).read(vec<uint,2>(((_S4976)).xy), uint(((_S4976)).z)));
                    break;
                }
                uint _S4977 = atlasWidth_20 / uint(_S4975.x);
                float _S4978 = float(_S4977);
                uint _S4979 = (atlasHeight_20 - 1U) / uint(_S4975.y);
                float2 cellSize_20 = float2(_S4978, float(_S4979));
                _S4797 = (((&kernelContext_0)->compositeTexture_0).sample(((&kernelContext_0)->compositeSampler_0), ((float2(tile_20) * cellSize_20 + float2(1.5f, 2.5f) + fract(_S4795) * max(cellSize_20 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_20), float(atlasHeight_20)))));
                break;
            }
            uint operation_9 = uint(round(_S4971.y));
            if(operation_9 == 1U)
            {
                _S4796 = _S4796 * _S4797;
                break;
    ...
    float _S4980 = saturate(abs(dot(normal_2, irradiance_0)) + 0.00000999999974738f);
    float _S4981 = max(0.00100000004749745f, roughness_0);
    float _S4982 = max(0.00100000004749745f, clearcoatRoughness_0);
    float reflectanceRatio_0 = (1.0f - ior_0) / (1.0f + ior_0);
    float3 _S4983 = float3(3.14159274101257324f) ;
    float3 diffuse_0 = diffuseColor_0 / _S4983;
    float3 normalIncidence_0;
    float3 grazingIncidence_0;
    float3 diffuse_1;
    if((_S4784.w) >= 0.5f)
    {
        float3 _S4984 = float3(1.0f, 1.0f, 1.0f);
        normalIncidence_0 = specularColor_0;
        grazingIncidence_0 = _S4984;
        diffuse_1 = diffuse_0;
    }
    else
    {
        float3 _S4985 = float3(metallic_0) ;
        float3 specularTint_0 = mix(float3(1.0f, 1.0f, 1.0f), diffuseColor_0, _S4985);
        float3 diffuse_2 = diffuse_0 * float3((1.0f - metallic_0)) ;
        normalIncidence_0 = mix(float3((reflectanceRatio_0 * reflectanceRatio_0))  * specularTint_0, specularTint_0, _S4985);
    ...
    {
        float3 _S4986 = float3(_S65, _S66, _S67);
        hasSceneLighting_0 = (dot(_S4986, _S4986)) > 0.0f;
    }
    if(hasSceneLighting_0)
    {
        hasSceneLighting_0 = true;
    ...
    uint _S4987 = min(uint(_S68), 128U);
    ...
    float4 _S4988 = float4(_S4->lightColorAmbient_0) ;
    float3 color_0 = diffuseColor_0 * float3(_S4988.w) ;
    uint domeLinkMask_0 = uint(max((float4(_S4->domeLinkControls_0) ).x, 0.0f));
    uint _S4989 = min(uint(max(_S4693, 0.0f)), 8U);
    uint allDomes_0 = (1U << _S4989) - 1U;
    bool allDomesLinked_0 = (domeLinkMask_0 & allDomes_0) == allDomes_0;
    float3 _S4990 = float3(_S65, _S66, _S67);
    uint lightCount_0;
    float3 domeAmbient_0;
    if(!allDomesLinked_0)
    {
        float3 _S4991 = float3(0.0f, 0.0f, 0.0f);
        lightCount_0 = 0U;
        domeAmbient_0 = _S4991;
        for(;;)
        {
            if(lightCount_0 < _S4989)
            {
            }
            else
            {
    ...
    for(;;)
    {
        ...
        if(hasSceneLighting_0)
        {
            _S4993 = (((uint4(_S4->lightLinkMask_0) )[lightIndex_0 / 32U]) & (1U << (lightIndex_0 % 32U))) == 0U;
        }
        else
        {
            _S4993 = false;
        ...
        if(hasSceneLighting_0)
        {
            ...
            if(shadowSlot_0 >= int(0))
            {
                for(;;)
                {
                    ...
                    float _S5007 = lightClip_0.w;
                    if(_S5007 <= 0.0f)
                    {
                        ior_0 = 1.0f;
                        break;
                    }
                    float3 ndc_0 = lightClip_0.xyz / float3(_S5007) ;
                    bool _S5008;
                    if((abs(ndc_0.x)) > 1.0f)
                    {
                        _S5008 = true;
                    ...
                    float2 _S5011 = _S4028[shadowSlot_0].xy;
                    float2 _S5012 = _S4028[shadowSlot_0].zw;
                    float2 _S5013 = _S5011 + (ndc_0.xy * float2(0.5f, -0.5f) + float2(0.5f, 0.5f)) * _S5012;
                    float texel_0 = _S4048[shadowSlot_0].w;
                    float _S5014 = max(_S4048[shadowSlot_0].z, 0.0f);
                    float _S5015 = ndc_0.z - _S4048[shadowSlot_0].x * (1.0f + 2.0f * slope_0);
                    float2 _S5016 = float2((texel_0 * 0.5f)) ;
                    float2 _S5017 = _S5011 + _S5016;
                    float2 _S5018 = _S5011 + _S5012 - _S5016;
                    int y_0 = int(-1);
                    ...
                    for(;;)
                    {
                        ...
                        for(;;)
                        {
                            ...
                            if(_S5015 <= (((&kernelContext_0)->shadowAtlas_0).sample(((&kernelContext_0)->shadowSampler_0), (clamp(_S5013 + float2(float(x_0), float(y_0)) * float2((_S5014 * texel_0)) , _S5017, _S5018)), level((0.0f))).x))
                            {
                                ior_0 = 1.0f;
                            }
                            else
        ...
        float3 _S5019 = float3(0.0f, 0.0f, 0.0f);
        sampleOffsets_0[int(0)] = _S5019;
        sampleOffsets_0[int(1)] = _S5019;
        sampleOffsets_0[int(2)] = _S5019;
        sampleOffsets_0[int(3)] = _S5019;
        sampleOffsets_0[int(4)] = _S5019;
        float sampleCount_0;
        if(lightType_0 == 3.0f)
        {
            ...
            float3 _S5020 = - halfWidth_0;
            sampleOffsets_0[int(3)] = _S5020 + halfHeight_0;
            sampleOffsets_0[int(4)] = _S5020 - halfHeight_0;
            sampleCount_0 = 5.0f;
        }
        else
        {
        ...
        for(;;)
        {
            ...
            if(lightType_0 >= 2.0f)
            {
                ...
                float _S5021 = max(dot(toLight_0, toLight_0), 0.00100000004749745f);
                float3 sampleDirection_1 = toLight_0 * float3(rsqrt(_S5021)) ;
                float sampleIntensity_2 = sampleIntensity_0 / _S5021;
                if(lightType_0 == 4.0f)
                {
            ...
            float3 _S5022 = float3(pow(max(0.0f, 1.0f - saturate(dot(domeAmbient_0, half_0))), 5.0f)) ;
            float3 _S5023 = mix(normalIncidence_0, grazingIncidence_0, _S5022);
            float3 directDiffuse_0 = diffuse_1 * (_S4823 - _S5023);
            float _S5024 = max(_S4981, 0.00100000004749745f);
            float alpha_0 = _S5024 * _S5024;
            ...
            float _S5025 = 1.0f - k_0;
            float3 _S5026 = float3(max(4.0f * normalDotLight_0 * _S4980, 1.00000000317107685e-30f)) ;
            float3 _S5027 = _S5023 * float3((_S4980 / (_S4980 * _S5025 + k_0) * (normalDotLight_0 / (normalDotLight_0 * _S5025 + k_0))))  * float3((alphaSquared_0 / max(3.14159274101257324f * denominator_0 * denominator_0, 1.00000000317107685e-30f)))  / _S5026;
            float3 directSpecular_0;
            if(clearcoatAmount_0 > 0.0f)
            {
                float _S5028 = max(_S4982, 0.00100000004749745f);
                float alpha_1 = _S5028 * _S5028;
                ...
                float _S5029 = 1.0f - k_1;
                directSpecular_0 = _S5027 + float3(clearcoatAmount_0)  * (mix(float3((reflectanceRatio_0 * reflectanceRatio_0)) , float3(1.0f, 1.0f, 1.0f), _S5022) * float3((_S4980 / (_S4980 * _S5029 + k_1) * (normalDotLight_0 / (normalDotLight_0 * _S5029 + k_1))))  * float3((alphaSquared_1 / max(3.14159274101257324f * denominator_1 * denominator_1, 1.00000000317107685e-30f)))  / _S5026);
            }
            else
            {
                directSpecular_0 = _S5027;
            }
            float3 _S5030 = diffuseColor_0 * float3(sampleIntensity_1) ;
            color_3 = color_3 + float3((shadowVisibility_0 * occlusion_0 * emissionScale_0 * normalDotLight_0))  * (directDiffuse_0 * float3(metallic_0)  * (_S5030 * _S4983) + directSpecular_0 * float3(clearcoatRoughness_0)  * _S5030);
            sampleIndex_0 = sampleIndex_0 + 1U;
        }
        color_2 = color_3;
        lightIndex_0 = lightIndex_0 + 1U;
    ...
    if(_S4689 >= 0.5f)
    {
        float _S5031 = saturate(saturate(abs(dot(worldNormal_2, sceneEye_0)) + 0.00000999999974738f));
        float _S5032 = saturate(_S4981);
        float2 _S5033 = (((&kernelContext_0)->environmentBrdf_0).sample(((&kernelContext_0)->environmentBrdfSampler_0), (float2(_S5031, _S5032)), level((0.0f)))).xy;
        float3 specularWeight_0 = normalIncidence_0 * float3(_S5033.x)  + grazingIncidence_0 * float3(_S5033.y) ;
        ...
        float _S5034 = max(_S4694, 1.0f);
        float3 _S5035 = float3(0.0f, 0.0f, 0.0f);
        if(allDomesLinked_0)
        {
            hasSceneLighting_0 = true;
        }
        ...
        {
            hasSceneLighting_0 = _S5034 <= 1.0f;
        }
        if(hasSceneLighting_0)
        {
            for(;;)
            {
                bool _S5036 = _S5034 <= 1.0f;
                _S2 = _S5036;
                if(_S5036)
                {
                ...
                diffuseColor_0 = (((&kernelContext_0)->environmentIrradiance_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(fract((atan2(unit_1.z, unit_1.x) + 1.57079637050628662f) / 6.28318548202514648f), (_S4695 + clamp(acos(clamp(unit_1.y, -1.0f, 1.0f)) / 3.14159274101257324f, inset_0, 1.0f - inset_0)) / _S5034)), level((0.0f)))).xyz;
                break;
            }
            for(;;)
            {
                if(_S2)
                {
                    ...
                    float _S5037 = max(_S4690, 1.0f);
                    float _S5038 = _S5037 - 1.0f;
                    float slice_0 = _S5032 * max(_S5038, 0.0f);
                    ...
                    specularColor_0 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_0, (lower_0 + v_0) / _S5037)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_0, (min(lower_0 + 1.0f, _S5038) + v_0) / _S5037)), level((0.0f)))).xyz, float3((slice_0 - lower_0)) );
                    break;
                }
                ...
                float _S5039 = max(_S4690, 1.0f);
                float total_0 = _S5039 * _S5034;
                float _S5040 = _S5039 - 1.0f;
                float slice_1 = _S5032 * max(_S5040, 0.0f);
                ...
                float base_0 = _S4695 * _S5039;
                specularColor_0 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_1, (base_0 + lower_1 + v_1) / total_0)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_1, (base_0 + min(lower_1 + 1.0f, _S5040) + v_1) / total_0)), level((0.0f)))).xyz, float3((slice_1 - lower_1)) );
                break;
            }
            if(clearcoatAmount_0 > 0.0f)
            {
                for(;;)
                {
                    if(_S2)
                    {
                        ...
                        float _S5041 = max(_S4690, 1.0f);
                        float _S5042 = _S5041 - 1.0f;
                        float slice_2 = saturate(_S4982) * max(_S5042, 0.0f);
                        ...
                        irradiance_0 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_2, (lower_2 + v_2) / _S5041)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_2, (min(lower_2 + 1.0f, _S5042) + v_2) / _S5041)), level((0.0f)))).xyz, float3((slice_2 - lower_2)) );
                        break;
                    }
                    ...
                    float _S5043 = max(_S4690, 1.0f);
                    float total_1 = _S5043 * _S5034;
                    float _S5044 = _S5043 - 1.0f;
                    float slice_3 = saturate(_S4982) * max(_S5044, 0.0f);
        ...
        else
        {
            sampleIndex_0 = 0U;
            irradiance_0 = _S5035;
            lightDirection_0 = _S5035;
            lightTangent_0 = _S5035;
            for(;;)
            {
                if(sampleIndex_0 < _S4989)
                {
                }
                else
                {
                ...
                for(;;)
                {
                    ...
                    diffuseColor_0 = (((&kernelContext_0)->environmentIrradiance_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(fract((atan2(unit_7.z, unit_7.x) + 1.57079637050628662f) / 6.28318548202514648f), (domeGroup_0 + clamp(acos(clamp(unit_7.y, -1.0f, 1.0f)) / 3.14159274101257324f, inset_5, 1.0f - inset_5)) / _S5034)), level((0.0f)))).xyz;
                    break;
                }
                ...
                for(;;)
                {
                    if(_S3)
                    {
                        ...
                        float _S5046 = max(_S4690, 1.0f);
                        float _S5047 = _S5046 - 1.0f;
                        float slice_4 = _S5032 * max(_S5047, 0.0f);
                        ...
                        specularColor_0 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_4, (lower_4 + v_4) / _S5046)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_4, (min(lower_4 + 1.0f, _S5047) + v_4) / _S5046)), level((0.0f)))).xyz, float3((slice_4 - lower_4)) );
                        break;
                    }
                    ...
                    float _S5048 = max(_S4690, 1.0f);
                    float total_2 = _S5048 * _S5034;
                    float _S5049 = _S5048 - 1.0f;
                    float slice_5 = _S5032 * max(_S5049, 0.0f);
                    ...
                    float base_2 = domeGroup_0 * _S5048;
                    specularColor_0 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_5, (base_2 + lower_5 + v_5) / total_2)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_5, (base_2 + min(lower_5 + 1.0f, _S5049) + v_5) / total_2)), level((0.0f)))).xyz, float3((slice_5 - lower_5)) );
                    break;
                }
                ...
                if(clearcoatAmount_0 > 0.0f)
                {
                    for(;;)
                    {
                        if(_S3)
                        {
                            ...
                            float _S5050 = max(_S4690, 1.0f);
                            float _S5051 = _S5050 - 1.0f;
                            float slice_6 = saturate(_S4982) * max(_S5051, 0.0f);
                            ...
                            normal_2 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_6, (lower_6 + v_6) / _S5050)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_6, (min(lower_6 + 1.0f, _S5051) + v_6) / _S5050)), level((0.0f)))).xyz, float3((slice_6 - lower_6)) );
                            break;
                        }
                        ...
                        float _S5052 = max(_S4690, 1.0f);
                        float total_3 = _S5052 * _S5034;
                        float _S5053 = _S5052 - 1.0f;
                        float slice_7 = saturate(_S4982) * max(_S5053, 0.0f);
                        ...
                        float base_3 = domeGroup_0 * _S5052;
                        normal_2 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_7, (base_3 + lower_7 + v_7) / total_3)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_7, (base_3 + min(lower_7 + 1.0f, _S5053) + v_7) / total_3)), level((0.0f)))).xyz, float3((slice_7 - lower_7)) );
                        break;
                    }
        ...
        if(clearcoatAmount_0 > 0.0f)
        {
            float2 _S5054 = (((&kernelContext_0)->environmentBrdf_0).sample(((&kernelContext_0)->environmentBrdfSampler_0), (float2(_S5031, saturate(_S4982))), level((0.0f)))).xy;
            color_2 = color_4 + float3((occlusion_0 * clearcoatAmount_0))  * lightTangent_0 * (float3((reflectanceRatio_0 * reflectanceRatio_0))  * float3(_S5054.x)  + float3(_S5054.y) );
        }
        else
        {
            color_2 = color_4;
    ...
    if(_S22 == 1U)
    {
        color_2 = color_5 / (_S4823 + max(color_5, float3(0.0f, 0.0f, 0.0f)));
    }
    else
    {
        color_2 = color_5;
    }
    pixelOutput_0 _S5055 = { float4(color_2, opacity_0) };
    return _S5055;
}
