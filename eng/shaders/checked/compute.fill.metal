...
[[kernel]] void fillMain(uint3 dispatchThreadId_0 [[thread_position_in_grid]], SLANG_ParameterGroup_ComputeParameters_0 constant* ComputeParameters_1 [[buffer(1)]], packed_float4 device* outputValues_1 [[buffer(0)]])
{
    ...
    {
        *((&kernelContext_0)->outputValues_0+index_0) = packed_float4(float4(float(index_0) * (&kernelContext_0)->ComputeParameters_0->scale_0, 0.0f, 0.0f, 1.0f)) ;
    }
    return;
}
