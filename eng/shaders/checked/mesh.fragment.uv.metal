...
[[fragment]] pixelOutput_0 fragmentMain_uv(pixelInput_0 _S2 [[stage_in]], float4 position_0 [[position]], SurfaceParameters_natural_0 device* surfaceParameters_0 [[buffer(7)]])
{
    SurfaceParameters_natural_0 surface_0 = surfaceParameters_0[int(0)];
