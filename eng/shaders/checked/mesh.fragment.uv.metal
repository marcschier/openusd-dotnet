...
[[fragment]] pixelOutput_0 fragmentMain_uv(pixelInput_0 _S1 [[stage_in]], bool isFrontFace_0 [[front_facing]], float4 position_0 [[position]], SurfaceParameters_natural_0 device* surfaceParameters_1 [[buffer(7)]], uint32_t device* frameParameters_1 [[buffer(8)]], texture2d<float, access::sample> shadowAtlas_1 [[texture(16)]], sampler shadowSampler_1 [[sampler(13)]], texture2d<float, access::sample> environmentBrdf_1 [[texture(19)]], sampler environmentBrdfSampler_1 [[sampler(15)]], texture2d<float, access::sample> environmentIrradiance_1 [[texture(17)]], sampler environmentSampler_1 [[sampler(14)]], texture2d<float, access::sample> environmentSpecular_1 [[texture(18)]])
{
    ...
    if(unlit_0)
    {
        ...
        pixelOutput_0 _S4780 = { float4(unlitColor_0, opacity_0) };
        return _S4780;
    }
    float4 _S4781 = float4(_S4->reserved_0) ;
    if((_S4781.x) >= 0.5f)
    {
        pixelOutput_0 _S4782 = { float4(diffuseColor_0 * float3((1.0f - exp(- max(0.0f, _S4781.y) * max(0.0f, _S4781.z)))) , 1.0f) };
        return _S4782;
    }
    float4 _S4783 = float4(_S4->metallicRoughnessThresholdWorkflow_0) ;
    float metallic_0 = saturate(_S4783.x);
    float roughness_0 = clamp(_S4783.y, 0.00999999977648258f, 1.0f);
    float4 _S4784 = float4(_S4->specularIor_0) ;
    float3 specularColor_0 = _S4784.xyz;
    float ior_0 = _S4784.w;
    float clearcoatAmount_0 = _S4778.x;
    float clearcoatRoughness_0 = _S4778.y;
    float opacityThreshold_0 = _S4783.z;
    ...
    float _S4785 = saturate(abs(dot(normal_2, unlitColor_0)) + 0.00000999999974738f);
    float _S4786 = max(0.00100000004749745f, roughness_0);
    float _S4787 = max(0.00100000004749745f, clearcoatRoughness_0);
    float reflectanceRatio_0 = (1.0f - ior_0) / (1.0f + ior_0);
    float3 _S4788 = float3(3.14159274101257324f) ;
    float3 diffuse_0 = diffuseColor_0 / _S4788;
    float3 normalIncidence_0;
    float3 grazingIncidence_0;
    float3 diffuse_1;
    if((_S4783.w) >= 0.5f)
    {
        float3 _S4789 = float3(1.0f, 1.0f, 1.0f);
        normalIncidence_0 = specularColor_0;
        grazingIncidence_0 = _S4789;
        diffuse_1 = diffuse_0;
    }
    else
    {
        float3 _S4790 = float3(metallic_0) ;
        float3 specularTint_0 = mix(float3(1.0f, 1.0f, 1.0f), diffuseColor_0, _S4790);
        float3 diffuse_2 = diffuse_0 * float3((1.0f - metallic_0)) ;
        normalIncidence_0 = mix(float3((reflectanceRatio_0 * reflectanceRatio_0))  * specularTint_0, specularTint_0, _S4790);
    ...
    {
        float3 _S4791 = float3(_S65, _S66, _S67);
        hasSceneLighting_0 = (dot(_S4791, _S4791)) > 0.0f;
    }
    if(hasSceneLighting_0)
    {
        hasSceneLighting_0 = true;
    ...
    uint _S4792 = min(uint(_S68), 128U);
    float3 sceneEye_0 = normalize((((float4(unlitColor_0, 0.0f)) * (_S3928))).xyz);
    ...
    float4 _S4793 = float4(_S4->lightColorAmbient_0) ;
    float3 color_0 = diffuseColor_0 * float3(_S4793.w) ;
    uint domeLinkMask_0 = uint(max((float4(_S4->domeLinkControls_0) ).x, 0.0f));
    uint _S4794 = min(uint(max(_S4693, 0.0f)), 8U);
    uint allDomes_0 = (1U << _S4794) - 1U;
    bool allDomesLinked_0 = (domeLinkMask_0 & allDomes_0) == allDomes_0;
    float3 _S4795 = float3(_S65, _S66, _S67);
    uint lightCount_0;
    float3 domeAmbient_0;
    if(!allDomesLinked_0)
    {
        float3 _S4796 = float3(0.0f, 0.0f, 0.0f);
        lightCount_0 = 0U;
        domeAmbient_0 = _S4796;
        for(;;)
        {
            if(lightCount_0 < _S4794)
            {
            }
            else
            {
    ...
    for(;;)
    {
        ...
        if(hasSceneLighting_0)
        {
            _S4798 = (((uint4(_S4->lightLinkMask_0) )[lightIndex_0 / 32U]) & (1U << (lightIndex_0 % 32U))) == 0U;
        }
        else
        {
            _S4798 = false;
        ...
        if(_S4802)
        {
            _S4803 = (float4(_S4->lightDirectionIntensity_0) ).w;
        }
        else
        {
            _S4803 = _S1988[lightIndex_0].w;
        }
        bool _S4804;
        if(_S4799)
        {
        ...
        if(hasSceneLighting_0)
        {
            ...
            if(shadowSlot_0 >= int(0))
            {
                for(;;)
                {
                    ...
                    float _S4815 = lightClip_0.w;
                    if(_S4815 <= 0.0f)
                    {
                        shadowVisibility_0 = 1.0f;
                        break;
                    }
                    float3 ndc_0 = lightClip_0.xyz / float3(_S4815) ;
                    bool _S4816;
                    if((abs(ndc_0.x)) > 1.0f)
                    {
                        _S4816 = true;
                    ...
                    float2 _S4819 = _S4028[shadowSlot_0].xy;
                    float2 _S4820 = _S4028[shadowSlot_0].zw;
                    float2 _S4821 = _S4819 + (ndc_0.xy * float2(0.5f, -0.5f) + float2(0.5f, 0.5f)) * _S4820;
                    float texel_0 = _S4048[shadowSlot_0].w;
                    float _S4822 = max(_S4048[shadowSlot_0].z, 0.0f);
                    float _S4823 = ndc_0.z - _S4048[shadowSlot_0].x * (1.0f + 2.0f * slope_0);
                    float2 _S4824 = float2((texel_0 * 0.5f)) ;
                    float2 _S4825 = _S4819 + _S4824;
                    float2 _S4826 = _S4819 + _S4820 - _S4824;
                    int y_0 = int(-1);
                    ...
                    for(;;)
                    {
                        ...
                        for(;;)
                        {
                            ...
                            if(_S4823 <= (((&kernelContext_0)->shadowAtlas_0).sample(((&kernelContext_0)->shadowSampler_0), (clamp(_S4821 + float2(float(x_0), float(y_0)) * float2((_S4822 * texel_0)) , _S4825, _S4826)), level((0.0f))).x))
                            {
                                sampleCount_0 = 1.0f;
                            }
                            else
        ...
        float3 _S4827 = float3(0.0f, 0.0f, 0.0f);
        sampleOffsets_0[int(0)] = _S4827;
        sampleOffsets_0[int(1)] = _S4827;
        sampleOffsets_0[int(2)] = _S4827;
        sampleOffsets_0[int(3)] = _S4827;
        sampleOffsets_0[int(4)] = _S4827;
        if(lightType_0 == 3.0f)
        {
            ...
            float3 _S4828 = - halfWidth_0;
            sampleOffsets_0[int(3)] = _S4828 + halfHeight_0;
            sampleOffsets_0[int(4)] = _S4828 - halfHeight_0;
            sampleCount_0 = 5.0f;
        }
        else
        {
        ...
        for(;;)
        {
            ...
            float sampleIntensity_0 = _S4803 / sampleCount_0;
            ...
            if(lightType_0 >= 2.0f)
            {
                ...
                float _S4829 = max(dot(toLight_0, toLight_0), 0.00100000004749745f);
                float3 sampleDirection_1 = toLight_0 * float3(rsqrt(_S4829)) ;
                float sampleIntensity_2 = sampleIntensity_0 / _S4829;
                if(lightType_0 == 4.0f)
                {
            ...
            float3 _S4830 = float3(pow(max(0.0f, 1.0f - saturate(dot(domeAmbient_0, half_0))), 5.0f)) ;
            float3 _S4831 = mix(normalIncidence_0, grazingIncidence_0, _S4830);
            float3 directDiffuse_0 = diffuse_1 * (float3(1.0f)  - _S4831);
            float _S4832 = max(_S4786, 0.00100000004749745f);
            float alpha_0 = _S4832 * _S4832;
            ...
            float _S4833 = 1.0f - k_0;
            float3 _S4834 = float3(max(4.0f * normalDotLight_0 * _S4785, 1.00000000317107685e-30f)) ;
            float3 _S4835 = _S4831 * float3((_S4785 / (_S4785 * _S4833 + k_0) * (normalDotLight_0 / (normalDotLight_0 * _S4833 + k_0))))  * float3((alphaSquared_0 / max(3.14159274101257324f * denominator_0 * denominator_0, 1.00000000317107685e-30f)))  / _S4834;
            float3 directSpecular_0;
            if(clearcoatAmount_0 > 0.0f)
            {
                float _S4836 = max(_S4787, 0.00100000004749745f);
                float alpha_1 = _S4836 * _S4836;
                ...
                float _S4837 = 1.0f - k_1;
                directSpecular_0 = _S4835 + float3(clearcoatAmount_0)  * (mix(float3((reflectanceRatio_0 * reflectanceRatio_0)) , float3(1.0f, 1.0f, 1.0f), _S4830) * float3((_S4785 / (_S4785 * _S4837 + k_1) * (normalDotLight_0 / (normalDotLight_0 * _S4837 + k_1))))  * float3((alphaSquared_1 / max(3.14159274101257324f * denominator_1 * denominator_1, 1.00000000317107685e-30f)))  / _S4834);
            }
            else
            {
                directSpecular_0 = _S4835;
            }
            float3 _S4838 = diffuseColor_0 * float3(sampleIntensity_1) ;
            color_3 = color_3 + float3((shadowVisibility_0 * occlusion_0 * emissionScale_0 * normalDotLight_0))  * (directDiffuse_0 * float3(_S4806)  * (_S4838 * _S4788) + directSpecular_0 * float3(_S4808)  * _S4838);
            sampleIndex_0 = sampleIndex_0 + 1U;
        }
        color_2 = color_3;
        lightIndex_0 = lightIndex_0 + 1U;
    ...
    if(_S4689 >= 0.5f)
    {
        float _S4839 = saturate(saturate(abs(dot(worldNormal_2, sceneEye_0)) + 0.00000999999974738f));
        float _S4840 = saturate(_S4786);
        float2 _S4841 = (((&kernelContext_0)->environmentBrdf_0).sample(((&kernelContext_0)->environmentBrdfSampler_0), (float2(_S4839, _S4840)), level((0.0f)))).xy;
        float3 specularWeight_0 = normalIncidence_0 * float3(_S4841.x)  + grazingIncidence_0 * float3(_S4841.y) ;
        ...
        {
            hasSceneLighting_0 = _S4842 <= 1.0f;
        }
        if(hasSceneLighting_0)
        {
            for(;;)
            {
                bool _S4844 = _S4842 <= 1.0f;
                _S2 = _S4844;
                if(_S4844)
                {
                ...
                diffuseColor_0 = (((&kernelContext_0)->environmentIrradiance_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(fract((atan2(unit_1.z, unit_1.x) + 1.57079637050628662f) / 6.28318548202514648f), (_S4695 + clamp(acos(clamp(unit_1.y, -1.0f, 1.0f)) / 3.14159274101257324f, inset_0, 1.0f - inset_0)) / _S4842)), level((0.0f)))).xyz;
                break;
            }
            for(;;)
            {
                if(_S2)
                {
                    ...
                    float _S4845 = max(_S4690, 1.0f);
                    float _S4846 = _S4845 - 1.0f;
                    float slice_0 = _S4840 * max(_S4846, 0.0f);
                    ...
                    unlitColor_0 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_0, (lower_0 + v_0) / _S4845)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_0, (min(lower_0 + 1.0f, _S4846) + v_0) / _S4845)), level((0.0f)))).xyz, float3((slice_0 - lower_0)) );
                    break;
                }
                ...
                float _S4847 = max(_S4690, 1.0f);
                float total_0 = _S4847 * _S4842;
                float _S4848 = _S4847 - 1.0f;
                float slice_1 = _S4840 * max(_S4848, 0.0f);
                ...
                float base_0 = _S4695 * _S4847;
                unlitColor_0 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_1, (base_0 + lower_1 + v_1) / total_0)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_1, (base_0 + min(lower_1 + 1.0f, _S4848) + v_1) / total_0)), level((0.0f)))).xyz, float3((slice_1 - lower_1)) );
                break;
            }
            if(clearcoatAmount_0 > 0.0f)
            {
                for(;;)
                {
                    if(_S2)
                    {
                        ...
                        float _S4849 = max(_S4690, 1.0f);
                        float _S4850 = _S4849 - 1.0f;
                        float slice_2 = saturate(_S4787) * max(_S4850, 0.0f);
                        ...
                        normal_2 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_2, (lower_2 + v_2) / _S4849)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_2, (min(lower_2 + 1.0f, _S4850) + v_2) / _S4849)), level((0.0f)))).xyz, float3((slice_2 - lower_2)) );
                        break;
                    }
                    ...
                    float _S4851 = max(_S4690, 1.0f);
                    float total_1 = _S4851 * _S4842;
                    float _S4852 = _S4851 - 1.0f;
                    float slice_3 = saturate(_S4787) * max(_S4852, 0.0f);
            ...
            {
                lightDirection_0 = _S4843;
            }
            float3 _S4853 = unlitColor_0;
            unlitColor_0 = diffuseColor_0;
            prefiltered_0 = _S4853;
        }
        else
        {
            sampleIndex_0 = 0U;
            unlitColor_0 = _S4843;
            prefiltered_0 = _S4843;
            lightDirection_0 = _S4843;
            for(;;)
            {
                if(sampleIndex_0 < _S4794)
                {
                }
                else
                {
                ...
                for(;;)
                {
                    ...
                    diffuseColor_0 = (((&kernelContext_0)->environmentIrradiance_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(fract((atan2(unit_7.z, unit_7.x) + 1.57079637050628662f) / 6.28318548202514648f), (domeGroup_0 + clamp(acos(clamp(unit_7.y, -1.0f, 1.0f)) / 3.14159274101257324f, inset_5, 1.0f - inset_5)) / _S4842)), level((0.0f)))).xyz;
                    break;
                }
                ...
                for(;;)
                {
                    if(_S3)
                    {
                        ...
                        float _S4855 = max(_S4690, 1.0f);
                        float _S4856 = _S4855 - 1.0f;
                        float slice_4 = _S4840 * max(_S4856, 0.0f);
                        ...
                        normal_2 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_4, (lower_4 + v_4) / _S4855)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_4, (min(lower_4 + 1.0f, _S4856) + v_4) / _S4855)), level((0.0f)))).xyz, float3((slice_4 - lower_4)) );
                        break;
                    }
                    ...
                    float _S4857 = max(_S4690, 1.0f);
                    float total_2 = _S4857 * _S4842;
                    float _S4858 = _S4857 - 1.0f;
                    float slice_5 = _S4840 * max(_S4858, 0.0f);
                    ...
                    float base_2 = domeGroup_0 * _S4857;
                    normal_2 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_5, (base_2 + lower_5 + v_5) / total_2)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_5, (base_2 + min(lower_5 + 1.0f, _S4858) + v_5) / total_2)), level((0.0f)))).xyz, float3((slice_5 - lower_5)) );
                    break;
                }
                ...
                if(clearcoatAmount_0 > 0.0f)
                {
                    for(;;)
                    {
                        if(_S3)
                        {
                            ...
                            float _S4859 = max(_S4690, 1.0f);
                            float _S4860 = _S4859 - 1.0f;
                            float slice_6 = saturate(_S4787) * max(_S4860, 0.0f);
                            ...
                            normalIncidence_0 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_6, (lower_6 + v_6) / _S4859)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_6, (min(lower_6 + 1.0f, _S4860) + v_6) / _S4859)), level((0.0f)))).xyz, float3((slice_6 - lower_6)) );
                            break;
                        }
                        ...
                        float _S4861 = max(_S4690, 1.0f);
                        float total_3 = _S4861 * _S4842;
                        float _S4862 = _S4861 - 1.0f;
                        float slice_7 = saturate(_S4787) * max(_S4862, 0.0f);
                        ...
                        float base_3 = domeGroup_0 * _S4861;
                        normalIncidence_0 = mix((((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_7, (base_3 + lower_7 + v_7) / total_3)), level((0.0f)))).xyz, (((&kernelContext_0)->environmentSpecular_0).sample(((&kernelContext_0)->environmentSampler_0), (float2(u_7, (base_3 + min(lower_7 + 1.0f, _S4862) + v_7) / total_3)), level((0.0f)))).xyz, float3((slice_7 - lower_7)) );
                        break;
                    }
        ...
        float3 _S4863 = float3(occlusion_0) ;
        float3 color_4 = color_2 + _S4863 * diffuse_1 * unlitColor_0 * diffuseWeight_0 + _S4863 * prefiltered_0 * specularWeight_0;
        if(clearcoatAmount_0 > 0.0f)
        {
            float2 _S4864 = (((&kernelContext_0)->environmentBrdf_0).sample(((&kernelContext_0)->environmentBrdfSampler_0), (float2(_S4839, saturate(_S4787))), level((0.0f)))).xy;
            color_2 = color_4 + float3((occlusion_0 * clearcoatAmount_0))  * lightDirection_0 * (float3((reflectanceRatio_0 * reflectanceRatio_0))  * float3(_S4864.x)  + float3(_S4864.y) );
        }
        else
        {
            color_2 = color_4;
    ...
    float3 color_5 = (color_2 + emissiveColor_0) * float3(exp2((as_type<float>((_S23))))) ;
    if(_S22 == 1U)
    {
    ...
    pixelOutput_0 _S4865 = { float4(color_2, opacity_0) };
    return _S4865;
}
