...
[[fragment]] pixelOutput_0 fragmentMain_uv_basecolor_metallic_emissive(pixelInput_0 _S1 [[stage_in]], bool isFrontFace_0 [[front_facing]], float4 position_0 [[position]], SurfaceParameters_natural_0 device* surfaceParameters_1 [[buffer(7)]], FrameParameters_natural_0 device* frameParameters_1 [[buffer(8)]], texture2d<float, access::sample> baseColorTexture_1 [[texture(0)]], sampler baseColorSampler_1 [[sampler(0)]], texture2d<float, access::sample> metallicTexture_1 [[texture(4)]], sampler metallicSampler_1 [[sampler(5)]], texture2d<float, access::sample> emissiveTexture_1 [[texture(3)]], sampler emissiveSampler_1 [[sampler(3)]])
{
    uint4 _S2;
    ...
    for(;;)
    {
        ...
        texture2d<float, access::sample> _S23 = (&kernelContext_0)->metallicTexture_0;
        ...
        float4 metadata_1 = round((((&kernelContext_0)->metallicTexture_0).read(vec<uint,2>(((_S24)).xy), uint(((_S24)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S3 = (((&kernelContext_0)->metallicTexture_0).read(vec<uint,2>(((_S26)).xy), uint(((_S26)).z)));
            break;
        }
    ...
    for(;;)
    {
        ...
        texture2d<float, access::sample> _S31 = (&kernelContext_0)->emissiveTexture_0;
        ...
        float4 metadata_2 = round((((&kernelContext_0)->emissiveTexture_0).read(vec<uint,2>(((_S32)).xy), uint(((_S32)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S3 = (((&kernelContext_0)->emissiveTexture_0).read(vec<uint,2>(((_S34)).xy), uint(((_S34)).z)));
            break;
        }
    ...
    float _S38 = saturate(abs(dot(normal_2, diffuseColor_0)) + 0.00000999999974738f);
    float _S39 = max(0.00100000004749745f, roughness_0);
    float _S40 = _S8.x;
    float _S41 = max(0.00100000004749745f, _S8.y);
    float4 _S42 = float4(surface_0.specularIor_0) ;
    float _S43 = _S42.w;
    float reflectanceRatio_0 = (1.0f - _S43) / (1.0f + _S43);
    float3 _S44 = float3(3.14159274101257324f) ;
    float3 diffuse_0 = diffuseColor_1 / _S44;
    float3 normalIncidence_0;
    float3 grazingIncidence_0;
    float3 diffuse_1;
    if((_S12.w) >= 0.5f)
    {
        float3 _S45 = float3(1.0f, 1.0f, 1.0f);
        normalIncidence_0 = _S42.xyz;
        grazingIncidence_0 = _S45;
        diffuse_1 = diffuse_0;
    }
    else
    {
        float3 _S46 = float3(metallic_0) ;
        float3 specularTint_0 = mix(float3(1.0f, 1.0f, 1.0f), diffuseColor_1, _S46);
        float3 diffuse_2 = diffuse_0 * float3((1.0f - metallic_0)) ;
        normalIncidence_0 = mix(float3((reflectanceRatio_0 * reflectanceRatio_0))  * specularTint_0, specularTint_0, _S46);
        grazingIncidence_0 = specularTint_0;
        diffuse_1 = diffuse_2;
    }
    float4 _S47 = float4(_S4->ambientLight_0) ;
    float _S48 = _S47.w;
    if(_S48 > 0.5f)
    {
        hasSceneLighting_0 = true;
    ...
    {
        float3 _S49 = _S47.xyz;
        hasSceneLighting_0 = (dot(_S49, _S49)) > 0.0f;
    }
    uint _S50 = min(uint(_S48), 8U);
    matrix<float,int(4),int(4)>  _S51 = matrix<float,int(4),int(4)> (_S4->eyeToWorld_0.data_0[int(0)][int(0)], _S4->eyeToWorld_0.data_0[int(0)][int(1)], _S4->eyeToWorld_0.data_0[int(0)][int(2)], _S4->eyeToWorld_0.data_0[int(0)][int(3)], _S4->eyeToWorld_0.data_0[int(1)][int(0)], _S4->eyeToWorld_0.data_0[int(1)][int(1)], _S4->eyeToWorld_0.data_0[int(1)][int(2)], _S4->eyeToWorld_0.data_0[int(1)][int(3)], _S4->eyeToWorld_0.data_0[int(2)][int(0)], _S4->eyeToWorld_0.data_0[int(2)][int(1)], _S4->eyeToWorld_0.data_0[int(2)][int(2)], _S4->eyeToWorld_0.data_0[int(2)][int(3)], _S4->eyeToWorld_0.data_0[int(3)][int(0)], _S4->eyeToWorld_0.data_0[int(3)][int(1)], _S4->eyeToWorld_0.data_0[int(3)][int(2)], _S4->eyeToWorld_0.data_0[int(3)][int(3)]);
    float3 _S52 = normalize((((float4(diffuseColor_0, 0.0f)) * (_S51))).xyz);
    float3 _S53 = (((float4(_S1.eyePosition_0, 1.0f)) * (_S51))).xyz;
    float4 _S54 = float4(surface_0.lightColorAmbient_0) ;
    float3 color_0 = diffuseColor_1 * float3(_S54.w)  + diffuseColor_1 * _S47.xyz;
    bool _S55 = !hasSceneLighting_0;
    uint lightCount_0;
    if(_S55)
    {
        lightCount_0 = 1U;
    ...
    for(;;)
    {
        ...
        bool _S56 = lightIndex_0 == 0U;
        if(_S56)
        {
            hasSceneLighting_0 = _S55;
        }
        else
        {
            hasSceneLighting_0 = false;
        ...
        {
            _S60 = (float4((&_S4->lightColorIntensity_0)->data_1[lightIndex_0]) ).xyz;
        }
        bool _S61;
        if(_S56)
        {
        ...
        {
            _S62 = (float4((&_S4->lightControls_0)->data_1[lightIndex_0]) ).x;
        }
        bool _S63;
        if(_S56)
        {
        ...
        {
            _S64 = (float4((&_S4->lightControls_0)->data_1[lightIndex_0]) ).y;
        }
        bool _S65;
        if(_S56)
        {
        ...
        float3 _S72 = float3(0.0f, 0.0f, 0.0f);
        sampleOffsets_0[int(0)] = _S72;
        sampleOffsets_0[int(1)] = _S72;
        sampleOffsets_0[int(2)] = _S72;
        sampleOffsets_0[int(3)] = _S72;
        sampleOffsets_0[int(4)] = _S72;
        float sampleCount_0;
        if(lightType_0 == 3.0f)
        {
            ...
            float3 _S73 = - halfWidth_0;
            sampleOffsets_0[int(3)] = _S73 + halfHeight_0;
            sampleOffsets_0[int(4)] = _S73 - halfHeight_0;
            sampleCount_0 = 5.0f;
        }
        else
        {
        ...
        for(;;)
        {
            ...
            if(lightType_0 >= 2.0f)
            {
                float3 toLight_0 = (float4((&_S4->lightPositionType_0)->data_1[lightIndex_0]) ).xyz + sampleOffsets_0[sampleIndex_0] - _S53;
                float _S74 = max(dot(toLight_0, toLight_0), 0.00100000004749745f);
                float3 sampleDirection_1 = toLight_0 * float3(rsqrt(_S74)) ;
                float sampleIntensity_2 = sampleIntensity_0 / _S74;
                if(lightType_0 == 4.0f)
                {
            ...
            float3 half_0 = normalize(sampleDirection_0 + _S71);
            float normalDotLight_0 = saturate(dot(normal_2, sampleDirection_0));
            float normalDotHalf_0 = saturate(dot(normal_2, half_0));
            float3 _S75 = float3(pow(max(0.0f, 1.0f - saturate(dot(_S71, half_0))), 5.0f)) ;
            float3 _S76 = mix(normalIncidence_0, grazingIncidence_0, _S75);
            float3 directDiffuse_0 = diffuse_1 * (float3(1.0f)  - _S76);
            float alpha_0 = _S39 * _S39;
            float alphaSquared_0 = alpha_0 * alpha_0;
            float _S77 = normalDotHalf_0 * normalDotHalf_0;
            float denominator_0 = _S77 * (alphaSquared_0 - 1.0f) + 1.0f;
            float k_0 = alpha_0 * 0.5f;
            float _S78 = 1.0f - k_0;
            float3 _S79 = float3((4.0f * normalDotLight_0 * _S38 + 0.00100000004749745f)) ;
            float3 _S80 = _S76 * float3((_S38 / (_S38 * _S78 + k_0) * (normalDotLight_0 / (normalDotLight_0 * _S78 + k_0))))  * float3(((alphaSquared_0 + 0.00100000004749745f) / (denominator_0 * denominator_0 * 3.14159274101257324f)))  / _S79;
            float3 directSpecular_0;
            if(_S40 > 0.0f)
            {
                float alpha_1 = _S41 * _S41;
                float alphaSquared_1 = alpha_1 * alpha_1;
                float denominator_1 = _S77 * (alphaSquared_1 - 1.0f) + 1.0f;
                float k_1 = alpha_1 * 0.5f;
                float _S81 = 1.0f - k_1;
                directSpecular_0 = _S80 + float3(_S40)  * (mix(float3((reflectanceRatio_0 * reflectanceRatio_0)) , float3(1.0f, 1.0f, 1.0f), _S75) * float3((_S38 / (_S38 * _S81 + k_1) * (normalDotLight_0 / (normalDotLight_0 * _S81 + k_1))))  * float3(((alphaSquared_1 + 0.00100000004749745f) / (denominator_1 * denominator_1 * 3.14159274101257324f)))  / _S79);
            }
            else
            {
                directSpecular_0 = _S80;
            }
            float3 _S82 = _S60 * float3(sampleIntensity_1) ;
            color_2 = color_2 + float3((_S9 * emissionScale_0 * normalDotLight_0))  * (directDiffuse_0 * float3(_S62)  * (_S82 * _S44) + directSpecular_0 * float3(_S64)  * _S82);
            sampleIndex_0 = sampleIndex_0 + 1U;
        }
    ...
    pixelOutput_0 _S83 = { float4(color_1, opacity_1) };
    return _S83;
}
