...
[[fragment]] pixelOutput_0 fragmentMain_uv_normal_roughmetal_metallic_emissive(pixelInput_0 _S1 [[stage_in]], bool isFrontFace_0 [[front_facing]], float4 position_0 [[position]], SurfaceParameters_natural_0 device* surfaceParameters_1 [[buffer(7)]], FrameParameters_natural_0 device* frameParameters_1 [[buffer(8)]], texture2d<float, access::sample> normalTexture_1 [[texture(1)]], sampler normalSampler_1 [[sampler(1)]], texture2d<float, access::sample> roughnessMetallicTexture_1 [[texture(2)]], sampler roughnessMetallicSampler_1 [[sampler(2)]], texture2d<float, access::sample> metallicTexture_1 [[texture(4)]], sampler metallicSampler_1 [[sampler(5)]], texture2d<float, access::sample> emissiveTexture_1 [[texture(3)]], sampler emissiveSampler_1 [[sampler(3)]])
{
    ...
    for(;;)
    {
        ...
        texture2d<float, access::sample> _S14 = (&kernelContext_0)->normalTexture_0;
        ...
        float4 metadata_0 = round((((&kernelContext_0)->normalTexture_0).read(vec<uint,2>(((_S15)).xy), uint(((_S15)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S3 = (((&kernelContext_0)->normalTexture_0).read(vec<uint,2>(((_S17)).xy), uint(((_S17)).z)));
            break;
        }
    ...
    float3 _S21 = float3(1.0f) ;
    float3 sampledNormal_0 = _S3.xyz * float3(2.0f)  - _S21;
    ...
    for(;;)
    {
        ...
        texture2d<float, access::sample> _S23 = (&kernelContext_0)->roughnessMetallicTexture_0;
        ...
        float4 metadata_1 = round((((&kernelContext_0)->roughnessMetallicTexture_0).read(vec<uint,2>(((_S24)).xy), uint(((_S24)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S3 = (((&kernelContext_0)->roughnessMetallicTexture_0).read(vec<uint,2>(((_S26)).xy), uint(((_S26)).z)));
            break;
        }
    ...
    for(;;)
    {
        ...
        texture2d<float, access::sample> _S31 = (&kernelContext_0)->metallicTexture_0;
        ...
        float4 metadata_2 = round((((&kernelContext_0)->metallicTexture_0).read(vec<uint,2>(((_S32)).xy), uint(((_S32)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S3 = (((&kernelContext_0)->metallicTexture_0).read(vec<uint,2>(((_S34)).xy), uint(((_S34)).z)));
            break;
        }
    ...
    for(;;)
    {
        ...
        texture2d<float, access::sample> _S39 = (&kernelContext_0)->emissiveTexture_0;
        ...
        float4 metadata_3 = round((((&kernelContext_0)->emissiveTexture_0).read(vec<uint,2>(((_S40)).xy), uint(((_S40)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S3 = (((&kernelContext_0)->emissiveTexture_0).read(vec<uint,2>(((_S42)).xy), uint(((_S42)).z)));
            break;
        }
    ...
    float4 _S46 = float4(surface_0.metallicRoughnessThresholdWorkflow_0) ;
    float opacityThreshold_0 = _S46.z;
    ...
    {
        _S47 = - _S1.eyePosition_0 * float3(rsqrt(lengthSquared_0)) ;
    }
    else
    {
        _S47 = float3(0.0f, 0.0f, 1.0f);
    }
    float3 normal_2;
    if(isFrontFace_0)
    {
    ...
    float _S48 = saturate(abs(dot(normal_2, _S47)) + 0.00000999999974738f);
    float _S49 = max(0.00100000004749745f, roughness_0);
    float _S50 = _S8.x;
    float _S51 = max(0.00100000004749745f, _S8.y);
    float4 _S52 = float4(surface_0.specularIor_0) ;
    float _S53 = _S52.w;
    float reflectanceRatio_0 = (1.0f - _S53) / (1.0f + _S53);
    float3 _S54 = float3(3.14159274101257324f) ;
    float3 diffuse_0 = diffuseColor_0 / _S54;
    float3 normalIncidence_0;
    float3 grazingIncidence_0;
    float3 diffuse_1;
    if((_S46.w) >= 0.5f)
    {
        float3 _S55 = float3(1.0f, 1.0f, 1.0f);
        normalIncidence_0 = _S52.xyz;
        grazingIncidence_0 = _S55;
        diffuse_1 = diffuse_0;
    }
    else
    {
        float3 _S56 = float3(metallic_0) ;
        float3 specularTint_0 = mix(float3(1.0f, 1.0f, 1.0f), diffuseColor_0, _S56);
        float3 diffuse_2 = diffuse_0 * float3((1.0f - metallic_0)) ;
        normalIncidence_0 = mix(float3((reflectanceRatio_0 * reflectanceRatio_0))  * specularTint_0, specularTint_0, _S56);
        grazingIncidence_0 = specularTint_0;
        diffuse_1 = diffuse_2;
    }
    float4 _S57 = float4(_S4->ambientLight_0) ;
    float _S58 = _S57.w;
    if(_S58 > 0.5f)
    {
        hasSceneLighting_0 = true;
    ...
    {
        float3 _S59 = _S57.xyz;
        hasSceneLighting_0 = (dot(_S59, _S59)) > 0.0f;
    }
    uint _S60 = min(uint(_S58), 8U);
    matrix<float,int(4),int(4)>  _S61 = matrix<float,int(4),int(4)> (_S4->eyeToWorld_0.data_0[int(0)][int(0)], _S4->eyeToWorld_0.data_0[int(0)][int(1)], _S4->eyeToWorld_0.data_0[int(0)][int(2)], _S4->eyeToWorld_0.data_0[int(0)][int(3)], _S4->eyeToWorld_0.data_0[int(1)][int(0)], _S4->eyeToWorld_0.data_0[int(1)][int(1)], _S4->eyeToWorld_0.data_0[int(1)][int(2)], _S4->eyeToWorld_0.data_0[int(1)][int(3)], _S4->eyeToWorld_0.data_0[int(2)][int(0)], _S4->eyeToWorld_0.data_0[int(2)][int(1)], _S4->eyeToWorld_0.data_0[int(2)][int(2)], _S4->eyeToWorld_0.data_0[int(2)][int(3)], _S4->eyeToWorld_0.data_0[int(3)][int(0)], _S4->eyeToWorld_0.data_0[int(3)][int(1)], _S4->eyeToWorld_0.data_0[int(3)][int(2)], _S4->eyeToWorld_0.data_0[int(3)][int(3)]);
    float3 _S62 = normalize((((float4(_S47, 0.0f)) * (_S61))).xyz);
    float3 _S63 = (((float4(_S1.eyePosition_0, 1.0f)) * (_S61))).xyz;
    float4 _S64 = float4(surface_0.lightColorAmbient_0) ;
    float3 color_0 = diffuseColor_0 * float3(_S64.w)  + diffuseColor_0 * _S57.xyz;
    bool _S65 = !hasSceneLighting_0;
    uint lightCount_0;
    if(_S65)
    {
        lightCount_0 = 1U;
    ...
    for(;;)
    {
        ...
        bool _S66 = lightIndex_0 == 0U;
        if(_S66)
        {
            hasSceneLighting_0 = _S65;
        }
        else
        {
            hasSceneLighting_0 = false;
        ...
        if(_S68)
        {
            _S69 = (float4(surface_0.lightDirectionIntensity_0) ).w;
        }
        else
        {
            _S69 = (float4((&_S4->lightColorIntensity_0)->data_1[lightIndex_0]) ).w;
        }
        bool _S70;
        if(_S66)
        {
        ...
        {
            _S72 = (float4((&_S4->lightControls_0)->data_1[lightIndex_0]) ).x;
        }
        bool _S73;
        if(_S66)
        {
        ...
        {
            _S74 = (float4((&_S4->lightControls_0)->data_1[lightIndex_0]) ).y;
        }
        bool _S75;
        if(_S66)
        {
        ...
        for(;;)
        {
            ...
            float sampleIntensity_0 = _S69 / sampleCount_0;
            float3 sampleDirection_0;
            float emissionScale_0;
            float sampleIntensity_1;
            if(lightType_0 >= 2.0f)
            {
                float3 toLight_0 = (float4((&_S4->lightPositionType_0)->data_1[lightIndex_0]) ).xyz + sampleOffsets_0[sampleIndex_0] - _S63;
            ...
            float3 half_0 = normalize(sampleDirection_0 + _S81);
            float normalDotLight_0 = saturate(dot(normal_2, sampleDirection_0));
            float normalDotHalf_0 = saturate(dot(normal_2, half_0));
            float3 _S85 = float3(pow(max(0.0f, 1.0f - saturate(dot(_S81, half_0))), 5.0f)) ;
            float3 _S86 = mix(normalIncidence_0, grazingIncidence_0, _S85);
            float3 directDiffuse_0 = diffuse_1 * (_S21 - _S86);
            float alpha_0 = _S49 * _S49;
            float alphaSquared_0 = alpha_0 * alpha_0;
            float _S87 = normalDotHalf_0 * normalDotHalf_0;
            float denominator_0 = _S87 * (alphaSquared_0 - 1.0f) + 1.0f;
            float k_0 = alpha_0 * 0.5f;
            float _S88 = 1.0f - k_0;
            float3 _S89 = float3((4.0f * normalDotLight_0 * _S48 + 0.00100000004749745f)) ;
            float3 _S90 = _S86 * float3((_S48 / (_S48 * _S88 + k_0) * (normalDotLight_0 / (normalDotLight_0 * _S88 + k_0))))  * float3(((alphaSquared_0 + 0.00100000004749745f) / (denominator_0 * denominator_0 * 3.14159274101257324f)))  / _S89;
            float3 directSpecular_0;
            if(_S50 > 0.0f)
            {
                float alpha_1 = _S51 * _S51;
                float alphaSquared_1 = alpha_1 * alpha_1;
                float denominator_1 = _S87 * (alphaSquared_1 - 1.0f) + 1.0f;
                float k_1 = alpha_1 * 0.5f;
                float _S91 = 1.0f - k_1;
                directSpecular_0 = _S90 + float3(_S50)  * (mix(float3((reflectanceRatio_0 * reflectanceRatio_0)) , float3(1.0f, 1.0f, 1.0f), _S85) * float3((_S48 / (_S48 * _S91 + k_1) * (normalDotLight_0 / (normalDotLight_0 * _S91 + k_1))))  * float3(((alphaSquared_1 + 0.00100000004749745f) / (denominator_1 * denominator_1 * 3.14159274101257324f)))  / _S89);
            }
            else
            {
                directSpecular_0 = _S90;
            }
            float3 _S92 = diffuseColor_0 * float3(sampleIntensity_1) ;
            color_2 = color_2 + float3((_S9 * emissionScale_0 * normalDotLight_0))  * (directDiffuse_0 * float3(_S72)  * (_S92 * _S54) + directSpecular_0 * float3(_S74)  * _S92);
            sampleIndex_0 = sampleIndex_0 + 1U;
        }
    ...
    if((_S2.y) == 1U)
    {
        color_1 = color_3 / (_S21 + max(color_3, float3(0.0f, 0.0f, 0.0f)));
    }
    else
    {
        color_1 = color_3;
    }
    pixelOutput_0 _S93 = { float4(color_1, opacity_0) };
    return _S93;
}
