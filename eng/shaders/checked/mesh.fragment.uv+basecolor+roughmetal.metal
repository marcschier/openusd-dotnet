...
[[fragment]] pixelOutput_0 fragmentMain_uv_basecolor_roughmetal(pixelInput_0 _S1 [[stage_in]], bool isFrontFace_0 [[front_facing]], float4 position_0 [[position]], SurfaceParameters_natural_0 device* surfaceParameters_1 [[buffer(7)]], FrameParameters_natural_0 device* frameParameters_1 [[buffer(8)]], texture2d<float, access::sample> baseColorTexture_1 [[texture(0)]], sampler materialSampler_1 [[sampler(0)]], texture2d<float, access::sample> roughnessMetallicTexture_1 [[texture(2)]])
{
    ...
    float _S11 = saturate(abs(dot(normal_2, diffuseColor_0)) + 0.00000999999974738f);
    ...
    float3 diffuse_0 = diffuseColor_1 / _S17;
    ...
    else
    {
        ...
        float3 specularTint_0 = mix(float3(1.0f, 1.0f, 1.0f), diffuseColor_1, _S19);
    ...
    float3 _S25 = normalize((((float4(diffuseColor_0, 0.0f)) * (_S24))).xyz);
    float3 _S26 = (((float4(_S1.eyePosition_0, 1.0f)) * (_S24))).xyz;
    float4 _S27 = float4(surface_0.lightColorAmbient_0) ;
    float3 color_0 = diffuseColor_1 * float3(_S27.w)  + diffuseColor_1 * _S20.xyz;
    ...
    for(;;)
    {
        ...
        {
            _S33 = (float4((&_S2->lightColorIntensity_0)->data_2[lightIndex_0]) ).xyz;
        }
        bool _S34;
        if(_S29)
        {
        ...
        for(;;)
        {
            ...
            float3 _S55 = _S33 * float3(sampleIntensity_1) ;
            color_2 = color_2 + float3((_S7 * emissionScale_0 * normalDotLight_0))  * (directDiffuse_0 * float3(_S35)  * (_S55 * _S17) + directSpecular_0 * float3(_S37)  * _S55);
            sampleIndex_0 = sampleIndex_0 + 1U;
        }
        lightIndex_0 = lightIndex_0 + 1U;
        color_1 = color_2;
    }
    pixelOutput_0 _S56 = { float4(color_1 + emissiveColor_0, opacity_1) };
    return _S56;
}
