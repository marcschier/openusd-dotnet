...
struct VertexOutput_0
{
    ...
    float2 texCoord_2;
    float4 tangent_2;
    float4 worldTangent_1;
};

[[vertex]] vertexMain_uv_normal_Result_0 vertexMain_uv_normal(vertexInput_0 _S1 [[stage_in]], uint instanceId_0 [[instance_id]], InstanceParameters_natural_0 device* instanceParameters_1 [[buffer(6)]], FrameParameters_natural_0 device* frameParameters_1 [[buffer(8)]])
{
    ...
    (&output_0)->worldTangent_1 = float4(basisX_0 * float3(_S1.tangent_1.x)  + basisY_0 * float3(_S1.tangent_1.y)  + basisZ_0 * float3(_S1.tangent_1.z) , _S1.tangent_1.w);
    thread vertexMain_uv_normal_Result_0 _S5;
    ...
    (&_S5)->texCoord_0 = output_0.texCoord_2;
    (&_S5)->tangent_0 = output_0.tangent_2;
    (&_S5)->worldTangent_0 = output_0.worldTangent_1;
    return _S5;
}
