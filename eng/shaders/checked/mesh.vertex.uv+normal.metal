...
struct vertexInput_0
{
    ...
    float4 tint_1 [[attribute(2)]];
    float2 texCoord_1 [[attribute(3)]];
    float4 tangent_1 [[attribute(4)]];
};
...
[[vertex]] vertexMain_uv_normal_Result_0 vertexMain_uv_normal(vertexInput_0 _S1 [[stage_in]], uint instanceId_0 [[instance_id]], InstanceParameters_natural_0 device* instanceParameters_0 [[buffer(6)]])
{
    ...
    (&output_0)->tint_3 = float4(instance_0.tint_2) ;
