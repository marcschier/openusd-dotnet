...
[[fragment]] pixelOutput_0 fragmentMain_uv_roughmetal_metallic(pixelInput_0 _S1 [[stage_in]], bool isFrontFace_0 [[front_facing]], float4 position_0 [[position]], SurfaceParameters_natural_0 device* surfaceParameters_1 [[buffer(7)]], FrameParameters_natural_0 device* frameParameters_1 [[buffer(8)]], texture2d<float, access::sample> roughnessMetallicTexture_1 [[texture(2)]], sampler roughnessMetallicSampler_1 [[sampler(2)]], texture2d<float, access::sample> metallicTexture_1 [[texture(4)]], sampler metallicSampler_1 [[sampler(5)]])
{
    ...
    for(;;)
    {
        ...
        texture2d<float, access::sample> _S15 = (&kernelContext_0)->roughnessMetallicTexture_0;
        ...
        float4 metadata_0 = round((((&kernelContext_0)->roughnessMetallicTexture_0).read(vec<uint,2>(((_S16)).xy), uint(((_S16)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S3 = (((&kernelContext_0)->roughnessMetallicTexture_0).read(vec<uint,2>(((_S18)).xy), uint(((_S18)).z)));
            break;
        }
    ...
    float4 _S30 = float4(surface_0.metallicRoughnessThresholdWorkflow_0) ;
    float opacityThreshold_0 = _S30.z;
    ...
    {
        _S31 = - _S1.eyePosition_0 * float3(rsqrt(lengthSquared_0)) ;
    }
    else
    {
        _S31 = float3(0.0f, 0.0f, 1.0f);
    }
    float3 normal_2;
    if(isFrontFace_0)
    {
    ...
    float _S32 = saturate(abs(dot(normal_2, _S31)) + 0.00000999999974738f);
    float _S33 = max(0.00100000004749745f, roughness_0);
    float _S34 = _S8.x;
    float _S35 = max(0.00100000004749745f, _S8.y);
    float4 _S36 = float4(surface_0.specularIor_0) ;
    float _S37 = _S36.w;
    float reflectanceRatio_0 = (1.0f - _S37) / (1.0f + _S37);
    float3 _S38 = float3(3.14159274101257324f) ;
    float3 diffuse_0 = diffuseColor_0 / _S38;
    float3 normalIncidence_0;
    float3 grazingIncidence_0;
    float3 diffuse_1;
    if((_S30.w) >= 0.5f)
    {
        float3 _S39 = float3(1.0f, 1.0f, 1.0f);
        normalIncidence_0 = _S36.xyz;
        grazingIncidence_0 = _S39;
        diffuse_1 = diffuse_0;
    }
    else
    {
        float3 _S40 = float3(metallic_0) ;
        float3 specularTint_0 = mix(float3(1.0f, 1.0f, 1.0f), diffuseColor_0, _S40);
        float3 diffuse_2 = diffuse_0 * float3((1.0f - metallic_0)) ;
        normalIncidence_0 = mix(float3((reflectanceRatio_0 * reflectanceRatio_0))  * specularTint_0, specularTint_0, _S40);
        grazingIncidence_0 = specularTint_0;
        diffuse_1 = diffuse_2;
    }
    float4 _S41 = float4(_S4->ambientLight_0) ;
    float _S42 = _S41.w;
    if(_S42 > 0.5f)
    {
        hasSceneLighting_0 = true;
    ...
    {
        float3 _S43 = _S41.xyz;
        hasSceneLighting_0 = (dot(_S43, _S43)) > 0.0f;
    }
    uint _S44 = min(uint(_S42), 8U);
    matrix<float,int(4),int(4)>  _S45 = matrix<float,int(4),int(4)> (_S4->eyeToWorld_0.data_0[int(0)][int(0)], _S4->eyeToWorld_0.data_0[int(0)][int(1)], _S4->eyeToWorld_0.data_0[int(0)][int(2)], _S4->eyeToWorld_0.data_0[int(0)][int(3)], _S4->eyeToWorld_0.data_0[int(1)][int(0)], _S4->eyeToWorld_0.data_0[int(1)][int(1)], _S4->eyeToWorld_0.data_0[int(1)][int(2)], _S4->eyeToWorld_0.data_0[int(1)][int(3)], _S4->eyeToWorld_0.data_0[int(2)][int(0)], _S4->eyeToWorld_0.data_0[int(2)][int(1)], _S4->eyeToWorld_0.data_0[int(2)][int(2)], _S4->eyeToWorld_0.data_0[int(2)][int(3)], _S4->eyeToWorld_0.data_0[int(3)][int(0)], _S4->eyeToWorld_0.data_0[int(3)][int(1)], _S4->eyeToWorld_0.data_0[int(3)][int(2)], _S4->eyeToWorld_0.data_0[int(3)][int(3)]);
    float3 _S46 = normalize((((float4(_S31, 0.0f)) * (_S45))).xyz);
    float3 _S47 = (((float4(_S1.eyePosition_0, 1.0f)) * (_S45))).xyz;
    float4 _S48 = float4(surface_0.lightColorAmbient_0) ;
    float3 color_0 = diffuseColor_0 * float3(_S48.w)  + diffuseColor_0 * _S41.xyz;
    ...
    for(;;)
    {
        ...
        bool _S50 = lightIndex_0 == 0U;
        if(_S50)
        {
            hasSceneLighting_0 = _S49;
        }
        else
        {
            hasSceneLighting_0 = false;
        ...
        if(_S52)
        {
            _S53 = (float4(surface_0.lightDirectionIntensity_0) ).w;
        }
        else
        {
            _S53 = (float4((&_S4->lightColorIntensity_0)->data_1[lightIndex_0]) ).w;
        }
        bool _S54;
        if(_S50)
        {
        ...
        {
            _S56 = (float4((&_S4->lightControls_0)->data_1[lightIndex_0]) ).x;
        }
        bool _S57;
        if(_S50)
        {
        ...
        {
            _S58 = (float4((&_S4->lightControls_0)->data_1[lightIndex_0]) ).y;
        }
        bool _S59;
        if(_S50)
        {
        ...
        for(;;)
        {
            ...
            float sampleIntensity_0 = _S53 / sampleCount_0;
            float3 sampleDirection_0;
            float emissionScale_0;
            float sampleIntensity_1;
            if(lightType_0 >= 2.0f)
            {
                float3 toLight_0 = (float4((&_S4->lightPositionType_0)->data_1[lightIndex_0]) ).xyz + sampleOffsets_0[sampleIndex_0] - _S47;
            ...
            float3 half_0 = normalize(sampleDirection_0 + _S65);
            float normalDotLight_0 = saturate(dot(normal_2, sampleDirection_0));
            float normalDotHalf_0 = saturate(dot(normal_2, half_0));
            float3 _S69 = float3(pow(max(0.0f, 1.0f - saturate(dot(_S65, half_0))), 5.0f)) ;
            float3 _S70 = mix(normalIncidence_0, grazingIncidence_0, _S69);
            float3 directDiffuse_0 = diffuse_1 * (float3(1.0f)  - _S70);
            float alpha_0 = _S33 * _S33;
            float alphaSquared_0 = alpha_0 * alpha_0;
            float _S71 = normalDotHalf_0 * normalDotHalf_0;
            float denominator_0 = _S71 * (alphaSquared_0 - 1.0f) + 1.0f;
            float k_0 = alpha_0 * 0.5f;
            float _S72 = 1.0f - k_0;
            float3 _S73 = float3((4.0f * normalDotLight_0 * _S32 + 0.00100000004749745f)) ;
            float3 _S74 = _S70 * float3((_S32 / (_S32 * _S72 + k_0) * (normalDotLight_0 / (normalDotLight_0 * _S72 + k_0))))  * float3(((alphaSquared_0 + 0.00100000004749745f) / (denominator_0 * denominator_0 * 3.14159274101257324f)))  / _S73;
            float3 directSpecular_0;
            if(_S34 > 0.0f)
            {
                float alpha_1 = _S35 * _S35;
                float alphaSquared_1 = alpha_1 * alpha_1;
                float denominator_1 = _S71 * (alphaSquared_1 - 1.0f) + 1.0f;
                float k_1 = alpha_1 * 0.5f;
                float _S75 = 1.0f - k_1;
                directSpecular_0 = _S74 + float3(_S34)  * (mix(float3((reflectanceRatio_0 * reflectanceRatio_0)) , float3(1.0f, 1.0f, 1.0f), _S69) * float3((_S32 / (_S32 * _S75 + k_1) * (normalDotLight_0 / (normalDotLight_0 * _S75 + k_1))))  * float3(((alphaSquared_1 + 0.00100000004749745f) / (denominator_1 * denominator_1 * 3.14159274101257324f)))  / _S73);
            }
            else
            {
                directSpecular_0 = _S74;
            }
            float3 _S76 = diffuseColor_0 * float3(sampleIntensity_1) ;
            color_2 = color_2 + float3((_S10 * emissionScale_0 * normalDotLight_0))  * (directDiffuse_0 * float3(_S56)  * (_S76 * _S38) + directSpecular_0 * float3(_S58)  * _S76);
            sampleIndex_0 = sampleIndex_0 + 1U;
        }
    ...
    pixelOutput_0 _S77 = { float4(color_1, opacity_0) };
    return _S77;
}
