...
[[fragment]] pixelOutput_0 fragmentMain_uv_normal_metallic(pixelInput_0 _S1 [[stage_in]], bool isFrontFace_0 [[front_facing]], float4 position_0 [[position]], SurfaceParameters_natural_0 device* surfaceParameters_1 [[buffer(7)]], FrameParameters_natural_0 device* frameParameters_1 [[buffer(8)]], texture2d<float, access::sample> normalTexture_1 [[texture(1)]], sampler normalSampler_1 [[sampler(1)]], texture2d<float, access::sample> metallicTexture_1 [[texture(4)]], sampler metallicSampler_1 [[sampler(5)]])
{
    ...
    for(;;)
    {
        ...
        texture2d<float, access::sample> _S25 = (&kernelContext_0)->metallicTexture_0;
        ...
        float4 metadata_1 = round((((&kernelContext_0)->metallicTexture_0).read(vec<uint,2>(((_S26)).xy), uint(((_S26)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S3 = (((&kernelContext_0)->metallicTexture_0).read(vec<uint,2>(((_S28)).xy), uint(((_S28)).z)));
            break;
        }
