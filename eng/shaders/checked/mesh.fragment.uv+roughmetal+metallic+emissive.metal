...
[[fragment]] pixelOutput_0 fragmentMain_uv_roughmetal_metallic_emissive(pixelInput_0 _S1 [[stage_in]], bool isFrontFace_0 [[front_facing]], float4 position_0 [[position]], SurfaceParameters_natural_0 device* surfaceParameters_1 [[buffer(7)]], FrameParameters_natural_0 device* frameParameters_1 [[buffer(8)]], texture2d<float, access::sample> roughnessMetallicTexture_1 [[texture(2)]], sampler roughnessMetallicSampler_1 [[sampler(2)]], texture2d<float, access::sample> metallicTexture_1 [[texture(4)]], sampler metallicSampler_1 [[sampler(5)]], texture2d<float, access::sample> emissiveTexture_1 [[texture(3)]], sampler emissiveSampler_1 [[sampler(3)]])
{
    ...
    for(;;)
    {
        ...
        texture2d<float, access::sample> _S14 = (&kernelContext_0)->roughnessMetallicTexture_0;
        ...
        float4 metadata_0 = round((((&kernelContext_0)->roughnessMetallicTexture_0).read(vec<uint,2>(((_S15)).xy), uint(((_S15)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S3 = (((&kernelContext_0)->roughnessMetallicTexture_0).read(vec<uint,2>(((_S17)).xy), uint(((_S17)).z)));
            break;
        }
    ...
    for(;;)
    {
        ...
        texture2d<float, access::sample> _S22 = (&kernelContext_0)->metallicTexture_0;
        ...
        float4 metadata_1 = round((((&kernelContext_0)->metallicTexture_0).read(vec<uint,2>(((_S23)).xy), uint(((_S23)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S3 = (((&kernelContext_0)->metallicTexture_0).read(vec<uint,2>(((_S25)).xy), uint(((_S25)).z)));
            break;
        }
        ...
        _S3 = (((&kernelContext_0)->metallicTexture_0).sample(((&kernelContext_0)->metallicSampler_0), ((float2(tile_1) * cellSize_1 + float2(1.5f, 2.5f) + fract(_S1.texCoord_0) * max(cellSize_1 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_1), float(atlasHeight_1)))));
        break;
    }
    float metallic_0 = saturate(_S3.x);
    bool _S29 = (_S12 & 8U) != 0U;
    for(;;)
    {
        if(!_S29)
        {
        ...
        texture2d<float, access::sample> _S30 = (&kernelContext_0)->emissiveTexture_0;
        ...
        float4 metadata_2 = round((((&kernelContext_0)->emissiveTexture_0).read(vec<uint,2>(((_S31)).xy), uint(((_S31)).z))) * float4(255.0f) );
        ...
        if(hasSceneLighting_0)
        {
            ...
            _S3 = (((&kernelContext_0)->emissiveTexture_0).read(vec<uint,2>(((_S33)).xy), uint(((_S33)).z)));
            break;
        }
        ...
        _S3 = (((&kernelContext_0)->emissiveTexture_0).sample(((&kernelContext_0)->emissiveSampler_0), ((float2(tile_2) * cellSize_2 + float2(1.5f, 2.5f) + fract(_S1.texCoord_0) * max(cellSize_2 - float2(2.0f)  - float2(1.0f) , float2(0.0f) )) / float2(float(atlasWidth_2), float(atlasHeight_2)))));
        break;
    }
    float3 emissiveColor_0 = _S3.xyz;
    float4 _S37 = float4(surface_0.metallicRoughnessThresholdWorkflow_0) ;
    float opacityThreshold_0 = _S37.z;
    ...
    {
        _S38 = - _S1.eyePosition_0 * float3(rsqrt(lengthSquared_0)) ;
    }
    else
    {
        _S38 = float3(0.0f, 0.0f, 1.0f);
    }
    float3 normal_2;
    if(isFrontFace_0)
    {
    ...
    float _S39 = saturate(abs(dot(normal_2, _S38)) + 0.00000999999974738f);
    float _S40 = max(0.00100000004749745f, roughness_0);
    float _S41 = _S8.x;
    float _S42 = max(0.00100000004749745f, _S8.y);
    float4 _S43 = float4(surface_0.specularIor_0) ;
    float _S44 = _S43.w;
    float reflectanceRatio_0 = (1.0f - _S44) / (1.0f + _S44);
    float3 _S45 = float3(3.14159274101257324f) ;
    float3 diffuse_0 = diffuseColor_0 / _S45;
    float3 normalIncidence_0;
    float3 grazingIncidence_0;
    float3 diffuse_1;
    if((_S37.w) >= 0.5f)
    {
        float3 _S46 = float3(1.0f, 1.0f, 1.0f);
        normalIncidence_0 = _S43.xyz;
        grazingIncidence_0 = _S46;
        diffuse_1 = diffuse_0;
    }
    else
    {
        float3 _S47 = float3(metallic_0) ;
        float3 specularTint_0 = mix(float3(1.0f, 1.0f, 1.0f), diffuseColor_0, _S47);
        float3 diffuse_2 = diffuse_0 * float3((1.0f - metallic_0)) ;
        normalIncidence_0 = mix(float3((reflectanceRatio_0 * reflectanceRatio_0))  * specularTint_0, specularTint_0, _S47);
        grazingIncidence_0 = specularTint_0;
        diffuse_1 = diffuse_2;
    }
    float4 _S48 = float4(_S4->ambientLight_0) ;
    float _S49 = _S48.w;
    if(_S49 > 0.5f)
    {
        hasSceneLighting_0 = true;
    ...
    {
        float3 _S50 = _S48.xyz;
        hasSceneLighting_0 = (dot(_S50, _S50)) > 0.0f;
    }
    uint _S51 = min(uint(_S49), 8U);
    matrix<float,int(4),int(4)>  _S52 = matrix<float,int(4),int(4)> (_S4->eyeToWorld_0.data_0[int(0)][int(0)], _S4->eyeToWorld_0.data_0[int(0)][int(1)], _S4->eyeToWorld_0.data_0[int(0)][int(2)], _S4->eyeToWorld_0.data_0[int(0)][int(3)], _S4->eyeToWorld_0.data_0[int(1)][int(0)], _S4->eyeToWorld_0.data_0[int(1)][int(1)], _S4->eyeToWorld_0.data_0[int(1)][int(2)], _S4->eyeToWorld_0.data_0[int(1)][int(3)], _S4->eyeToWorld_0.data_0[int(2)][int(0)], _S4->eyeToWorld_0.data_0[int(2)][int(1)], _S4->eyeToWorld_0.data_0[int(2)][int(2)], _S4->eyeToWorld_0.data_0[int(2)][int(3)], _S4->eyeToWorld_0.data_0[int(3)][int(0)], _S4->eyeToWorld_0.data_0[int(3)][int(1)], _S4->eyeToWorld_0.data_0[int(3)][int(2)], _S4->eyeToWorld_0.data_0[int(3)][int(3)]);
    float3 _S53 = normalize((((float4(_S38, 0.0f)) * (_S52))).xyz);
    float3 _S54 = (((float4(_S1.eyePosition_0, 1.0f)) * (_S52))).xyz;
    float4 _S55 = float4(surface_0.lightColorAmbient_0) ;
    float3 color_0 = diffuseColor_0 * float3(_S55.w)  + diffuseColor_0 * _S48.xyz;
    bool _S56 = !hasSceneLighting_0;
    uint lightCount_0;
    if(_S56)
    {
        lightCount_0 = 1U;
    ...
    for(;;)
    {
        ...
        bool _S57 = lightIndex_0 == 0U;
        if(_S57)
        {
            hasSceneLighting_0 = _S56;
        }
        else
        {
            hasSceneLighting_0 = false;
        ...
        if(_S59)
        {
            _S60 = (float4(surface_0.lightDirectionIntensity_0) ).w;
        }
        else
        {
            _S60 = (float4((&_S4->lightColorIntensity_0)->data_1[lightIndex_0]) ).w;
        }
        bool _S61;
        if(_S57)
        {
        ...
        {
            _S63 = (float4((&_S4->lightControls_0)->data_1[lightIndex_0]) ).x;
        }
        bool _S64;
        if(_S57)
        {
        ...
        {
            _S65 = (float4((&_S4->lightControls_0)->data_1[lightIndex_0]) ).y;
        }
        bool _S66;
        if(_S57)
        {
        ...
        sampleOffsets_0[int(0)] = _S73;
        sampleOffsets_0[int(1)] = _S73;
        sampleOffsets_0[int(2)] = _S73;
        sampleOffsets_0[int(3)] = _S73;
        sampleOffsets_0[int(4)] = _S73;
        float sampleCount_0;
        if(lightType_0 == 3.0f)
        {
            ...
            float3 _S74 = - halfWidth_0;
            sampleOffsets_0[int(3)] = _S74 + halfHeight_0;
            sampleOffsets_0[int(4)] = _S74 - halfHeight_0;
            sampleCount_0 = 5.0f;
        }
        else
        {
        ...
        for(;;)
        {
            ...
            float sampleIntensity_0 = _S60 / sampleCount_0;
            float3 sampleDirection_0;
            float emissionScale_0;
            float sampleIntensity_1;
            if(lightType_0 >= 2.0f)
            {
                float3 toLight_0 = (float4((&_S4->lightPositionType_0)->data_1[lightIndex_0]) ).xyz + sampleOffsets_0[sampleIndex_0] - _S54;
                float _S75 = max(dot(toLight_0, toLight_0), 0.00100000004749745f);
                float3 sampleDirection_1 = toLight_0 * float3(rsqrt(_S75)) ;
                float sampleIntensity_2 = sampleIntensity_0 / _S75;
                if(lightType_0 == 4.0f)
                {
            ...
            float3 half_0 = normalize(sampleDirection_0 + _S72);
            float normalDotLight_0 = saturate(dot(normal_2, sampleDirection_0));
            float normalDotHalf_0 = saturate(dot(normal_2, half_0));
            float3 _S76 = float3(pow(max(0.0f, 1.0f - saturate(dot(_S72, half_0))), 5.0f)) ;
            float3 _S77 = mix(normalIncidence_0, grazingIncidence_0, _S76);
            float3 directDiffuse_0 = diffuse_1 * (float3(1.0f)  - _S77);
            float alpha_0 = _S40 * _S40;
            float alphaSquared_0 = alpha_0 * alpha_0;
            float _S78 = normalDotHalf_0 * normalDotHalf_0;
            float denominator_0 = _S78 * (alphaSquared_0 - 1.0f) + 1.0f;
            float k_0 = alpha_0 * 0.5f;
            float _S79 = 1.0f - k_0;
            float3 _S80 = float3((4.0f * normalDotLight_0 * _S39 + 0.00100000004749745f)) ;
            float3 _S81 = _S77 * float3((_S39 / (_S39 * _S79 + k_0) * (normalDotLight_0 / (normalDotLight_0 * _S79 + k_0))))  * float3(((alphaSquared_0 + 0.00100000004749745f) / (denominator_0 * denominator_0 * 3.14159274101257324f)))  / _S80;
            float3 directSpecular_0;
            if(_S41 > 0.0f)
            {
                float alpha_1 = _S42 * _S42;
                float alphaSquared_1 = alpha_1 * alpha_1;
                float denominator_1 = _S78 * (alphaSquared_1 - 1.0f) + 1.0f;
                float k_1 = alpha_1 * 0.5f;
                float _S82 = 1.0f - k_1;
                directSpecular_0 = _S81 + float3(_S41)  * (mix(float3((reflectanceRatio_0 * reflectanceRatio_0)) , float3(1.0f, 1.0f, 1.0f), _S76) * float3((_S39 / (_S39 * _S82 + k_1) * (normalDotLight_0 / (normalDotLight_0 * _S82 + k_1))))  * float3(((alphaSquared_1 + 0.00100000004749745f) / (denominator_1 * denominator_1 * 3.14159274101257324f)))  / _S80);
            }
            else
            {
                directSpecular_0 = _S81;
            }
            float3 _S83 = diffuseColor_0 * float3(sampleIntensity_1) ;
            color_2 = color_2 + float3((_S9 * emissionScale_0 * normalDotLight_0))  * (directDiffuse_0 * float3(_S63)  * (_S83 * _S45) + directSpecular_0 * float3(_S65)  * _S83);
            sampleIndex_0 = sampleIndex_0 + 1U;
        }
    ...
    pixelOutput_0 _S84 = { float4(color_1, opacity_0) };
    return _S84;
}
