...
$script:OpenUsdStormChildSoname = 'libopenusd_storm_child.so.9'
$script:OpenUsdStormChildVersionName = 'libopenusd_storm_child.so.9.0.0'
...
function Assert-OpenUsdStormChildTopology
{
    ...
    {
        throw (
            'libopenusd_storm_child.so.9 must be a symbolic link whose exact target is ' +
