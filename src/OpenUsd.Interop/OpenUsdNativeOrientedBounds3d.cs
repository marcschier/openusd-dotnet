...
/// <summary>A pointer-free ABI result for one world-space oriented bounds query.</summary>
[StructLayout(LayoutKind.Sequential)]
internal struct OpenUsdNativeOrientedBounds3d
{
    ...
    internal OpenUsdNativeMatrix4d Matrix;
}
