...
> **Current distribution:** public source repository and 22 published `0.10.0-alpha` packages,
...
```shell
dotnet add package OpenUsd --version 0.10.0-alpha
dotnet add package OpenUsd.Runtime.Core --version 0.10.0-alpha
```
...
`0.10.0-alpha`. The five Cesium IDs became public after being withheld at `0.5.0-alpha`.
...
OpenUsd is a substantial public `0.10.0-alpha` baseline with 22 packages published to NuGet.org,
